...
const b09: CoreProgrammingQuestion[] = [
  {
    id: "JS-P401",
    number: 401,
    ...
    skills: ["Promises", "setTimeout", "Async"],
    tags: ["sleep", "delay", "promises", "async"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[10]", output: "true", explanation: "Resolves after 10ms." }
    ],
    constraints: ["ms >= 0", "Must return a Promise."],
    starterCode: "function sleep(ms) {\n  // Write your solution here\n}",
    functionName: "sleep",
    testCases: [
      { id: "tc_401_1", input: "[5]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_401_2", input: "[0]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function sleep(ms) {\n  return new Promise(resolve => setTimeout(() => resolve(true), ms));\n}",
    explanation: "Wrap setTimeout inside new Promise and resolve(true) in the callback.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use new Promise((resolve) => setTimeout(resolve, ms))."]
  },
  {
    id: "JS-P402",
    number: 402,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Promises", "setTimeout", "Functions"],
    tags: ["delay", "promises", "async"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(a, b) => a + b, 5, 2, 3]", output: "5", explanation: "Returns 2 + 3 = 5 after 5ms." }
    ],
    constraints: ["Supports multiple args."],
    starterCode: "function delay(fn, ms, ...args) {\n  // Write your solution here\n}",
    functionName: "delay",
    testCases: [
      { id: "tc_402_1", input: "[(a, b) => a + b, 5, 2, 3]", expectedOutput: "5", isHidden: false },
      { id: "tc_402_2", input: "[() => 'done', 5]", expectedOutput: "'done'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_402_3", input: "[x => x * 3, 2, 4]", expectedOutput: "12", isHidden: true }
    ],
    solution: "function delay(fn, ms, ...args) {\n  return new Promise((resolve, reject) => {\n    setTimeout(() => {\n      try {\n        resolve(fn(...args));\n      } catch (err) {\n        reject(err);\n      }\n    }, ms);\n  });\n}",
    explanation: "Use setTimeout to invoke fn and resolve the promise with the result.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Wrap in new Promise, invoke fn inside setTimeout callback."]
  },
  {
    id: "JS-P403",
    number: 403,
    ...
    skills: ["Promise.all", "Async", "Polyfills"],
    tags: ["promise", "polyfill", "all"],
    ...
    examples: [
      { title: "Example 1", input: "[[Promise.resolve(1), Promise.resolve(2), 3]]", output: "[1, 2, 3]", explanation: "Resolves with [1, 2, 3]." }
    ],
    constraints: ["Empty array resolves to [].", "Preserves original input index order."],
    starterCode: "function myPromiseAll(promises) {\n  // Write your solution here\n}",
    functionName: "myPromiseAll",
    testCases: [
      { id: "tc_403_1", input: "[[Promise.resolve(1), Promise.resolve(2), 3]]", expectedOutput: "[1, 2, 3]", isHidden: false },
      { id: "tc_403_2", input: "[[]]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_403_3", input: "[[Promise.resolve('a'), 'b', Promise.resolve('c')]]", expectedOutput: "['a', 'b', 'c']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Keep a counter of resolved promises. Ensure you store in results[index]."]
  },
  {
    id: "JS-P404",
    number: 404,
    ...
    difficulty: "Medium",
    questionType: "Polyfill",
    skills: ["Promise.race", "Async", "Polyfills"],
    tags: ["promise", "polyfill", "race"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[new Promise(r => setTimeout(() => r(1), 50)), Promise.resolve(2)]]", output: "2", explanation: "Promise.resolve(2) resolves first." }
    ],
    constraints: ["Handles non-promise values."],
    starterCode: "function myPromiseRace(promises) {\n  // Write your solution here\n}",
    functionName: "myPromiseRace",
    testCases: [
      { id: "tc_404_1", input: "[[new Promise(r => setTimeout(() => r('slow'), 30)), Promise.resolve('fast')]]", expectedOutput: "'fast'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_404_2", input: "[[Promise.resolve(10), Promise.resolve(20)]]", expectedOutput: "10", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Iterate and attach resolve/reject to each."]
  },
  {
    id: "JS-P405",
    number: 405,
    ...
    difficulty: "Medium",
    questionType: "Polyfill",
    skills: ["Promise.allSettled", "Async", "Polyfills"],
    tags: ["promise", "polyfill", "allSettled"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[Promise.resolve(1), Promise.reject('err')]]", output: "[{ status: 'fulfilled', value: 1 }, { status: 'rejected', reason: 'err' }]", explanation: "Captures both states." }
    ],
    constraints: ["Always resolves, never rejects.", "Empty array resolves to []."],
    starterCode: "function myPromiseAllSettled(promises) {\n  // Write your solution here\n}",
    functionName: "myPromiseAllSettled",
    testCases: [
      { id: "tc_405_1", input: "[[Promise.resolve(1), Promise.resolve('ok')]]", expectedOutput: "[{ status: 'fulfilled', value: 1 }, { status: 'fulfilled', value: 'ok' }]", isHidden: false },
      { id: "tc_405_2", input: "[[]]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_405_3", input: "[[Promise.resolve('ok'), 42]]", expectedOutput: "[{ status: 'fulfilled', value: 'ok' }, { status: 'fulfilled', value: 42 }]", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Catch each promise and format into status objects."]
  },
  {
    id: "JS-P406",
    number: 406,
    ...
    difficulty: "Medium",
    questionType: "Polyfill",
    skills: ["Promise.any", "Async", "Polyfills"],
    tags: ["promise", "polyfill", "any"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[Promise.resolve(1), Promise.resolve('success')]]", output: "1", explanation: "First fulfilled value." }
    ],
    constraints: ["Rejects if iterable is empty."],
    starterCode: "function myPromiseAny(promises) {\n  // Write your solution here\n}",
    functionName: "myPromiseAny",
    testCases: [
      { id: "tc_406_1", input: "[[Promise.resolve(10), Promise.resolve(20)]]", expectedOutput: "10", isHidden: false },
      { id: "tc_406_2", input: "[[Promise.resolve(42)]]", expectedOutput: "42", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_406_3", input: "[[Promise.resolve('b')]]", expectedOutput: "'b'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Accumulate errors until remaining is 0, resolve immediately on fulfillment."]
  },
  {
    id: "JS-P407",
    number: 407,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Retry", "Async", "Promises"],
    tags: ["retry", "promises", "async"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(() => { let c = 0; return () => ++c < 3 ? Promise.reject('fail') : Promise.resolve('ok'); })(), 3, 5]", output: "'ok'", explanation: "Fails twice, succeeds on attempt 3." }
    ],
    constraints: ["maxRetries >= 0"],
    starterCode: "async function retryPromise(fn, maxRetries = 3, delayMs = 0) {\n  // Write your solution here\n}",
    functionName: "retryPromise",
    testCases: [
      { id: "tc_407_1", input: "[(() => { let c = 0; return () => ++c < 3 ? Promise.reject('fail') : Promise.resolve('ok'); })(), 3, 5]", expectedOutput: "'ok'", isHidden: false },
      { id: "tc_407_2", input: "[() => Promise.resolve('immediate'), 2, 0]", expectedOutput: "'immediate'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_407_3", input: "[(() => { let c = 0; return () => ++c < 2 ? Promise.reject('e') : Promise.resolve(99); })(), 2, 2]", expectedOutput: "99", isHidden: true }
    ],
    ...
    timeComplexity: "O(r)",
    spaceComplexity: "O(1)",
    hints: ["Use a for loop up to maxRetries and catch errors."]
  },
  {
    id: "JS-P408",
    number: 408,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Timeout", "Promises", "Race"],
    tags: ["timeout", "promises", "fallback"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[new Promise(r => setTimeout(() => r('fast'), 10)), 50, 'fallback']", output: "'fast'", explanation: "Finished before timeout." },
      { title: "Example 2", input: "[new Promise(r => setTimeout(() => r('slow'), 50)), 10, 'timeout']", output: "'timeout'", explanation: "Timed out and returned fallback." }
    ],
    constraints: ["Clear timeout if promise settles first."],
    starterCode: "function promiseTimeout(promise, ms, fallbackValue) {\n  // Write your solution here\n}",
    functionName: "promiseTimeout",
    testCases: [
      { id: "tc_408_1", input: "[new Promise(r => setTimeout(() => r('fast'), 5)), 50, 'fallback']", expectedOutput: "'fast'", isHidden: false },
      { id: "tc_408_2", input: "[new Promise(r => setTimeout(() => r('slow'), 50)), 5, 'timeout']", expectedOutput: "'timeout'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_408_3", input: "[Promise.resolve(100), 10, -1]", expectedOutput: "100", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Promise.race with a timeout promise."]
  },
  {
    id: "JS-P409",
    number: 409,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Promisify", "Callbacks", "NodeJS"],
    tags: ["promisify", "callbacks", "promises"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(a, b, cb) => cb(null, a + b), [[2, 3]]]", output: "5", explanation: "Resolves with 2 + 3 = 5." }
    ],
    constraints: ["Preserves this context if applicable."],
    starterCode: "function promisify(fn) {\n  // Write your solution here\n}",
    functionName: "promisify",
    testCases: [
      { id: "tc_409_1", input: "[(a, b, cb) => cb(null, a + b), [[2, 3]]]", expectedOutput: "5", isHidden: false },
      { id: "tc_409_2", input: "[cb => cb(null, 'hello'), [[]]]", expectedOutput: "'hello'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_409_3", input: "[(str, cb) => cb(null, str.toUpperCase()), [['abc']]]", expectedOutput: "'ABC'", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Pass callback (err, result) => { if (err) reject(err); else resolve(result); }."]
  },
  {
    id: "JS-P410",
    number: 410,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Callbackify", "Callbacks", "NodeJS"],
    tags: ["callbackify", "callbacks", "promises"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[async (x) => x * 2, [5]]", output: "[null, 10]", explanation: "Resolves with [null, 10]." }
    ],
    constraints: ["Returns 2-element array [err, result]."],
    starterCode: "function callbackify(asyncFn, args = []) {\n  // Write your solution here\n}",
    functionName: "callbackify",
    testCases: [
      { id: "tc_410_1", input: "[async (x) => x * 2, [5]]", expectedOutput: "[null, 10]", isHidden: false },
      { id: "tc_410_2", input: "[async () => 'ok', []]", expectedOutput: "[null, 'ok']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_410_3", input: "[async () => { throw 'err'; }, []]", expectedOutput: "['err', null]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use .then(res => resolve([null, res])).catch(err => resolve([err, null]))."]
  },
  {
    id: "JS-P411",
    number: 411,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Async", "Promises", "Series"],
    tags: ["series", "flow", "async"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[() => Promise.resolve(1), () => Promise.resolve(2)]]", output: "[1, 2]", explanation: "Executes sequentially." }
    ],
    constraints: ["Empty tasks returns [].", "Stops on first error."],
    starterCode: "async function asyncSeries(tasks) {\n  // Write your solution here\n}",
    functionName: "asyncSeries",
    testCases: [
      { id: "tc_411_1", input: "[[() => Promise.resolve(1), () => Promise.resolve(2), () => Promise.resolve(3)]]", expectedOutput: "[1, 2, 3]", isHidden: false },
      { id: "tc_411_2", input: "[[]]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_411_3", input: "[[async () => 'a', async () => 'b']]", expectedOutput: "['a', 'b']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use for (const task of tasks) and await task()."]
  },
  {
    id: "JS-P412",
    number: 412,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Async", "Parallel", "Promises"],
    tags: ["parallel", "flow", "async"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[() => Promise.resolve('x'), () => Promise.resolve('y')]]", output: "['x', 'y']", explanation: "Executes concurrently." }
    ],
    constraints: ["Order preserved."],
    starterCode: "function asyncParallel(tasks) {\n  // Write your solution here\n}",
    functionName: "asyncParallel",
    testCases: [
      { id: "tc_412_1", input: "[[() => Promise.resolve(10), () => Promise.resolve(20)]]", expectedOutput: "[10, 20]", isHidden: false },
      { id: "tc_412_2", input: "[[]]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_412_3", input: "[[async () => 1, async () => 2, async () => 3]]", expectedOutput: "[1, 2, 3]", isHidden: true }
    ],
    solution: "function asyncParallel(tasks) {\n  return Promise.all(tasks.map(t => t()));\n}",
    explanation: "Map tasks to task() executions and wrap in Promise.all.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use Promise.all(tasks.map(t => t()))."]
  },
  {
    id: "JS-P413",
    number: 413,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Waterfall", "Pipeline", "Async"],
    tags: ["waterfall", "pipeline", "async"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[async x => x + 1, async x => x * 2], 5]", output: "12", explanation: "(5 + 1) * 2 = 12." }
    ],
    constraints: ["Empty tasks returns initialValue."],
    starterCode: "async function asyncWaterfall(tasks, initialValue) {\n  // Write your solution here\n}",
    functionName: "asyncWaterfall",
    testCases: [
      { id: "tc_413_1", input: "[[async x => x + 1, async x => x * 2], 5]", expectedOutput: "12", isHidden: false },
      { id: "tc_413_2", input: "[[], 42]", expectedOutput: "42", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_413_3", input: "[[async s => s + ' world', async s => s.toUpperCase()], 'hello']", expectedOutput: "'HELLO WORLD'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Let cur = initialValue and cur = await task(cur)."]
  },
  {
    id: "JS-P414",
    number: 414,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Async", "Map", "Promises"],
    tags: ["map", "async", "collections"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3], async x => x * 10]", output: "[10, 20, 30]", explanation: "Maps elements concurrently." }
    ],
    constraints: ["Preserves original indices."],
    starterCode: "function mapAsync(array, asyncFn) {\n  // Write your solution here\n}",
    functionName: "mapAsync",
    testCases: [
      { id: "tc_414_1", input: "[[1, 2, 3], async x => x * 10]", expectedOutput: "[10, 20, 30]", isHidden: false },
      { id: "tc_414_2", input: "[[], async x => x]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_414_3", input: "[['a', 'b'], async (x, i) => `${x}-${i}`]", expectedOutput: "['a-0', 'b-1']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Promise.all(array.map(asyncFn))."]
  },
  {
    id: "JS-P415",
    number: 415,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Async", "Filter", "Promises"],
    tags: ["filter", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4], async x => x % 2 === 0]", output: "[2, 4]", explanation: "Keeps even numbers." }
    ],
    constraints: ["Maintains original element ordering."],
    starterCode: "async function filterAsync(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "filterAsync",
    testCases: [
      { id: "tc_415_1", input: "[[1, 2, 3, 4], async x => x % 2 === 0]", expectedOutput: "[2, 4]", isHidden: false },
      { id: "tc_415_2", input: "[[], async () => true]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_415_3", input: "[['cat', 'elephant', 'dog'], async s => s.length > 3]", expectedOutput: "['elephant']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Evaluate with Promise.all first, then filter by results."]
  },
  {
    id: "JS-P416",
    number: 416,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Async", "Reduce", "Promises"],
    tags: ["reduce", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3], async (acc, x) => acc + x, 0]", output: "6", explanation: "0 + 1 + 2 + 3 = 6." }
    ],
    constraints: ["Must execute sequentially."],
    starterCode: "async function reduceAsync(array, asyncReducer, initialValue) {\n  // Write your solution here\n}",
    functionName: "reduceAsync",
    testCases: [
      { id: "tc_416_1", input: "[[1, 2, 3], async (acc, x) => acc + x, 0]", expectedOutput: "6", isHidden: false },
      { id: "tc_416_2", input: "[[], async (acc, x) => acc + x, 10]", expectedOutput: "10", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_416_3", input: "[['a', 'b', 'c'], async (acc, x) => acc + '-' + x, 'start']", expectedOutput: "'start-a-b-c'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Iterate with for-loop and await asyncReducer on every turn."]
  },
  {
    id: "JS-P417",
    number: 417,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["Concurrency", "Pool", "Async"],
    tags: ["concurrency", "limit", "pool", "async"],
    ...
    examples: [
      { title: "Example 1", input: "[[() => Promise.resolve(1), () => Promise.resolve(2), () => Promise.resolve(3)], 2]", output: "[1, 2, 3]", explanation: "Runs at most 2 concurrently." }
    ],
    constraints: ["limit >= 1", "Results array matches original tasks index order."],
    starterCode: "async function concurrencyLimit(tasks, limit) {\n  // Write your solution here\n}",
    functionName: "concurrencyLimit",
    testCases: [
      { id: "tc_417_1", input: "[[() => Promise.resolve(1), () => Promise.resolve(2), () => Promise.resolve(3)], 2]", expectedOutput: "[1, 2, 3]", isHidden: false },
      { id: "tc_417_2", input: "[[], 3]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_417_3", input: "[[async () => 'a', async () => 'b'], 1]", expectedOutput: "['a', 'b']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Spawn worker loops that increment a shared index while nextIndex < tasks.length."]
  },
  {
    id: "JS-P418",
    number: 418,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["Queue", "Concurrency", "Async"],
    tags: ["queue", "concurrency", "async"],
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['push', () => Promise.resolve(10)], ['push', () => Promise.resolve(20)]]]", output: "[10, 20]", explanation: "Queues tasks and executes them." }
    ],
    constraints: ["Limits concurrent executions."],
    starterCode: "function createAsyncQueue(concurrency = 1) {\n  // Write your solution here\n}",
    functionName: "createAsyncQueue",
    testCases: [
      { id: "tc_418_1", input: "[[2], [['push', () => Promise.resolve(10)], ['push', () => Promise.resolve(20)]]]", expectedOutput: "[10, 20]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_418_2", input: "[[1], [['push', () => Promise.resolve('single')]]]", expectedOutput: "['single']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(k)",
    hints: ["Store { task, resolve, reject } in an array, dispatch when running < concurrency."]
  },
  {
    id: "JS-P419",
    number: 419,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Debounce", "Async", "Promises"],
    tags: ["debounce", "async", "promises"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[async x => x * 10, 5, [[1], [2]]]", output: "[20, 20]", explanation: "Returns debounced function." }
    ],
    constraints: ["All suppressed calls resolve with latest execution result or reject."],
    starterCode: "function debounceAsync(fn, delayMs) {\n  // Write your solution here\n}",
    functionName: "debounceAsync",
    testCases: [
      { id: "tc_419_1", input: "[async x => x * 10, 5, [[1], [2]]]", expectedOutput: "[20, 20]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_419_2", input: "[async s => s.toUpperCase(), 2, [['ok']]]", expectedOutput: "['OK']", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(k)",
    hints: ["Collect pending { resolve, reject } pairs and resolve all on the timer callback."]
  },
  {
    id: "JS-P420",
    number: 420,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Deferred", "Promises"],
    tags: ["deferred", "promises"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['resolve', 'resolved']]]", output: "['resolved']", explanation: "def.resolve('resolved') resolves def.promise." }
    ],
    constraints: ["Promise resolves when def.resolve is called."],
    starterCode: "function createDeferred() {\n  // Write your solution here\n}",
    functionName: "createDeferred",
    testCases: [
      { id: "tc_420_1", input: "[[], [['resolve', 'resolved']]]", expectedOutput: "['resolved']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_420_2", input: "[[], [['resolve', 100]]]", expectedOutput: "[100]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Assign outer let resolve, reject inside new Promise((res, rej) => { ... })."]
  },
  {
    id: "JS-P421",
    number: 421,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Cancellation", "Promises"],
    tags: ["cancellation", "promises"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[Promise.resolve('ok'), false]", output: "'ok'", explanation: "Resolves if not cancelled." }
    ],
    constraints: ["If cancelled, resolves or rejects with 'cancelled'."],
    starterCode: "function cancellablePromise(promise, shouldCancel = false) {\n  // Write your solution here\n}",
    functionName: "cancellablePromise",
    testCases: [
      { id: "tc_421_1", input: "[Promise.resolve('ok'), false]", expectedOutput: "'ok'", isHidden: false },
      { id: "tc_421_2", input: "[new Promise(r => setTimeout(() => r('late'), 50)), true]", expectedOutput: "'cancelled'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_421_3", input: "[Promise.resolve(42), false]", expectedOutput: "42", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Check shouldCancel and return 'cancelled' or promise."]
  },
  {
    id: "JS-P422",
    number: 422,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Polling", "Async", "Timers"],
    tags: ["poll", "async", "predicate"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(() => { let i = 0; return () => ++i; })(), x => x >= 3, 5, 5]", output: "3", explanation: "Returns 3 on attempt 3." }
    ],
    ...
    testCases: [
      { id: "tc_422_1", input: "[(() => { let i = 0; return () => ++i; })(), x => x >= 3, 5, 5]", expectedOutput: "3", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_422_2", input: "[() => 'ready', x => x === 'ready', 2, 3]", expectedOutput: "'ready'", isHidden: true }
    ],
    ...
    timeComplexity: "O(a)",
    spaceComplexity: "O(1)",
    hints: ["Use a for-loop and check predicate(val) on each iteration."]
  },
  {
    id: "JS-P423",
    number: 423,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Backoff", "Retry", "Async"],
    tags: ["backoff", "retry", "async"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(() => { let c = 0; return () => ++c < 3 ? Promise.reject('e') : Promise.resolve('success'); })(), 3, 2]", output: "'success'", explanation: "Succeeds on 3rd attempt." }
    ],
    constraints: ["maxRetries >= 0"],
    starterCode: "async function exponentialBackoff(fn, maxRetries = 3, baseDelayMs = 5) {\n  // Write your solution here\n}",
    functionName: "exponentialBackoff",
    testCases: [
      { id: "tc_423_1", input: "[(() => { let c = 0; return () => ++c < 3 ? Promise.reject('e') : Promise.resolve('success'); })(), 3, 2]", expectedOutput: "'success'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_423_2", input: "[() => Promise.resolve(42), 2, 2]", expectedOutput: "42", isHidden: true }
    ],
    ...
    timeComplexity: "O(r)",
    spaceComplexity: "O(1)",
    hints: ["Calculate delay using baseDelayMs * (2 ** attempt)."]
  },
  {
    id: "JS-P424",
    number: 424,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Memoize", "Async", "Cache"],
    tags: ["memoize", "ttl", "cache", "async"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(() => { let c = 0; return async x => ({ val: x, call: ++c }); })(), 50, [[2], [2]]]", output: "[{\"val\":2,\"call\":1}, {\"val\":2,\"call\":1}]", explanation: "Second call uses cached result." }
    ],
    constraints: ["Key serialized via JSON.stringify(args)."],
    starterCode: "function asyncMemoize(fn, ttlMs = 100) {\n  // Write your solution here\n}",
    functionName: "asyncMemoize",
    testCases: [
      { id: "tc_424_1", input: "[(() => { let c = 0; return async x => ({ val: x, call: ++c }); })(), 50, [[2], [2]]]", expectedOutput: "[{\"val\":2,\"call\":1}, {\"val\":2,\"call\":1}]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_424_2", input: "[async s => s + '!', 10, [['test']]]", expectedOutput: "['test!']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(k)",
    hints: ["Check Date.now() < entry.expiry before returning cached value."]
  },
  {
    id: "JS-P425",
    number: 425,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Batching", "Async", "Collections"],
    tags: ["batch", "chunk", "async"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4, 5], 2, async x => x * 10]", output: "[10, 20, 30, 40, 50]", explanation: "Processes [1, 2], then [3, 4], then [5]." }
    ],
    constraints: ["Returns flattened array of all processed results."],
    starterCode: "async function executeInBatches(items, batchSize, asyncWorker) {\n  // Write your solution here\n}",
    functionName: "executeInBatches",
    testCases: [
      { id: "tc_425_1", input: "[[1, 2, 3, 4, 5], 2, async x => x * 10]", expectedOutput: "[10, 20, 30, 40, 50]", isHidden: false },
      { id: "tc_425_2", input: "[[], 2, async x => x]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_425_3", input: "[['a', 'b'], 1, async s => s.toUpperCase()]", expectedOutput: "['A', 'B']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Iterate with step batchSize, await Promise.all(batch.map(...))."]
  },
  {
    id: "JS-P426",
    number: 426,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["Mutex", "Lock", "Async"],
    tags: ["mutex", "lock", "async", "synchronization"],
    expectedTime: "12 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['runExclusive', () => Promise.resolve(1)], ['runExclusive', () => Promise.resolve(2)]]]", output: "[1, 2]", explanation: "Runs sequentially." }
    ],
    constraints: ["FIFO queue of lock requesters."],
    starterCode: "function createAsyncLock() {\n  // Write your solution here\n}",
    functionName: "createAsyncLock",
    testCases: [
      { id: "tc_426_1", input: "[[], [['runExclusive', () => Promise.resolve(1)], ['runExclusive', () => Promise.resolve(2)]]]", expectedOutput: "[1, 2]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_426_2", input: "[[], [['runExclusive', () => Promise.resolve('safe')]]]", expectedOutput: "['safe']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(k)",
    hints: ["Chain promises: const next = last.then(() => fn()); last = next.catch(() => {}); return next;"]
  },
  {
    id: "JS-P427",
    number: 427,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["Semaphore", "Synchronization", "Async"],
    tags: ["semaphore", "async", "permits"],
    expectedTime: "12 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['acquire'], ['release'], ['acquire']]]", output: "[true, true, true]", explanation: "Acquires available permits." }
    ],
    constraints: ["permits >= 1"],
    starterCode: "function createSemaphore(permits) {\n  // Write your solution here\n}",
    functionName: "createSemaphore",
    testCases: [
      { id: "tc_427_1", input: "[[2], [['acquire'], ['release'], ['acquire']]]", expectedOutput: "[true, true, true]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_427_2", input: "[[1], [['acquire'], ['release']]]", expectedOutput: "[true, true]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(k)",
    hints: ["Queue resolver functions in a waiting array when available is 0."]
  },
  {
    id: "JS-P428",
    number: 428,
    ...
    difficulty: "Medium",
    questionType: "Polyfill",
    skills: ["Finally", "Promises", "Polyfills"],
    tags: ["finally", "promise", "polyfill"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[Promise.resolve(42), () => {}]", output: "42", explanation: "Passes through 42." }
    ],
    constraints: ["If onFinally returns a rejected promise, rejects with that error."],
    starterCode: "function myPromiseFinally(promise, onFinally) {\n  // Write your solution here\n}",
    functionName: "myPromiseFinally",
    testCases: [
      { id: "tc_428_1", input: "[Promise.resolve('data'), () => {}]", expectedOutput: "'data'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_428_2", input: "[Promise.resolve(100), () => 999]", expectedOutput: "100", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Promise.resolve(onFinally()).then(() => val)."]
  },
  {
    id: "JS-P429",
    number: 429,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Some", "Async", "Short-Circuit"],
    tags: ["some", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 3, 4, 7], async x => x % 2 === 0]", output: "true", explanation: "4 is even." }
    ],
    constraints: ["Short-circuits immediately upon finding match."],
    starterCode: "async function asyncSome(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "asyncSome",
    testCases: [
      { id: "tc_429_1", input: "[[1, 3, 4, 7], async x => x % 2 === 0]", expectedOutput: "true", isHidden: false },
      { id: "tc_429_2", input: "[[1, 3, 5], async x => x % 2 === 0]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_429_3", input: "[[], async () => true]", expectedOutput: "false", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use a for-loop and return true if await asyncPredicate(...) is truthy."]
  },
  {
    id: "JS-P430",
    number: 430,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Every", "Async", "Short-Circuit"],
    tags: ["every", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2, 4, 6], async x => x % 2 === 0]", output: "true", explanation: "All are even." }
    ],
    constraints: ["Empty array returns true."],
    starterCode: "async function asyncEvery(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "asyncEvery",
    testCases: [
      { id: "tc_430_1", input: "[[2, 4, 6], async x => x % 2 === 0]", expectedOutput: "true", isHidden: false },
      { id: "tc_430_2", input: "[[2, 3, 6], async x => x % 2 === 0]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_430_3", input: "[[], async () => false]", expectedOutput: "true", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use a for-loop and return false if !(await asyncPredicate(...))."]
  },
  {
    id: "JS-P431",
    number: 431,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Find", "Async", "Collections"],
    tags: ["find", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[10, 25, 30], async x => x > 20]", output: "25", explanation: "First element > 20 is 25." }
    ],
    constraints: ["Returns undefined on no match."],
    starterCode: "async function asyncFind(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "asyncFind",
    testCases: [
      { id: "tc_431_1", input: "[[10, 25, 30], async x => x > 20]", expectedOutput: "25", isHidden: false },
      { id: "tc_431_2", input: "[[1, 2, 3], async x => x > 10]", expectedOutput: "undefined", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_431_3", input: "[['apple', 'banana', 'cherry'], async s => s.startsWith('b')]", expectedOutput: "'banana'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Return array[i] when await asyncPredicate(array[i], i, array) is truthy."]
  },
  {
    id: "JS-P432",
    number: 432,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["FindIndex", "Async", "Collections"],
    tags: ["findIndex", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[5, 12, 8, 130], async x => x > 10]", output: "1", explanation: "12 is at index 1." }
    ],
    constraints: ["Returns -1 on no match."],
    starterCode: "async function asyncFindIndex(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "asyncFindIndex",
    testCases: [
      { id: "tc_432_1", input: "[[5, 12, 8, 130], async x => x > 10]", expectedOutput: "1", isHidden: false },
      { id: "tc_432_2", input: "[[1, 2], async x => x > 10]", expectedOutput: "-1", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_432_3", input: "[['a', 'b', 'c'], async s => s === 'c']", expectedOutput: "2", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Pipe", "Async", "Composition"],
    tags: ["pipe", "async", "composition"],
    expectedTime: "8 mins",
    ...
    constraints: ["Works with sync or async functions."],
    starterCode: "function asyncPipe(...fns) {\n  // Write your solution here\n}",
    functionName: "asyncPipe",
    testCases: [
      { id: "tc_433_1", input: "[async x => x + 1, async x => x * 2, [[5]]]", expectedOutput: "12", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_433_2", input: "[x => x * 3, async x => x - 1, [[4]]]", expectedOutput: "11", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Reduce with p.then(fn) starting from Promise.resolve(initial)."]
  },
  {
    id: "JS-P434",
    number: 434,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Compose", "Async", "Composition"],
    tags: ["compose", "async", "composition"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[async x => x * 2, async x => x + 1, [[5]]]", output: "12", explanation: "(5 + 1) * 2 = 12." }
    ],
    constraints: ["Right to left evaluation."],
    starterCode: "function asyncCompose(...fns) {\n  // Write your solution here\n}",
    functionName: "asyncCompose",
    testCases: [
      { id: "tc_434_1", input: "[async x => x * 2, async x => x + 1, [[5]]]", expectedOutput: "12", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_434_2", input: "[async s => s.trim(), async s => s.toUpperCase(), [['  abc  ']]]", expectedOutput: "'ABC'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use fns.reduceRight((p, fn) => p.then(fn), Promise.resolve(initial))."]
  },
  {
    id: "JS-P435",
    number: 435,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Events", "Promises", "EventEmitter"],
    tags: ["events", "promises", "emitter"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ on(e, cb) { setTimeout(() => cb('data'), 10); }, off() {} }, 'message', 50]", output: "'data'", explanation: "Receives emitted data." }
    ],
    constraints: ["Removes listener after event or timeout."],
    starterCode: "function waitForEvent(emitter, eventName, timeoutMs = 100) {\n  // Write your solution here\n}",
    functionName: "waitForEvent",
    testCases: [
      { id: "tc_435_1", input: "[{ on(e, cb) { setTimeout(() => cb('payload'), 5); }, off() {} }, 'data', 50]", expectedOutput: "'payload'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_435_2", input: "[{ on(e, cb) { setTimeout(() => cb(42), 2); }, off() {} }, 'calc', 50]", expectedOutput: "42", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Attach handler via emitter.on, clean up with emitter.off in both success and timeout."]
  },
  {
    id: "JS-P436",
    number: 436,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Async Iterators", "Generators"],
    tags: ["generator", "async", "iterators"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(async function*() { yield 1; yield 2; yield 3; })()]", output: "[1, 2, 3]", explanation: "Collects 1, 2, 3." }
    ],
    constraints: ["Consumes entire async iterable."],
    starterCode: "async function asyncGeneratorToArray(asyncGen) {\n  // Write your solution here\n}",
    functionName: "asyncGeneratorToArray",
    testCases: [
      { id: "tc_436_1", input: "[(async function*() { yield 1; yield 2; yield 3; })()]", expectedOutput: "[1, 2, 3]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_436_2", input: "[(async function*() { yield 'x'; yield 'y'; })()]", expectedOutput: "['x', 'y']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use for await (const item of asyncGen)."]
  },
  {
    id: "JS-P437",
    number: 437,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Interval", "Async", "Timers"],
    tags: ["interval", "async", "timers"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[3, 5]", output: "[0, 1, 2]", explanation: "Executes 3 ticks." }
    ],
    constraints: ["ticks >= 0"],
    starterCode: "async function runAsyncInterval(ticks, delayMs) {\n  // Write your solution here\n}",
    functionName: "runAsyncInterval",
    testCases: [
      { id: "tc_437_1", input: "[3, 5]", expectedOutput: "[0, 1, 2]", isHidden: false },
      { id: "tc_437_2", input: "[0, 5]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_437_3", input: "[1, 2]", expectedOutput: "[0]", isHidden: true }
    ],
    ...
    timeComplexity: "O(t)",
    spaceComplexity: "O(t)",
    hints: ["Use for loop up to ticks and await delay between iterations."]
  },
  {
    id: "JS-P438",
    number: 438,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Lazy", "Promises", "Thenable"],
    tags: ["lazy", "promises", "thenable"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[() => Promise.resolve(99)]", output: "99", explanation: "Executes factory upon then call." }
    ],
    constraints: ["Factory is called at most once."],
    starterCode: "function lazyPromise(factory) {\n  // Write your solution here\n}",
    functionName: "lazyPromise",
    testCases: [
      { id: "tc_438_1", input: "[() => Promise.resolve(99)]", expectedOutput: "99", isHidden: false },
      { id: "tc_438_2", input: "[() => 'syncValue']", expectedOutput: "'syncValue'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_438_3", input: "[() => Promise.resolve('lazy-loaded')]", expectedOutput: "'lazy-loaded'", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return object with then method that initializes promise on first call."]
  },
  {
    id: "JS-P439",
    number: 439,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["Rate Limiter", "Async", "Token Bucket"],
    tags: ["rateLimit", "async", "tokenBucket"],
    expectedTime: "12 mins",
    ...
    examples: [
      { title: "Example 1", input: "[2, 50, [[() => Promise.resolve(1)], [() => Promise.resolve(2)]]]", output: "[1, 2]", explanation: "Limits calls to 2 per 50ms window." }
    ],
    constraints: ["Executes within rate window."],
    starterCode: "function createRateLimiter(maxCalls, windowMs) {\n  // Write your solution here\n}",
    functionName: "createRateLimiter",
    testCases: [
      { id: "tc_439_1", input: "[2, 50, [[() => Promise.resolve(1)], [() => Promise.resolve(2)]]]", expectedOutput: "[1, 2]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_439_2", input: "[5, 20, [[() => Promise.resolve('fast')]]]", expectedOutput: "['fast']", isHidden: true }
    ],
    ...
    timeComplexity: "O(k)",
    spaceComplexity: "O(k)",
    hints: ["Filter or shift timestamps older than now - windowMs."]
  },
  {
    id: "JS-P440",
    number: 440,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Retry", "Predicate", "Async"],
    tags: ["retry", "predicate", "async"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(() => { let c = 0; return () => ++c < 2 ? Promise.reject(new Error('retryable')) : Promise.resolve('ok'); })(), err => err.message === 'retryable', 2]", output: "'ok'", explanation: "Retries retryable error." }
    ],
    constraints: ["Does not retry non-retryable errors."],
    starterCode: "async function asyncRetryIf(fn, shouldRetry, maxRetries = 2) {\n  // Write your solution here\n}",
    functionName: "asyncRetryIf",
    testCases: [
      { id: "tc_440_1", input: "[(() => { let c = 0; return () => ++c < 2 ? Promise.reject(new Error('retryable')) : Promise.resolve('ok'); })(), err => err.message === 'retryable', 2]", expectedOutput: "'ok'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_440_2", input: "[() => Promise.resolve('immediate'), () => true, 2]", expectedOutput: "'immediate'", isHidden: true }
    ],
    ...
    timeComplexity: "O(r)",
    spaceComplexity: "O(1)",
    hints: ["Check if (attempt === maxRetries || !shouldRetry(err)) throw err."]
  },
  {
    id: "JS-P441",
    number: 441,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Partition", "Async", "Collections"],
    tags: ["partition", "async", "collections"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4, 5], async x => x % 2 === 1]", output: "[[1, 3, 5], [2, 4]]", explanation: "Partitions into odds and evens." }
    ],
    constraints: ["Preserves original element order."],
    starterCode: "async function asyncPartition(array, asyncPredicate) {\n  // Write your solution here\n}",
    functionName: "asyncPartition",
    testCases: [
      { id: "tc_441_1", input: "[[1, 2, 3, 4, 5], async x => x % 2 === 1]", expectedOutput: "[[1, 3, 5], [2, 4]]", isHidden: false },
      { id: "tc_441_2", input: "[[], async () => true]", expectedOutput: "[[], []]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_441_3", input: "[['a', 'bb', 'ccc'], async s => s.length >= 2]", expectedOutput: "[['bb', 'ccc'], ['a']]", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use Promise.all to compute flags, then separate into pass/fail arrays."]
  },
  {
    id: "JS-P442",
    number: 442,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["State", "Inspection", "Promises"],
    tags: ["state", "inspection", "promises"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[Promise.resolve(42)]", output: "'fulfilled'", explanation: "Resolved promise is fulfilled." }
    ],
    constraints: ["Non-blocking inspect."],
    starterCode: "async function promiseState(promise) {\n  // Write your solution here\n}",
    functionName: "promiseState",
    testCases: [
      { id: "tc_442_1", input: "[Promise.resolve('done')]", expectedOutput: "'fulfilled'", isHidden: false },
      { id: "tc_442_2", input: "[(() => { const p = Promise.reject('error'); p.catch(() => {}); return p; })()]", expectedOutput: "'rejected'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_442_3", input: "[new Promise(() => {})]", expectedOutput: "'pending'", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Race promise against Promise.resolve(sentinel)."]
  },
  {
    id: "JS-P443",
    number: 443,
    ...
    difficulty: "Hard",
    questionType: "Implementation",
    skills: ["DataLoader", "Batching", "Async"],
    tags: ["dataloader", "batch", "async"],
    expectedTime: "15 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[async keys => keys.map(k => 'val-' + k)], [['load', 1], ['load', 2]]]", output: "['val-1', 'val-2']", explanation: "Batches keys 1 and 2." }
    ],
    constraints: ["Resolves each load(id) with matching output from batchFn."],
    starterCode: "function createBatchLoader(batchFn) {\n  // Write your solution here\n}",
    functionName: "createBatchLoader",
    testCases: [
      { id: "tc_443_1", input: "[[async keys => keys.map(k => 'val-' + k)], [['load', 1], ['load', 2]]]", expectedOutput: "['val-1', 'val-2']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_443_2", input: "[[async keys => keys.map(k => k * 2)], [['load', 10]]]", expectedOutput: "[20]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(k)",
    hints: ["Use queueMicrotask(flush) to coalesce all calls within the tick."]
  },
  {
    id: "JS-P444",
    number: 444,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Cache", "Async", "TTL"],
    tags: ["cache", "ttl", "async"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[async k => 'u1-1', 50], [['get', 'u1'], ['get', 'u1']]]", output: "['u1-1', 'u1-1']", explanation: "Fetches and caches." }
    ],
    constraints: ["Evicts expired entries on get."],
    starterCode: "function createAsyncCache(fetchFn, maxAgeMs) {\n  // Write your solution here\n}",
    functionName: "createAsyncCache",
    testCases: [
      { id: "tc_444_1", input: "[[async k => 'u1-1', 50], [['get', 'u1'], ['get', 'u1']]]", expectedOutput: "['u1-1', 'u1-1']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_444_2", input: "[[async k => k.toUpperCase(), 10], [['get', 'item']]]", expectedOutput: "['ITEM']", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Polyfill",
    skills: ["AbortController", "AbortSignal", "Polyfill"],
    tags: ["abort", "controller", "signal", "polyfill"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['abort']]]", output: "[true]", explanation: "Signal aborted becomes true." }
    ],
    constraints: ["Calling abort() returns true."],
    starterCode: "function createAbortControllerShim() {\n  // Write your solution here\n}",
    functionName: "createAbortControllerShim",
    testCases: [
      { id: "tc_445_1", input: "[[], [['abort']]]", expectedOutput: "[true]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_445_2", input: "[[], [['abort'], ['abort']]]", expectedOutput: "[true, true]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Return object with abort() method."]
  },
  {
    id: "JS-P446",
    number: 446,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Queue", "Drain", "Async"],
    tags: ["queue", "drain", "async"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4], async x => x * 2, 2]", output: "[2, 4, 6, 8]", explanation: "Processes all items." }
    ],
    constraints: ["Empties original queue array."],
    starterCode: "async function drainQueue(queue, processor, workersCount = 2) {\n  // Write your solution here\n}",
    functionName: "drainQueue",
    testCases: [
      { id: "tc_446_1", input: "[[1, 2, 3, 4], async x => x * 2, 2]", expectedOutput: "[2, 4, 6, 8]", isHidden: false },
      { id: "tc_446_2", input: "[[], async x => x, 2]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_446_3", input: "[['a', 'b'], async s => s.toUpperCase(), 1]", expectedOutput: "['A', 'B']", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["While queue.length > 0 shift and await processor(item)."]
  },
  {
    id: "JS-P447",
    number: 447,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Race", "Fallback", "Timeout"],
    tags: ["race", "fallback", "timeout"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[new Promise(r => setTimeout(() => r('primary'), 50)), Promise.resolve('fallback'), 10]", output: "'fallback'", explanation: "Falls back to second promise." }
    ],
    constraints: ["Returns result of primary if it completes within timeout."],
    starterCode: "function raceWithFallback(primaryPromise, fallbackPromise, timeoutMs) {\n  // Write your solution here\n}",
    functionName: "raceWithFallback",
    testCases: [
      { id: "tc_447_1", input: "[new Promise(r => setTimeout(() => r('primary'), 50)), Promise.resolve('fallback'), 5]", expectedOutput: "'fallback'", isHidden: false },
      { id: "tc_447_2", input: "[Promise.resolve('instant'), Promise.resolve('fallback'), 20]", expectedOutput: "'instant'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_447_3", input: "[new Promise(r => setTimeout(() => r(1), 5)), Promise.resolve(2), 20]", expectedOutput: "1", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Promise.race([primaryPromise, new Promise(r => timer = setTimeout(() => r(fallbackPromise), timeoutMs))])."]
  },
  {
    id: "JS-P448",
    number: 448,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Streams", "Async Iterables"],
    tags: ["streams", "async", "iterables"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[(async function*() { yield 'Hello '; yield 'World!'; })()]", output: "'Hello World!'", explanation: "Concatenates chunks." }
    ],
    constraints: ["Supports any async iterable."],
    starterCode: "async function collectAsyncStream(stream) {\n  // Write your solution here\n}",
    functionName: "collectAsyncStream",
    testCases: [
      { id: "tc_448_1", input: "[(async function*() { yield 'Hello '; yield 'World!'; })()]", expectedOutput: "'Hello World!'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_448_2", input: "[(async function*() { yield 'foo'; yield 'bar'; })()]", expectedOutput: "'foobar'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use for await (const chunk of stream) chunks.push(chunk). Return chunks.join('')."]
  },
  {
    id: "JS-P449",
    number: 449,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Symbol.asyncIterator", "Iterables"],
    tags: ["asyncIterator", "iterable", "async"],
    expectedTime: "8 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3]]", output: "[1, 2, 3]", explanation: "Yields 1, 2, 3." }
    ],
    constraints: ["Implements Symbol.asyncIterator."],
    starterCode: "function createAsyncIterable(arr) {\n  // Write your solution here\n}",
    functionName: "createAsyncIterable",
    testCases: [
      { id: "tc_449_1", input: "[[1, 2, 3]]", expectedOutput: "[1, 2, 3]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_449_2", input: "[['a', 'b']]", expectedOutput: "['a', 'b']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Define [Symbol.asyncIterator]() returning an object with next() method."]
  },
  {
    id: "JS-P450",
    number: 450,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Microtask", "Event Loop", "queueMicrotask"],
    tags: ["microtask", "eventLoop", "queueMicrotask"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[() => 42]", output: "42", explanation: "Runs in microtask and resolves 42." }
    ],
    constraints: ["Runs as microtask."],
    starterCode: "function runMicrotask(fn) {\n  // Write your solution here\n}",
    functionName: "runMicrotask",
    testCases: [
      { id: "tc_450_1", input: "[() => 42]", expectedOutput: "42", isHidden: false },
      { id: "tc_450_2", input: "[() => 'micro']", expectedOutput: "'micro'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_450_3", input: "[() => ({ executed: true })]", expectedOutput: "{\"executed\":true}", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use new Promise with queueMicrotask(() => resolve(fn()))."]
  }
];

async function buildAndTestBatch09() {
  console.log(`Testing Batch 09 (${b09.length} questions)...`);
  const passed = await testBatch(b09);
  if (!passed) throw new Error('Batch 09 verification failed!');

  const outputPath = path.join(process.cwd(), 'src/components/coreprogramming/data/batches/batch09.ts');
  const fileContent = `// Batch 09: Questions JS-P401 to JS-P450 (Async JavaScript, Promises, Concurrency, Event Loop)
import type { CoreProgrammingQuestion } from '../coreProgrammingTypes';

export const batch09Questions: CoreProgrammingQuestion[] = ${JSON.stringify(b09, null, 2)};
`;
  fs.writeFileSync(outputPath, fileContent, 'utf-8');
  console.log(`Successfully wrote ${b09.length} verified questions to batch09.ts!`);
}

buildAndTestBatch09().catch(err => {
  console.error(err);
  process.exit(1);
});

...
const b08: CoreProgrammingQuestion[] = [
  {
    id: "JS-P351",
    number: 351,
    ...
    examples: [
      { title: "Example 1", input: "[function(greet) { return `${greet}, ${this.name}`; }, { name: 'Alice' }, 'Hello']", output: "'Hello, Alice'", explanation: "Invokes with { name: 'Alice' } as this." }
    ],
    constraints: ["Do not use built-in .call() or .apply()."],
    starterCode: "function myCall(fn, context, ...args) {\n  // Write your solution here\n}",
    functionName: "myCall",
    testCases: [
      { id: "tc_351_1", input: "[function(greet) { return `${greet}, ${this.name}`; }, { name: 'Alice' }, 'Hello']", expectedOutput: "'Hello, Alice'", isHidden: false },
      { id: "tc_351_2", input: "[function(a, b) { return (this.base || 0) + a + b; }, { base: 10 }, 5, 3]", expectedOutput: "18", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_351_3", input: "[function() { return 42; }, null]", expectedOutput: "42", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use a Symbol property to attach fn to context."]
  },
  {
    id: "JS-P352",
    number: 352,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Functions", "Apply"],
    tags: ["apply", "this", "functions"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function(a, b) { return this.mult * (a + b); }, { mult: 2 }, [3, 4]]", output: "14", explanation: "2 * (3 + 4) = 14" }
    ],
    constraints: ["Do not use built-in .call() or .apply()."],
    starterCode: "function myApply(fn, context, argsArray = []) {\n  // Write your solution here\n}",
    functionName: "myApply",
    testCases: [
      { id: "tc_352_1", input: "[function(a, b) { return this.mult * (a + b); }, { mult: 2 }, [3, 4]]", expectedOutput: "14", isHidden: false },
      { id: "tc_352_2", input: "[function() { return this.val; }, { val: 'test' }, []]", expectedOutput: "'test'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_352_3", input: "[function(x) { return x; }, null, [99]]", expectedOutput: "99", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Functions", "Bind", "Closures"],
    tags: ["bind", "this", "functions"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function(a, b) { return `${this.prefix}: ${a + b}`; }, { prefix: 'Sum' }, 5, [[10]]]", output: "'Sum: 15'", explanation: "Binds this and first argument 5." }
    ],
    constraints: ["Do not use built-in .bind()."],
    starterCode: "function myBind(fn, context, ...boundArgs) {\n  // Write your solution here\n}",
    functionName: "myBind",
    testCases: [
      { id: "tc_353_1", input: "[function(a, b) { return `${this.prefix}: ${a + b}`; }, { prefix: 'Sum' }, 5, [[10]]]", expectedOutput: "'Sum: 15'", isHidden: false },
      { id: "tc_353_2", input: "[function() { return this.x; }, { x: 42 }, [[]]]", expectedOutput: "42", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_353_3", input: "[function(a, b, c) { return a + b + c; }, null, 1, 2, [[3]]]", expectedOutput: "6", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(b)",
    hints: ["Return (...newArgs) => invoke with [...boundArgs, ...newArgs]."]
  },
  {
    id: "JS-P354",
    number: 354,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["new", "Prototypes", "Instantiation"],
    tags: ["new", "prototype", "constructors"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function Person(name) { this.name = name; }, 'Alice']", output: "{\"name\":\"Alice\"}", explanation: "Creates Person instance." }
    ],
    constraints: ["Correctly link prototype to constructor.prototype."],
    starterCode: "function myNew(constructor, ...args) {\n  // Write your solution here\n}",
    functionName: "myNew",
    testCases: [
      { id: "tc_354_1", input: "[function Person(name) { this.name = name; }, 'Alice']", expectedOutput: "{\"name\":\"Alice\"}", isHidden: false },
      { id: "tc_354_2", input: "[function Overwrite() { return { custom: true }; }]", expectedOutput: "{\"custom\":true}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_354_3", input: "[function Primitive() { this.x = 1; return 42; }]", expectedOutput: "{\"x\":1}", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.create(constructor.prototype) and check if return value is an object."]
  },
  {
    id: "JS-P355",
    number: 355,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Prototypes", "instanceof", "Prototype Chain"],
    ...
    examples: [
      { title: "Example 1", input: "[[], Array]", output: "true", explanation: "[] inherits from Array.prototype." },
      { title: "Example 2", input: "[{}, Array]", output: "false", explanation: "{} does not inherit from Array.prototype." }
    ],
    constraints: ["Return false for primitives."],
    starterCode: "function myInstanceof(obj, constructor) {\n  // Write your solution here\n}",
    functionName: "myInstanceof",
    testCases: [
      { id: "tc_355_1", input: "[[], Array]", expectedOutput: "true", isHidden: false },
      { id: "tc_355_2", input: "[{}, Array]", expectedOutput: "false", isHidden: false },
      { id: "tc_355_3", input: "[new Date(), Object]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_355_4", input: "[null, Object]", expectedOutput: "false", isHidden: true },
      { id: "tc_355_5", input: "['hello', String]", expectedOutput: "false", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Use a while loop with Object.getPrototypeOf(current)."]
  },
  {
    id: "JS-P356",
    number: 356,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Object.create", "Prototypes"],
    tags: ["objectCreate", "prototype"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }]", output: "{}", explanation: "New object with empty own properties, inheriting a: 1." }
    ],
    constraints: ["proto must be an object or null."],
    starterCode: "function myObjectCreate(proto) {\n  // Write your solution here\n}",
    functionName: "myObjectCreate",
    testCases: [
      { id: "tc_356_1", input: "[{ a: 1 }]", expectedOutput: "{}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_356_2", input: "[{ answer: 42 }]", expectedOutput: "{}", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use F.prototype = proto and new F()."]
  },
  {
    id: "JS-P357",
    number: 357,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Objects", "Object.assign"],
    tags: ["assign", "objects", "shallowCopy"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }, { b: 2 }, { c: 3 }]", output: "{\"a\":1,\"b\":2,\"c\":3}", explanation: "Merges sources into target." }
    ],
    constraints: ["Do not use Object.assign."],
    starterCode: "function myAssign(target, ...sources) {\n  // Write your solution here\n}",
    functionName: "myAssign",
    testCases: [
      { id: "tc_357_1", input: "[{ a: 1 }, { b: 2 }, { c: 3 }]", expectedOutput: "{\"a\":1,\"b\":2,\"c\":3}", isHidden: false },
      { id: "tc_357_2", input: "[{ x: 10 }, { x: 20 }]", expectedOutput: "{\"x\":20}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_357_3", input: "[{}, null, undefined, { ok: true }]", expectedOutput: "{\"ok\":true}", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Iterate sources, skipping null/undefined, and assign keys."]
  },
  {
    id: "JS-P358",
    number: 358,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Objects", "Object.entries"],
    tags: ["entries", "objects"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1, b: 2 }]", output: "[['a', 1], ['b', 2]]", explanation: "Returns key-value pairs." }
    ],
    constraints: ["Only include own properties."],
    starterCode: "function myObjectEntries(obj) {\n  // Write your solution here\n}",
    functionName: "myObjectEntries",
    testCases: [
      { id: "tc_358_1", input: "[{ a: 1, b: 2 }]", expectedOutput: "[['a', 1], ['b', 2]]", isHidden: false },
      { id: "tc_358_2", input: "[{}]", expectedOutput: "[]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_358_3", input: "[{ x: 'test' }]", expectedOutput: "[['x', 'test']]", isHidden: true }
    ],
    solution: "function myObjectEntries(obj) {\n  const res = [];\n  for (const key in obj) {\n    if (Object.prototype.hasOwnProperty.call(obj, key)) {\n      res.push([key, obj[key]]);\n    }\n  }\n  return res;\n}",
    explanation: "for...in with hasOwnProperty check.",
    timeComplexity: "O(k)",
    spaceComplexity: "O(k)",
    hints: ["Check Object.prototype.hasOwnProperty.call(obj, key)."]
  },
  {
    id: "JS-P359",
    number: 359,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Objects", "Object.fromEntries"],
    tags: ["fromEntries", "objects"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[['a', 1], ['b', 2]]]", output: "{\"a\":1,\"b\":2}", explanation: "Converts pairs to object." }
    ],
    constraints: ["Do not use Object.fromEntries."],
    starterCode: "function myObjectFromEntries(entries) {\n  // Write your solution here\n}",
    functionName: "myObjectFromEntries",
    testCases: [
      { id: "tc_359_1", input: "[[['a', 1], ['b', 2]]]", expectedOutput: "{\"a\":1,\"b\":2}", isHidden: false },
      { id: "tc_359_2", input: "[[]]", expectedOutput: "{}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_359_3", input: "[[['x', 'val']]]", expectedOutput: "{\"x\":\"val\"}", isHidden: true }
    ],
    solution: "function myObjectFromEntries(entries) {\n  const obj = {};\n  for (const [key, val] of entries) {\n    obj[key] = val;\n  }\n  return obj;\n}",
    explanation: "Iterate over entries and assign obj[key] = val.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Iterate with for (const [k, v] of entries) obj[k] = v."]
  },
  {
    id: "JS-P360",
    number: 360,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Equality", "Object.is", "NaN", "Signed Zeros"],
    tags: ["objectIs", "equality", "sameValue"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[NaN, NaN]", output: "true", explanation: "NaN equals NaN." },
      { title: "Example 2", input: "[0, -0]", output: "false", explanation: "+0 does not equal -0." }
    ],
    constraints: ["Do not use Object.is."],
    starterCode: "function myObjectIs(a, b) {\n  // Write your solution here\n}",
    functionName: "myObjectIs",
    testCases: [
      { id: "tc_360_1", input: "[NaN, NaN]", expectedOutput: "true", isHidden: false },
      { id: "tc_360_2", input: "[0, -0]", expectedOutput: "false", isHidden: false },
      { id: "tc_360_3", input: "[1, 1]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_360_4", input: "['a', 'b']", expectedOutput: "false", isHidden: true }
    ],
    solution: "function myObjectIs(a, b) {\n  if (a === b) {\n    return a !== 0 || 1 / a === 1 / b;\n  }\n  return a !== a && b !== b;\n}",
    explanation: "Check 1 / a === 1 / b to distinguish +0 from -0, and a !== a && b !== b for NaN.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Check 1 / a === 1 / b for signed zero and a !== a for NaN."]
  },
  {
    id: "JS-P361",
    number: 361,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Prototypes", "Inheritance"],
    tags: ["inheritance", "prototype", "subclass"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function Parent() {}, function Child() {}]", output: "true", explanation: "Child.prototype.__proto__ === Parent.prototype." }
    ],
    constraints: ["Maintain constructor reference."],
    starterCode: "function inherits(Child, Parent) {\n  // Write your solution here\n}",
    functionName: "inherits",
    testCases: [
      { id: "tc_361_1", input: "[function Animal() { this.isAnimal = true; }, function Dog() { Animal.call(this); this.bark = true; }]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_361_2", input: "[function Base() {}, function Derived() {}]", expectedOutput: "true", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Object.create(Parent.prototype) and restore constructor."]
  },
  {
    id: "JS-P362",
    number: 362,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "Prototype Chain"],
    tags: ["prototypeChain", "prototypes"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[]]", output: "['Array', 'Object']", explanation: "Array -> Object." }
    ],
    constraints: ["If obj is null or undefined, return []."],
    starterCode: "function getPrototypeChain(obj) {\n  // Write your solution here\n}",
    functionName: "getPrototypeChain",
    testCases: [
      { id: "tc_362_1", input: "[[]]", expectedOutput: "['Array', 'Object']", isHidden: false },
      { id: "tc_362_2", input: "[{}]", expectedOutput: "['Object']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_362_3", input: "[null]", expectedOutput: "[]", isHidden: true }
    ],
    ...
    timeComplexity: "O(d)",
    spaceComplexity: "O(d)",
    hints: ["Collect cur.constructor.name while cur is not null."]
  },
  {
    id: "JS-P363",
    number: 363,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "AutoBind", "Prototypes"],
    tags: ["autoBind", "this", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ val: 10, getVal() { return this.val; } }]", output: "10", explanation: "Calling detached getVal retains this.val." }
    ],
    constraints: ["Mutates instance in place and returns instance."],
    starterCode: "function autoBind(instance) {\n  // Write your solution here\n}",
    functionName: "autoBind",
    testCases: [
      { id: "tc_363_1", input: "[{ val: 10, getVal() { return this.val; } }]", expectedOutput: "{\"val\":10}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_363_2", input: "[{ name: 'Alice', getName() { return this.name; } }]", expectedOutput: "{\"name\":\"Alice\"}", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Find methods with Object.getOwnPropertyNames and call .bind(instance)."]
  },
  {
    id: "JS-P364",
    number: 364,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["this", "Method Chaining", "Fluent Interface"],
    tags: ["fluent", "chaining", "this"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['add', 3], ['multiply', 4], ['value']]]", output: "20", explanation: "(2 + 3) * 4 = 20." }
    ],
    constraints: ["Methods must return this to allow chaining."],
    starterCode: "function fluentCalculator(init = 0) {\n  // Write your solution here\n}",
    functionName: "fluentCalculator",
    testCases: [
      { id: "tc_364_1", input: "[[2], [['add', 3], ['multiply', 4], ['value']]]", expectedOutput: "20", isHidden: false },
      { id: "tc_364_2", input: "[[10], [['divide', 2], ['subtract', 1], ['value']]]", expectedOutput: "4", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_364_3", input: "[[0], [['value']]]", expectedOutput: "0", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Return this from mutating methods."]
  },
  {
    id: "JS-P365",
    number: 365,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["this", "Method Chaining", "Strings"],
    tags: ["stringBuilder", "chaining", "this"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['Hello', [['append', ' '], ['append', 'World'], ['toString']]]", output: "'Hello World'", explanation: "Builds 'Hello World'." }
    ],
    constraints: ["Return this from append and clear."],
    starterCode: "function createStringBuilder(initial = '') {\n  // Write your solution here\n}",
    functionName: "createStringBuilder",
    testCases: [
      { id: "tc_365_1", input: "['Hello', [['append', ' '], ['append', 'World'], ['toString']]]", expectedOutput: "'Hello World'", isHidden: false },
      { id: "tc_365_2", input: "['', [['appendLine', 'Line 1'], ['append', 'Line 2'], ['toString']]]", expectedOutput: "'Line 1\\nLine 2'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_365_3", input: "['a', [['clear'], ['toString']]]", expectedOutput: "''", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Return this from append/clear."]
  },
  {
    id: "JS-P366",
    number: 366,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Monkey Patching", "Testing Spies"],
    tags: ["spy", "monkeyPatch", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ add(a, b) { return a + b; } }, 'add', [['call', 2, 3], ['calls']]]", output: "[5, [[2, 3]]]", explanation: "Tracks arguments of call." }
    ],
    constraints: ["Preserve original method execution."],
    starterCode: "function createMethodSpy(obj, methodName) {\n  // Write your solution here\n}",
    functionName: "createMethodSpy",
    testCases: [
      { id: "tc_366_1", input: "[{ add(a, b) { return a + b; } }, 'add', [['call', 2, 3], ['calls']]]", expectedOutput: "[5, [[2, 3]]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_366_2", input: "[{ getVal() { return 42; } }, 'getVal', [['call'], ['calls']]]", expectedOutput: "[42, [[]]]", isHidden: true }
    ],
    ...
    hints: ["Save original = obj[methodName] and record arguments."]
  },
  {
    id: "JS-P367",
    number: 367,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "Type Checking"],
    tags: ["isPlainObject", "prototype", "type"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }]", output: "true", explanation: "Plain object literal." },
      { title: "Example 2", input: "[new Date()]", output: "false", explanation: "Instance of Date class is not a plain object." }
    ],
    constraints: ["Arrays, RegExps, Dates, and Class instances return false."],
    starterCode: "function isPlainObject(val) {\n  // Write your solution here\n}",
    functionName: "isPlainObject",
    testCases: [
      { id: "tc_367_1", input: "[{ a: 1 }]", expectedOutput: "true", isHidden: false },
      { id: "tc_367_2", input: "[new Date()]", expectedOutput: "false", isHidden: false },
      { id: "tc_367_3", input: "[[]]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_367_4", input: "[null]", expectedOutput: "false", isHidden: true },
      { id: "tc_367_5", input: "[Object.create(null)]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isPlainObject(val) {\n  if (val === null || typeof val !== 'object') return false;\n  const proto = Object.getPrototypeOf(val);\n  return proto === null || proto === Object.prototype;\n}",
    explanation: "Check if prototype is null or Object.prototype.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Check Object.getPrototypeOf(val) === null || Object.getPrototypeOf(val) === Object.prototype."]
  },
  {
    id: "JS-P368",
    number: 368,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "Security", "hasOwnProperty"],
    tags: ["hasOwnProperty", "security", "prototype"],
    expectedTime: "3 mins",
    ...
    constraints: ["Do not call obj.hasOwnProperty directly."],
    starterCode: "function safeHasOwnProperty(obj, prop) {\n  // Write your solution here\n}",
    functionName: "safeHasOwnProperty",
    testCases: [
      { id: "tc_368_1", input: "[{ a: 1 }, 'a']", expectedOutput: "true", isHidden: false },
      { id: "tc_368_2", input: "[{ a: 1 }, 'toString']", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_368_3", input: "[null, 'x']", expectedOutput: "false", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.prototype.hasOwnProperty.call(obj, prop)."]
  },
  {
    id: "JS-P369",
    number: 369,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Delegation", "Composition"],
    tags: ["delegate", "composition", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ greet(n) { return `Hi ${n}`; } }, ['greet'], [['greet', 'Bob']]]", output: "['Hi Bob']", explanation: "Delegates greet call to target." }
    ],
    constraints: ["Preserve return value and arguments."],
    starterCode: "function createDelegator(target, methods) {\n  // Write your solution here\n}",
    functionName: "createDelegator",
    testCases: [
      { id: "tc_369_1", input: "[{ greet(n) { return `Hi ${n}`; } }, ['greet'], [['greet', 'Bob']]]", expectedOutput: "['Hi Bob']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_369_2", input: "[{ sum(a, b) { return a + b; } }, ['sum'], [['sum', 10, 20]]]", expectedOutput: "[30]", isHidden: true }
    ],
    ...
    timeComplexity: "O(m)",
    spaceComplexity: "O(1)",
    hints: ["Assign source[m] = (...args) => target[m](...args)."]
  },
  {
    id: "JS-P370",
    number: 370,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Singleton", "Prototypes", "Classes"],
    tags: ["singleton", "pattern", "classes"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[() => ({ id: 42 }), [[], []]]", output: "[{\"id\":42}, {\"id\":42}]", explanation: "Returns identical cached instance." }
    ],
    constraints: ["Factory is called at most once."],
    starterCode: "function createSingleton(factory) {\n  // Write your solution here\n}",
    functionName: "createSingleton",
    testCases: [
      { id: "tc_370_1", input: "[() => ({ id: 42 }), [[], []]]", expectedOutput: "[{\"id\":42}, {\"id\":42}]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_370_2", input: "[() => ({ connected: true }), [[]]]", expectedOutput: "[{\"connected\":true}]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Cache instance variable in closure."]
  },
  {
    id: "JS-P371",
    number: 371,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.seal", "Integrity"],
    tags: ["seal", "integrity", "objects"],
    expectedTime: "5 mins",
    ...
    examples: [{ title: "Example 1", input: "[{ a: 1 }]", output: "{\"a\":1}", explanation: "Prevents adding new properties." }],
    constraints: ["Returns obj."],
    starterCode: "function sealObject(obj) {\n  // Write your solution here\n}",
    functionName: "sealObject",
    testCases: [
      { id: "tc_371_1", input: "[{ a: 1 }]", expectedOutput: "{\"a\":1}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_371_2", input: "[{ x: 5 }]", expectedOutput: "{\"x\":5}", isHidden: true }
    ],
    solution: "function sealObject(obj) {\n  return Object.seal(obj);\n}",
    explanation: "Apply Object.seal to object.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.seal(obj)."]
  },
  {
    id: "JS-P372",
    number: 372,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.freeze", "Immutability"],
    tags: ["freeze", "immutability", "objects"],
    expectedTime: "5 mins",
    ...
    examples: [{ title: "Example 1", input: "[{ a: 1 }]", output: "{\"a\":1}", explanation: "Object is frozen." }],
    constraints: ["Returns obj."],
    starterCode: "function freezeObject(obj) {\n  // Write your solution here\n}",
    functionName: "freezeObject",
    testCases: [
      { id: "tc_372_1", input: "[{ a: 1 }]", expectedOutput: "{\"a\":1}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_372_2", input: "[{ val: 42 }]", expectedOutput: "{\"val\":42}", isHidden: true }
    ],
    solution: "function freezeObject(obj) {\n  return Object.freeze(obj);\n}",
    explanation: "Apply Object.freeze(obj).",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.freeze(obj)."]
  },
  {
    id: "JS-P373",
    number: 373,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Arrays", "Negative Indices"],
    tags: ["arrays", "negativeIndex"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[[10, 20, 30]], [['get', -1], ['get', -2], ['get', 0]]]", output: "[30, 20, 10]", explanation: "-1 returns last element 30." }
    ],
    constraints: ["Support negative indices."],
    starterCode: "function createNegativeArray(arr) {\n  // Write your solution here\n}",
    functionName: "createNegativeArray",
    testCases: [
      { id: "tc_373_1", input: "[[[10, 20, 30]], [['get', -1], ['get', -2], ['get', 0]]]", expectedOutput: "[30, 20, 10]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_373_2", input: "[[['a', 'b']], [['get', -1]]]", expectedOutput: "['b']", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["idx < 0 ? arr.length + idx : idx."]
  },
  {
    id: "JS-P374",
    number: 374,
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }, 0, [['get', 'a'], ['get', 'b']]]", output: "[1, 0]", explanation: "'b' falls back to 0." }
    ],
    constraints: ["Check key in target."],
    starterCode: "function createDefaultObject(target, defaultValue) {\n  // Write your solution here\n}",
    functionName: "createDefaultObject",
    testCases: [
      { id: "tc_374_1", input: "[{ a: 1 }, 0, [['get', 'a'], ['get', 'b']]]", expectedOutput: "[1, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_374_2", input: "[{}, 'missing', [['get', 'x']]]", expectedOutput: "['missing']", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["key in target ? target[key] : defaultValue."]
  },
  {
    id: "JS-P375",
    number: 375,
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }, [['get', 'a'], ['set', 'a', 2]]]", output: "[1, 'Read only']", explanation: "Blocks writes." }
    ],
    constraints: ["Never modify target."],
    starterCode: "function createReadOnlyObject(target) {\n  // Write your solution here\n}",
    functionName: "createReadOnlyObject",
    testCases: [
      { id: "tc_375_1", input: "[{ a: 1 }, [['get', 'a'], ['set', 'a', 2]]]", expectedOutput: "[1, 'Read only']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_375_2", input: "[{ x: 10 }, [['get', 'x']]]", expectedOutput: "[10]", isHidden: true }
    ],
    solution: "function createReadOnlyObject(target) {\n  return {\n    get: (k) => target[k],\n    set: () => 'Read only'\n  };\n}",
    explanation: "Return target[k] on get, return 'Read only' on set.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return target[k] on get, 'Read only' on set."]
  },
  {
    id: "JS-P376",
    number: 376,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Telemetry", "Objects"],
    tags: ["tracker", "telemetry", "objects"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1, b: 2 }, [['get', 'a'], ['get', 'b'], ['getAccessed']]]", output: "[1, 2, ['a', 'b']]", explanation: "Tracks 'a' and 'b'." }
    ],
    constraints: ["Record each get access."],
    starterCode: "function createPropertyTracker(target) {\n  // Write your solution here\n}",
    functionName: "createPropertyTracker",
    testCases: [
      { id: "tc_376_1", input: "[{ a: 1, b: 2 }, [['get', 'a'], ['get', 'b'], ['getAccessed']]]", expectedOutput: "[1, 2, ['a', 'b']]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_376_2", input: "[{}, [['getAccessed']]]", expectedOutput: "[[]]", isHidden: true }
    ],
    solution: "function createPropertyTracker(target) {\n  const accessed = [];\n  return {\n    get: (k) => {\n      accessed.push(k);\n      return target[k];\n    },\n    getAccessed: () => accessed.slice()\n  };\n}",
    explanation: "Push k to accessed array on get.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(a)",
    hints: ["Record k in accessed array."]
  },
  {
    id: "JS-P377",
    number: 377,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Observer", "State"],
    tags: ["observable", "state", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ x: 1 }, [['set', 'x', 10], ['get', 'x'], ['getHistory']]]", output: "[10, 10, [{\"prop\":\"x\",\"n\":10,\"o\":1}]]", explanation: "Logs property mutation." }
    ],
    constraints: ["Record old and new values."],
    starterCode: "function createObservableObject(target) {\n  // Write your solution here\n}",
    functionName: "createObservableObject",
    testCases: [
      { id: "tc_377_1", input: "[{ x: 1 }, [['set', 'x', 10], ['get', 'x'], ['getHistory']]]", expectedOutput: "[10, 10, [{\"prop\":\"x\",\"n\":10,\"o\":1}]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_377_2", input: "[{}, [['getHistory']]]", expectedOutput: "[[]]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Prototypes", "Deep Clone"],
    tags: ["deepClone", "prototype", "objects"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1, b: { c: 2 } }]", output: "{\"a\":1,\"b\":{\"c\":2}}", explanation: "Deep clones nested objects." }
    ],
    constraints: ["Preserve prototypes recursively."],
    starterCode: "function deepCloneWithProto(obj) {\n  // Write your solution here\n}",
    functionName: "deepCloneWithProto",
    testCases: [
      { id: "tc_378_1", input: "[{ a: 1, b: { c: 2 } }]", expectedOutput: "{\"a\":1,\"b\":{\"c\":2}}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_378_2", input: "[{ x: 10 }]", expectedOutput: "{\"x\":10}", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use Object.create(Object.getPrototypeOf(obj))."]
  },
  {
    id: "JS-P379",
    number: 379,
    ...
    examples: [
      { title: "Example 1", input: "[[], Array.prototype]", output: "true", explanation: "Array.prototype is in []'s prototype chain." }
    ],
    constraints: ["Return false if target is null."],
    starterCode: "function hasPrototype(target, proto) {\n  // Write your solution here\n}",
    functionName: "hasPrototype",
    testCases: [
      { id: "tc_379_1", input: "[[], Array.prototype]", expectedOutput: "true", isHidden: false },
      { id: "tc_379_2", input: "[{}, Array.prototype]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_379_3", input: "[null, Object.prototype]", expectedOutput: "false", isHidden: true }
    ],
    ...
    timeComplexity: "O(d)",
    spaceComplexity: "O(1)",
    hints: ["Traverse Object.getPrototypeOf."]
  },
  {
    id: "JS-P380",
    number: 380,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "Mixins", "Composition"],
    tags: ["mixin", "prototypes", "composition"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }, { b: 2 }]", output: "{\"a\":1,\"b\":2}", explanation: "Merges mixins into target." }
    ],
    constraints: ["Returns target."],
    starterCode: "function applyMixins(target, ...mixins) {\n  // Write your solution here\n}",
    functionName: "applyMixins",
    testCases: [
      { id: "tc_380_1", input: "[{ a: 1 }, { b: 2 }]", expectedOutput: "{\"a\":1,\"b\":2}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_380_2", input: "[{}, { x: 10 }]", expectedOutput: "{\"x\":10}", isHidden: true }
    ],
    solution: "function applyMixins(target, ...mixins) {\n  return Object.assign(target, ...mixins);\n}",
    explanation: "Object.assign(target, ...mixins).",
    timeComplexity: "O(k)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.assign(target, ...mixins)."]
  },
  {
    id: "JS-P381",
    number: 381,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Symbols", "Objects"],
    tags: ["symbol", "objects", "hidden"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{}, 'id', 123]", output: "123", explanation: "Stored under unique symbol." }
    ],
    constraints: ["Sets property via Symbol."],
    starterCode: "function setSymbolProp(obj, desc, val) {\n  // Write your solution here\n}",
    functionName: "setSymbolProp",
    testCases: [
      { id: "tc_381_1", input: "[{}, 'id', 123]", expectedOutput: "123", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_381_2", input: "[{}, 'tag', 'test']", expectedOutput: "'test'", isHidden: true }
    ],
    solution: "function setSymbolProp(obj, desc, val) {\n  const sym = Symbol(desc);\n  obj[sym] = val;\n  return obj[sym];\n}",
    explanation: "Create Symbol(desc), assign to obj, and return it.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["const sym = Symbol(desc); obj[sym] = val; return obj[sym];"]
  },
  {
    id: "JS-P382",
    number: 382,
    ...
    examples: [
      { title: "Example 1", input: "[/test/gi]", output: "/test/gi", explanation: "Clones pattern and flags." }
    ],
    constraints: ["Preserve lastIndex."],
    starterCode: "function cloneRegExp(regex) {\n  // Write your solution here\n}",
    functionName: "cloneRegExp",
    testCases: [
      { id: "tc_382_1", input: "[/test/gi]", expectedOutput: "/test/gi", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_382_2", input: "[/abc/]", expectedOutput: "/abc/", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["new RegExp(regex.source, regex.flags)."]
  },
  {
    id: "JS-P383",
    number: 383,
    ...
    examples: [
      { title: "Example 1", input: "[new Date(1600000000000)]", output: "new Date(1600000000000)", explanation: "Same epoch time." }
    ],
    constraints: ["Returns a distinct Date instance."],
    starterCode: "function cloneDate(date) {\n  // Write your solution here\n}",
    functionName: "cloneDate",
    testCases: [
      { id: "tc_383_1", input: "[new Date(1600000000000)]", expectedOutput: "new Date(1600000000000)", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_383_2", input: "[new Date(0)]", expectedOutput: "new Date(0)", isHidden: true }
    ],
    solution: "function cloneDate(date) {\n  return new Date(date.getTime());\n}",
    explanation: "new Date(date.getTime()).",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["new Date(date.getTime())."]
  },
  {
    id: "JS-P384",
    number: 384,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Method Chaining"],
    tags: ["chaining", "pipeline", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ n: 0, add(x) { this.n += x; return this; }, get() { return this.n; } }, [['add', 5], ['add', 10], ['get']]]", output: "15", explanation: "Applies calls sequentially." }
    ],
    constraints: ["Support methods returning this or values."],
    starterCode: "function pipeMethods(instance, methodCalls) {\n  // Write your solution here\n}",
    functionName: "pipeMethods",
    testCases: [
      { id: "tc_384_1", input: "[{ n: 0, add(x) { this.n += x; return this; }, get() { return this.n; } }, [['add', 5], ['add', 10], ['get']]]", expectedOutput: "15", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_384_2", input: "[{ echo(x) { return x; } }, [['echo', 42]]]", expectedOutput: "42", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Functions as Objects", "Prototypes"],
    tags: ["callable", "objects", "functions"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[x => x * 2, { desc: 'doubler' }]", output: "function with properties", explanation: "fn(5) === 10 and fn.desc === 'doubler'." }
    ],
    constraints: ["Mutates or assigns properties onto fn."],
    starterCode: "function callableObject(fn, properties) {\n  // Write your solution here\n}",
    functionName: "callableObject",
    testCases: [
      { id: "tc_385_1", input: "[x => x * 2, { desc: 'doubler' }]", expectedOutput: "function", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_385_2", input: "[() => 1, { val: 42 }]", expectedOutput: "function", isHidden: true }
    ],
    ...
    timeComplexity: "O(p)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.assign(fn, properties)."]
  },
  {
    id: "JS-P386",
    number: 386,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["this", "Monkey Patching"],
    tags: ["override", "methods", "wrapper"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ greet(name) { return `Hi ${name}`; } }, 'greet', (orig, name) => orig(name).toUpperCase()]", output: "object with overridden greet", explanation: "Wraps and transforms result." }
    ],
    constraints: ["Preserve context this inside originalMethod."],
    starterCode: "function overrideMethod(obj, methodName, wrapper) {\n  // Write your solution here\n}",
    functionName: "overrideMethod",
    testCases: [
      { id: "tc_386_1", input: "[{ greet(name) { return `Hi ${name}`; } }, 'greet', function(orig, name) { return orig.call(this, name).toUpperCase(); }]", expectedOutput: "object", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_386_2", input: "[{ get() { return 10; } }, 'get', function(orig) { return orig.call(this) * 2; }]", expectedOutput: "object", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Pass orig.bind(this) as first argument to wrapper."]
  },
  {
    id: "JS-P387",
    number: 387,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Descriptors", "Object Reflection"],
    tags: ["descriptors", "properties", "reflection"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }]", output: "descriptors map", explanation: "Contains descriptor for 'a'." }
    ],
    constraints: ["Include non-enumerable properties."],
    starterCode: "function getOwnPropertyDescriptors(obj) {\n  // Write your solution here\n}",
    functionName: "getOwnPropertyDescriptors",
    testCases: [
      { id: "tc_387_1", input: "[{ a: 1 }]", expectedOutput: "{\"a\":{\"value\":1,\"writable\":true,\"enumerable\":true,\"configurable\":true}}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_387_2", input: "[{}]", expectedOutput: "{}", isHidden: true }
    ],
    ...
    timeComplexity: "O(k)",
    spaceComplexity: "O(k)",
    hints: ["Use Object.getOwnPropertyDescriptor(obj, key)."]
  },
  {
    id: "JS-P388",
    number: 388,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.defineProperty", "Descriptors"],
    tags: ["defineProperty", "readOnly", "descriptors"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{}, 'id', 100]", output: "{\"id\":100}", explanation: "Property is read-only." }
    ],
    constraints: ["Returns obj."],
    starterCode: "function defineReadOnly(obj, prop, val) {\n  // Write your solution here\n}",
    functionName: "defineReadOnly",
    testCases: [
      { id: "tc_388_1", input: "[{}, 'id', 100]", expectedOutput: "{\"id\":100}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_388_2", input: "[{}, 'k', 'v']", expectedOutput: "{\"k\":\"v\"}", isHidden: true }
    ],
    solution: "function defineReadOnly(obj, prop, val) {\n  Object.defineProperty(obj, prop, {\n    value: val,\n    writable: false,\n    enumerable: true,\n    configurable: false\n  });\n  return obj;\n}",
    explanation: "Call Object.defineProperty with writable: false.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Object.defineProperty with writable: false."]
  },
  {
    id: "JS-P389",
    number: 389,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.defineProperty", "Getters", "Setters"],
    tags: ["getter", "setter", "defineProperty"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{}, 'val', () => 42, () => {}]", output: "{\"val\":42}", explanation: "Accessor returns 42." }
    ],
    constraints: ["Returns obj."],
    starterCode: "function defineAccessor(obj, prop, getter, setter) {\n  // Write your solution here\n}",
    functionName: "defineAccessor",
    testCases: [
      { id: "tc_389_1", input: "[{}, 'val', () => 42, () => {}]", expectedOutput: "{\"val\":42}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_389_2", input: "[{}, 'fixed', () => 100, () => {}]", expectedOutput: "{\"fixed\":100}", isHidden: true }
    ],
    solution: "function defineAccessor(obj, prop, getter, setter) {\n  Object.defineProperty(obj, prop, {\n    get: getter,\n    set: setter,\n    enumerable: true,\n    configurable: true\n  });\n  return obj;\n}",
    explanation: "Call Object.defineProperty with get and set options.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use get and set in property descriptor."]
  },
  {
    id: "JS-P390",
    number: 390,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.preventExtensions", "Integrity"],
    tags: ["preventExtensions", "integrity", "objects"],
    expectedTime: "3 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ a: 1 }]", output: "{\"a\":1}", explanation: "Object is no longer extensible." }
    ],
    constraints: ["Returns obj."],
    starterCode: "function preventExtensions(obj) {\n  // Write your solution here\n}",
    functionName: "preventExtensions",
    testCases: [
      { id: "tc_390_1", input: "[{ a: 1 }]", expectedOutput: "{\"a\":1}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_390_2", input: "[{ x: 10 }]", expectedOutput: "{\"x\":10}", isHidden: true }
    ],
    solution: "function preventExtensions(obj) {\n  return Object.preventExtensions(obj);\n}",
    explanation: "Apply Object.preventExtensions.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.preventExtensions(obj)."]
  },
  {
    id: "JS-P391",
    number: 391,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Classes", "Inheritance", "Factory"],
    tags: ["subclass", "classes", "inheritance"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ x: 5 }, { double() { return this.x * 2; } }, [['double']]]", output: "[10]", explanation: "Calls double()." }
    ],
    constraints: ["methods attached to instance."],
    starterCode: "function createSubclassInstance(initial, methods) {\n  // Write your solution here\n}",
    functionName: "createSubclassInstance",
    testCases: [
      { id: "tc_391_1", input: "[{ x: 5 }, { double() { return this.x * 2; } }, [['double']]]", expectedOutput: "[10]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_391_2", input: "[{ v: 100 }, { get() { return this.v; } }, [['get']]]", expectedOutput: "[100]", isHidden: true }
    ],
    ...
    timeComplexity: "O(m)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.create(methods) and assign initial."]
  },
  {
    id: "JS-P392",
    number: 392,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["OOP", "Polymorphism", "Classes"],
    tags: ["polymorphism", "oop", "shapes"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "['rectangle', 4, 5, [['area'], ['perimeter']]]", output: "[20, 18]", explanation: "Rectangle methods." }
    ],
    constraints: ["Returns object with area() and perimeter()."],
    starterCode: "function createShape(type, ...dimensions) {\n  // Write your solution here\n}",
    functionName: "createShape",
    testCases: [
      { id: "tc_392_1", input: "['rectangle', 4, 5, [['area'], ['perimeter']]]", expectedOutput: "[20, 18]", isHidden: false },
      { id: "tc_392_2", input: "['square', 6, [['area'], ['perimeter']]]", expectedOutput: "[36, 24]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_392_3", input: "['circle', 1, [['area']]]", expectedOutput: "[3.141592653589793]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Implement branch for circle, rectangle, square."]
  },
  {
    id: "JS-P393",
    number: 393,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "isPrototypeOf"],
    tags: ["isPrototypeOf", "prototype"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[Array.prototype, []]", output: "true", explanation: "Array.prototype is in [] chain." }
    ],
    constraints: ["Return false if obj is null or undefined."],
    starterCode: "function isPrototypeOf(proto, obj) {\n  // Write your solution here\n}",
    functionName: "isPrototypeOf",
    testCases: [
      { id: "tc_393_1", input: "[Array.prototype, []]", expectedOutput: "true", isHidden: false },
      { id: "tc_393_2", input: "[Object.prototype, Object.create(null)]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_393_3", input: "[Function.prototype, () => {}]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isPrototypeOf(proto, obj) {\n  if (obj === null || obj === undefined) return false;\n  let cur = Object.getPrototypeOf(obj);\n  while (cur !== null) {\n    if (cur === proto) return true;\n    cur = Object.getPrototypeOf(cur);\n  }\n  return false;\n}",
    explanation: "Traverse prototype chain comparing cur to proto.",
    timeComplexity: "O(d)",
    spaceComplexity: "O(1)",
    hints: ["While loop with Object.getPrototypeOf."]
  },
  {
    id: "JS-P394",
    number: 394,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Object.setPrototypeOf", "Prototypes"],
    tags: ["setPrototypeOf", "prototype"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{}, { test: 123 }]", output: "{}", explanation: "obj inherits from proto." }
    ],
    constraints: ["Returns obj."],
    starterCode: "function setPrototypeOf(obj, proto) {\n  // Write your solution here\n}",
    functionName: "setPrototypeOf",
    testCases: [
      { id: "tc_394_1", input: "[{}, { test: 123 }]", expectedOutput: "{}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_394_2", input: "[{}, null]", expectedOutput: "{}", isHidden: true }
    ],
    solution: "function setPrototypeOf(obj, proto) {\n  return Object.setPrototypeOf(obj, proto);\n}",
    explanation: "Use Object.setPrototypeOf.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Object.setPrototypeOf(obj, proto)."]
  },
  {
    id: "JS-P395",
    number: 395,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Decorators", "Memoization", "this"],
    tags: ["decorator", "memoize", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ calc(x) { return x * 2; } }, 'calc']", output: "object with memoized calc", explanation: "Caches calls." }
    ],
    constraints: ["Preserve this context."],
    starterCode: "function memoizeMethod(obj, methodName) {\n  // Write your solution here\n}",
    functionName: "memoizeMethod",
    testCases: [
      { id: "tc_395_1", input: "[{ calc(x) { return x * 2; } }, 'calc']", expectedOutput: "object", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_395_2", input: "[{ square(n) { return n * n; } }, 'square']", expectedOutput: "object", isHidden: true }
    ],
    ...
    spaceComplexity: "O(m)",
    hints: ["Replace method with wrapper querying cache Map."]
  },
  {
    id: "JS-P396",
    number: 396,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["AOP", "this", "Hooks"],
    tags: ["hooks", "aop", "methods"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ fn(x) { return x * 2; } }, 'fn', { before: () => {}, after: () => {} }]", output: "object with hooked fn", explanation: "Hooks trigger around method." }
    ],
    constraints: ["Preserve return value and this."],
    starterCode: "function attachHooks(obj, methodName, { before, after }) {\n  // Write your solution here\n}",
    functionName: "attachHooks",
    testCases: [
      { id: "tc_396_1", input: "[{ fn(x) { return x * 2; } }, 'fn', { before: () => {}, after: () => {} }]", expectedOutput: "object", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_396_2", input: "[{ add(a, b) { return a + b; } }, 'add', {}]", expectedOutput: "object", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Call before, invoke orig, call after."]
  },
  {
    id: "JS-P397",
    number: 397,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["OOP", "Polymorphism"],
    tags: ["polymorphism", "area", "shapes"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[{ area: () => 10 }, { area: () => 20 }]]", output: "30", explanation: "10 + 20 = 30." }
    ],
    constraints: ["Each item in shapes implements area()."],
    starterCode: "function totalArea(shapes) {\n  // Write your solution here\n}",
    functionName: "totalArea",
    testCases: [
      { id: "tc_397_1", input: "[[{ area: () => 10 }, { area: () => 20 }]]", expectedOutput: "30", isHidden: false },
      { id: "tc_397_2", input: "[[]]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_397_3", input: "[[{ area: () => 42 }]]", expectedOutput: "42", isHidden: true }
    ],
    solution: "function totalArea(shapes) {\n  return shapes.reduce((sum, shape) => sum + shape.area(), 0);\n}",
    explanation: "Reduce over shapes invoking shape.area().",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["shapes.reduce((sum, s) => sum + s.area(), 0)."]
  },
  {
    id: "JS-P398",
    number: 398,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Prototypes", "Extension"],
    tags: ["prototype", "methods", "extend"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function Greeter() {}, { hi() { return 'hi'; } }]", output: "function", explanation: "Adds hi to prototype." }
    ],
    constraints: ["Mutates Constructor.prototype."],
    starterCode: "function extendPrototype(Constructor, methods) {\n  // Write your solution here\n}",
    functionName: "extendPrototype",
    testCases: [
      { id: "tc_398_1", input: "[function G() {}, { hi() { return 'hi'; } }]", expectedOutput: "function", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_398_2", input: "[function C() {}, { val: 42 }]", expectedOutput: "function", isHidden: true }
    ],
    ...
    timeComplexity: "O(m)",
    spaceComplexity: "O(1)",
    hints: ["Object.assign(Constructor.prototype, methods)."]
  },
  {
    id: "JS-P399",
    number: 399,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Prototypes", "Inherited Properties"],
    tags: ["flatten", "prototypes", "properties"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[Object.assign(Object.create({ a: 1 }), { b: 2 })]", output: "{\"a\":1,\"b\":2}", explanation: "Includes inherited a and own b." }
    ],
    constraints: ["Returns a new plain object."],
    starterCode: "function flattenPrototypeChain(obj) {\n  // Write your solution here\n}",
    functionName: "flattenPrototypeChain",
    testCases: [
      { id: "tc_399_1", input: "[Object.assign(Object.create({ a: 1 }), { b: 2 })]", expectedOutput: "{\"a\":1,\"b\":2}", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_399_2", input: "[{ x: 10 }]", expectedOutput: "{\"x\":10}", isHidden: true }
    ],
    solution: "function flattenPrototypeChain(obj) {\n  if (obj === null || obj === undefined) return {};\n  const result = {};\n  for (const key in obj) {\n    result[key] = obj[key];\n  }\n  return result;\n}",
    explanation: "for...in iterates over own and inherited enumerable properties.",
    timeComplexity: "O(p)",
    spaceComplexity: "O(p)",
    hints: ["A for...in loop naturally traverses inherited enumerable properties."]
  },
  {
    id: "JS-P400",
    number: 400,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Classes", "Prototypes", "Constructors"],
    tags: ["classBuilder", "oop", "prototypes"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[function(name) { this.name = name; }, { greet() { return `Hi ${this.name}`; } }, { version: '1.0' }]", output: "function", explanation: "Returns constructor function." }
    ],
    constraints: ["Support 'new' invocation."],
    starterCode: "function createClass(initFn, methods, staticMethods) {\n  // Write your solution here\n}",
    functionName: "createClass",
    testCases: [
      { id: "tc_400_1", input: "[function(n) { this.n = n; }, { double() { return this.n * 2; } }, { ver: '1.0' }]", expectedOutput: "function", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_400_2", input: "[function() { this.ok = true; }, {}, {}]", expectedOutput: "function", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Assign methods to Cls.prototype and staticMethods to Cls."]
  }
];

async function buildAndTestBatch08() {
  console.log(`Testing Batch 08 (${b08.length} questions)...`);
  const passed = await testBatch(b08);
  if (!passed) throw new Error('Batch 08 verification failed!');

  const outPath = path.join(process.cwd(), 'src/components/coreprogramming/data/batches/batch08.ts');
  const fileContent = `// src/components/coreprogramming/data/batches/batch08.ts
import type { CoreProgrammingQuestion } from '../coreProgrammingTypes';

export const batch08: CoreProgrammingQuestion[] = ${JSON.stringify(b08, null, 2)};
`;

  fs.writeFileSync(outPath, fileContent, 'utf-8');
  console.log('Successfully wrote 50 verified questions to batch08.ts!');
}

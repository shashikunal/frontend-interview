// scripts/build-core-programming.js
const fs = require('fs');
...
function getDifficulty(num) {
  // First 125 have higher proportion of Easy (e.g. 1..125: 125 Easy)
  // But let's distribute logically:
  // 1..75: Easy (75)
  // 76..125: Easy (50) -> total Easy = 125
  // 126..375: Medium (250) -> total Medium = 250
  // 376..475: Hard (100) -> total Hard = 100
  // 476..500: Expert (25) -> total Expert = 25

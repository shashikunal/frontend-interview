...
const b01: CoreProgrammingQuestion[] = [
  {
    id: "JS-P001",
    number: 1,
  ...
  },
  {
    ...
    examples: [
      { title: "Example 1", input: "[1, 5, 3]", output: "5", explanation: "5 is the largest." },
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Numbers", "Recursion", "Loops"],
    tags: ["numbers", "factorial", "math"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[5]", output: "120", explanation: "5 * 4 * 3 * 2 * 1 = 120." },
      { title: "Example 2", input: "[0]", output: "1", explanation: "0! is 1." }
    ],
    constraints: ["0 <= n <= 18"],
    starterCode: "function factorial(n) {\n  // Write your solution here\n}",
    functionName: "factorial",
    testCases: [
      { id: "tc_11_1", input: "[5]", expectedOutput: "120", isHidden: false },
      { id: "tc_11_2", input: "[0]", expectedOutput: "1", isHidden: false },
      { id: "tc_11_3", input: "[1]", expectedOutput: "1", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_11_4", input: "[3]", expectedOutput: "6", isHidden: true },
      { id: "tc_11_5", input: "[7]", expectedOutput: "5040", isHidden: true }
    ],
    solution: "function factorial(n) {\n  if (n < 0) return null;\n  let res = 1;\n  for (let i = 2; i <= n; i++) res *= i;\n  return res;\n}",
    explanation: "Iterate from 2 up to n multiplying into result.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use an iterative loop from 2 to n."]
  },
  {
    id: "JS-P012",
    number: 12,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Numbers", "Dynamic Programming"],
    tags: ["numbers", "fibonacci", "dp"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[4]", output: "3", explanation: "Sequence: 0, 1, 1, 2, 3." },
      { title: "Example 2", input: "[6]", output: "8", explanation: "Sequence up to 6: 0, 1, 1, 2, 3, 5, 8." }
    ],
    constraints: ["0 <= n <= 40"],
    starterCode: "function fibonacci(n) {\n  // Write your solution here\n}",
    functionName: "fibonacci",
    testCases: [
      { id: "tc_12_1", input: "[0]", expectedOutput: "0", isHidden: false },
      { id: "tc_12_2", input: "[1]", expectedOutput: "1", isHidden: false },
      { id: "tc_12_3", input: "[4]", expectedOutput: "3", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_12_4", input: "[6]", expectedOutput: "8", isHidden: true },
      { id: "tc_12_5", input: "[10]", expectedOutput: "55", isHidden: true }
    ],
    solution: "function fibonacci(n) {\n  if (n <= 0) return 0;\n  if (n === 1) return 1;\n  let a = 0, b = 1;\n  for (let i = 2; i <= n; i++) {\n    const c = a + b;\n    a = b;\n    b = c;\n  }\n  return b;\n}",
    explanation: "Iterate from 2 to n with two variables in O(n) time and O(1) space.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use two variables to track the previous two values rather than exponential recursion."]
  },
  {
    id: "JS-P013",
    number: 13,
    ...
    examples: [
      { title: "Example 1", input: "[7]", output: "true", explanation: "7 is prime." },
      { title: "Example 2", input: "[4]", output: "false", explanation: "4 is divisible by 2." },
      { title: "Example 3", input: "[1]", output: "false", explanation: "1 is not prime." }
    ],
    constraints: ["0 <= n <= 10^7"],
    starterCode: "function isPrime(n) {\n  // Write your solution here\n}",
    functionName: "isPrime",
    testCases: [
      { id: "tc_13_1", input: "[7]", expectedOutput: "true", isHidden: false },
      { id: "tc_13_2", input: "[4]", expectedOutput: "false", isHidden: false },
      { id: "tc_13_3", input: "[1]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_13_4", input: "[2]", expectedOutput: "true", isHidden: true },
      { id: "tc_13_5", input: "[17]", expectedOutput: "true", isHidden: true },
      { id: "tc_13_6", input: "[25]", expectedOutput: "false", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["Check divisibility only up to Math.sqrt(n)."]
  },
  {
    id: "JS-P014",
    number: 14,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Numbers", "Math", "Euclidean Algorithm"],
    tags: ["numbers", "gcd", "math"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[12, 18]", output: "6", explanation: "Common factors: 1, 2, 3, 6. Greatest is 6." },
      { title: "Example 2", input: "[10, 5]", output: "5", explanation: "5 divides 10." }
    ],
    constraints: ["1 <= a, b <= 10^9"],
    starterCode: "function gcd(a, b) {\n  // Write your solution here\n}",
    functionName: "gcd",
    testCases: [
      { id: "tc_14_1", input: "[12, 18]", expectedOutput: "6", isHidden: false },
      { id: "tc_14_2", input: "[10, 5]", expectedOutput: "5", isHidden: false },
      { id: "tc_14_3", input: "[17, 13]", expectedOutput: "1", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_14_4", input: "[48, 18]", expectedOutput: "6", isHidden: true },
      { id: "tc_14_5", input: "[100, 25]", expectedOutput: "25", isHidden: true }
    ],
    solution: "function gcd(a, b) {\n  while (b) {\n    const t = b;\n    b = a % b;\n    a = t;\n  }\n  return Math.abs(a);\n}",
    explanation: "Euclid's algorithm replaces (a, b) with (b, a % b) until b is 0 in logarithmic time.",
    timeComplexity: "O(log(min(a, b)))",
    spaceComplexity: "O(1)",
    hints: ["Use Euclid's algorithm: gcd(a, b) = gcd(b, a % b)."]
  },
  {
    id: "JS-P015",
    number: 15,
    ...
    examples: [
      { title: "Example 1", input: "[4, 6]", output: "12", explanation: "Multiples of 4: 4,8,12; multiples of 6: 6,12. Least common is 12." },
      { title: "Example 2", input: "[5, 10]", output: "10", explanation: "10 is multiple of 5 and 10." }
    ],
    constraints: ["1 <= a, b <= 10^5"],
    starterCode: "function lcm(a, b) {\n  // Write your solution here\n}",
    functionName: "lcm",
    testCases: [
      { id: "tc_15_1", input: "[4, 6]", expectedOutput: "12", isHidden: false },
      { id: "tc_15_2", input: "[5, 10]", expectedOutput: "10", isHidden: false },
      { id: "tc_15_3", input: "[3, 7]", expectedOutput: "21", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_15_4", input: "[12, 15]", expectedOutput: "60", isHidden: true },
      { id: "tc_15_5", input: "[8, 12]", expectedOutput: "24", isHidden: true }
    ],
    solution: "function lcm(a, b) {\n  function gcd(x, y) {\n    while (y) {\n      const t = y;\n      y = x % y;\n      x = t;\n    }\n    return x;\n  }\n  return (a * b) / gcd(a, b);\n}",
    explanation: "LCM(a, b) = (a * b) / GCD(a, b).",
    timeComplexity: "O(log(min(a, b)))",
    spaceComplexity: "O(1)",
    hints: ["Use the relation lcm(a, b) = (a * b) / gcd(a, b)."]
  },
  {
    id: "JS-P016",
    number: 16,
    ...
    examples: [
      { title: "Example 1", input: "[123]", output: "6", explanation: "1 + 2 + 3 = 6." },
      { title: "Example 2", input: "[905]", output: "14", explanation: "9 + 0 + 5 = 14." }
    ],
    constraints: ["-10^15 <= n <= 10^15"],
    starterCode: "function sumDigits(n) {\n  // Write your solution here\n}",
    functionName: "sumDigits",
    testCases: [
      { id: "tc_16_1", input: "[123]", expectedOutput: "6", isHidden: false },
      { id: "tc_16_2", input: "[905]", expectedOutput: "14", isHidden: false },
      { id: "tc_16_3", input: "[0]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_16_4", input: "[-456]", expectedOutput: "15", isHidden: true },
      { id: "tc_16_5", input: "[9999]", expectedOutput: "36", isHidden: true }
    ],
    ...
    hints: ["Iterate through digits using modulo 10 or split string."]
  },
  {
    id: "JS-P017",
    number: 17,
    ...
    examples: [
      { title: "Example 1", input: "[153]", output: "true", explanation: "1^3 + 5^3 + 3^3 = 1 + 125 + 27 = 153." },
      { title: "Example 2", input: "[370]", output: "true", explanation: "3^3 + 7^3 + 0^3 = 27 + 343 + 0 = 370." },
      { title: "Example 3", input: "[120]", output: "false", explanation: "1^3 + 2^3 + 0^3 = 9 != 120." }
    ],
    constraints: ["0 <= n <= 10^9"],
    starterCode: "function isArmstrong(n) {\n  // Write your solution here\n}",
    functionName: "isArmstrong",
    testCases: [
      { id: "tc_17_1", input: "[153]", expectedOutput: "true", isHidden: false },
      { id: "tc_17_2", input: "[370]", expectedOutput: "true", isHidden: false },
      { id: "tc_17_3", input: "[120]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_17_4", input: "[9]", expectedOutput: "true", isHidden: true },
      { id: "tc_17_5", input: "[9474]", expectedOutput: "true", isHidden: true }
    ],
    ...
    timeComplexity: "O(log10(n))",
    spaceComplexity: "O(1)",
    hints: ["Find the number of digits k, then sum d^k for each digit d."]
  },
  {
    id: "JS-P018",
    number: 18,
    ...
    examples: [
      { title: "Example 1", input: "[2, 3]", output: "8", explanation: "2 * 2 * 2 = 8." },
      { title: "Example 2", input: "[5, 0]", output: "1", explanation: "Any non-zero base to 0 is 1." }
    ],
    constraints: ["-100 <= base <= 100", "0 <= exp <= 20"],
    starterCode: "function power(base, exp) {\n  // Write your solution here\n}",
    functionName: "power",
    testCases: [
      { id: "tc_18_1", input: "[2, 3]", expectedOutput: "8", isHidden: false },
      { id: "tc_18_2", input: "[5, 0]", expectedOutput: "1", isHidden: false },
      { id: "tc_18_3", input: "[3, 4]", expectedOutput: "81", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_18_4", input: "[10, 5]", expectedOutput: "100000", isHidden: true },
      { id: "tc_18_5", input: "[0, 5]", expectedOutput: "0", isHidden: true }
    ],
    solution: "function power(base, exp) {\n  return Math.pow(base, exp);\n}",
    explanation: "Math.pow handles exponentiation in O(1) time.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use Math.pow(base, exp) or the ** operator."]
  },
  {
    id: "JS-P019",
    number: 19,
    ...
    questionType: "Coding",
    skills: ["Numbers", "Math"],
    tags: ["numbers", "perfect-number", "math"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[6]", output: "true", explanation: "1 + 2 + 3 = 6." },
      { title: "Example 2", input: "[28]", output: "true", explanation: "1 + 2 + 4 + 7 + 14 = 28." },
      { title: "Example 3", input: "[12]", output: "false", explanation: "1 + 2 + 3 + 4 + 6 = 16 != 12." }
    ],
    constraints: ["1 <= n <= 10^8"],
    starterCode: "function isPerfectNumber(n) {\n  // Write your solution here\n}",
    functionName: "isPerfectNumber",
    testCases: [
      { id: "tc_19_1", input: "[6]", expectedOutput: "true", isHidden: false },
      { id: "tc_19_2", input: "[28]", expectedOutput: "true", isHidden: false },
      { id: "tc_19_3", input: "[12]", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_19_4", input: "[1]", expectedOutput: "false", isHidden: true },
      { id: "tc_19_5", input: "[496]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isPerfectNumber(n) {\n  if (n <= 1) return false;\n  let sum = 1;\n  for (let i = 2; i * i <= n; i++) {\n    if (n % i === 0) {\n      sum += i;\n      if (i * i !== n) sum += n / i;\n    }\n  }\n  return sum === n;\n}",
    explanation: "Sum proper divisors up to sqrt(n) and compare to n.",
    timeComplexity: "O(sqrt(n))",
    spaceComplexity: "O(1)",
    hints: ["Iterate up to sqrt(n) and add both divisor pairs."]
  },
  {
    id: "JS-P020",
    number: 20,
    ...
    examples: [
      { title: "Example 1", input: "['hello world']", output: "3", explanation: "'e', 'o', 'o' make 3 vowels." },
      { title: "Example 2", input: "['xyz']", output: "0", explanation: "No vowels." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function countVowels(str) {\n  // Write your solution here\n}",
    functionName: "countVowels",
    testCases: [
      { id: "tc_20_1", input: "['hello world']", expectedOutput: "3", isHidden: false },
      { id: "tc_20_2", input: "['xyz']", expectedOutput: "0", isHidden: false },
      { id: "tc_20_3", input: "['AEIOUaeiou']", expectedOutput: "10", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_20_4", input: "['']", expectedOutput: "0", isHidden: true },
      { id: "tc_20_5", input: "['JavaScript']", expectedOutput: "3", isHidden: true }
    ],
    solution: "function countVowels(str) {\n  const matches = str.match(/[aeiou]/gi);\n  return matches ? matches.length : 0;\n}",
    explanation: "Use a regular expression matching [aeiou] case-insensitively.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use a regex with [aeiou] or iterate through characters checking against a Set of vowels."]
  },
  {
    id: "JS-P021",
    number: 21,
    ...
    questionType: "Coding",
    skills: ["Strings", "Regex"],
    tags: ["strings", "consonants", "counting"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['hello world']", output: "7", explanation: "h, l, l, w, r, l, d = 7." },
      { title: "Example 2", input: "['123!']", output: "0", explanation: "No letters." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function countConsonants(str) {\n  // Write your solution here\n}",
    functionName: "countConsonants",
    testCases: [
      { id: "tc_21_1", input: "['hello world']", expectedOutput: "7", isHidden: false },
      { id: "tc_21_2", input: "['abc']", expectedOutput: "2", isHidden: false },
      { id: "tc_21_3", input: "['123!']", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_21_4", input: "['aeiou']", expectedOutput: "0", isHidden: true },
      { id: "tc_21_5", input: "['JavaScript']", expectedOutput: "7", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use regex /[bcdfghjklmnpqrstvwxyz]/gi."]
  },
  {
    id: "JS-P022",
    number: 22,
    ...
    examples: [
      { title: "Example 1", input: "['hello world']", output: "'hll wrld'", explanation: "e, o, o are removed." },
      { title: "Example 2", input: "['apple']", output: "'ppl'", explanation: "a and e are removed." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function removeVowels(str) {\n  // Write your solution here\n}",
    functionName: "removeVowels",
    testCases: [
      { id: "tc_22_1", input: "['hello world']", expectedOutput: "'hll wrld'", isHidden: false },
      { id: "tc_22_2", input: "['apple']", expectedOutput: "'ppl'", isHidden: false },
      { id: "tc_22_3", input: "['aeiou']", expectedOutput: "''", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_22_4", input: "['xyz']", expectedOutput: "'xyz'", isHidden: true },
      { id: "tc_22_5", input: "['JavaScript']", expectedOutput: "'JvScrpt'", isHidden: true }
    ],
    solution: "function removeVowels(str) {\n  return str.replace(/[aeiou]/gi, '');\n}",
    explanation: "Use String.prototype.replace with a global case-insensitive regex.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use str.replace(/[aeiou]/gi, '')."]
  },
  {
    id: "JS-P023",
    number: 23,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Strings", "Formatting"],
    tags: ["strings", "capitalize", "format"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['hello']", output: "'Hello'", explanation: "'h' becomes 'H'." },
      { title: "Example 2", input: "['world']", output: "'World'", explanation: "'w' becomes 'W'." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function capitalize(str) {\n  // Write your solution here\n}",
    functionName: "capitalize",
    testCases: [
      { id: "tc_23_1", input: "['hello']", expectedOutput: "'Hello'", isHidden: false },
      { id: "tc_23_2", input: "['world']", expectedOutput: "'World'", isHidden: false },
      { id: "tc_23_3", input: "['']", expectedOutput: "''", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_23_4", input: "['a']", expectedOutput: "'A'", isHidden: true },
      { id: "tc_23_5", input: "['already']", expectedOutput: "'Already'", isHidden: true }
    ],
    solution: "function capitalize(str) {\n  if (!str) return '';\n  return str.charAt(0).toUpperCase() + str.slice(1);\n}",
    explanation: "Upper-case charAt(0) and concatenate with the slice from index 1.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use str.charAt(0).toUpperCase() + str.slice(1)."]
  },
  {
    id: "JS-P024",
    number: 24,
    ...
    examples: [
      { title: "Example 1", input: "['listen', 'silent']", output: "true", explanation: "Both words contain the exact same letters." },
      { title: "Example 2", input: "['hello', 'world']", output: "false", explanation: "Different letters." }
    ],
    constraints: ["0 <= str1.length, str2.length <= 10^5"],
    starterCode: "function areAnagrams(str1, str2) {\n  // Write your solution here\n}",
    functionName: "areAnagrams",
    testCases: [
      { id: "tc_24_1", input: "['listen', 'silent']", expectedOutput: "true", isHidden: false },
      { id: "tc_24_2", input: "['hello', 'world']", expectedOutput: "false", isHidden: false },
      { id: "tc_24_3", input: "['rat', 'car']", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_24_4", input: "['', '']", expectedOutput: "true", isHidden: true },
      { id: "tc_24_5", input: "['anagram', 'nagaram']", expectedOutput: "true", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Check lengths first, then compare sorted character arrays or character frequency maps."]
  },
  {
    id: "JS-P025",
    number: 25,
    ...
    questionType: "Coding",
    skills: ["Numbers", "Math"],
    tags: ["math", "conversion", "temperature"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[0]", output: "32", explanation: "0°C is 32°F." },
      { title: "Example 2", input: "[100]", output: "212", explanation: "100°C is 212°F." }
    ],
    constraints: ["-273.15 <= c <= 10^5"],
    starterCode: "function celsiusToFahrenheit(c) {\n  // Write your solution here\n}",
    functionName: "celsiusToFahrenheit",
    testCases: [
      { id: "tc_25_1", input: "[0]", expectedOutput: "32", isHidden: false },
      { id: "tc_25_2", input: "[100]", expectedOutput: "212", isHidden: false },
      { id: "tc_25_3", input: "[-40]", expectedOutput: "-40", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_25_4", input: "[25]", expectedOutput: "77", isHidden: true },
      { id: "tc_25_5", input: "[37]", expectedOutput: "98.6", isHidden: true }
    ],
    solution: "function celsiusToFahrenheit(c) {\n  return (c * 9) / 5 + 32;\n}",
    explanation: "Apply the linear formula (C * 9/5) + 32.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Formula: (c * 9/5) + 32."]
  },
  {
    id: "JS-P026",
    number: 26,
    ...
    examples: [
      { title: "Example 1", input: "[32]", output: "0", explanation: "32°F is 0°C." },
      { title: "Example 2", input: "[212]", output: "100", explanation: "212°F is 100°C." }
    ],
    constraints: ["-459.67 <= f <= 10^5"],
    starterCode: "function fahrenheitToCelsius(f) {\n  // Write your solution here\n}",
    functionName: "fahrenheitToCelsius",
    testCases: [
      { id: "tc_26_1", input: "[32]", expectedOutput: "0", isHidden: false },
      { id: "tc_26_2", input: "[212]", expectedOutput: "100", isHidden: false },
      { id: "tc_26_3", input: "[-40]", expectedOutput: "-40", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_26_4", input: "[77]", expectedOutput: "25", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Conditionals", "Modulo"],
    tags: ["logic", "dates", "modulo"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[2024]", output: "true", explanation: "2024 is divisible by 4 and not 100." },
      { title: "Example 2", input: "[1900]", output: "false", explanation: "1900 is divisible by 100 but not 400." },
      { title: "Example 3", input: "[2000]", output: "true", explanation: "2000 is divisible by 400." }
    ],
    constraints: ["1 <= year <= 10^5"],
    starterCode: "function isLeapYear(year) {\n  // Write your solution here\n}",
    functionName: "isLeapYear",
    testCases: [
      { id: "tc_27_1", input: "[2024]", expectedOutput: "true", isHidden: false },
      { id: "tc_27_2", input: "[1900]", expectedOutput: "false", isHidden: false },
      { id: "tc_27_3", input: "[2000]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_27_4", input: "[2023]", expectedOutput: "false", isHidden: true },
      { id: "tc_27_5", input: "[1600]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isLeapYear(year) {\n  return (year % 4 === 0 && year % 100 !== 0) || year % 400 === 0;\n}",
    explanation: "Check (year % 4 === 0 && year % 100 !== 0) || (year % 400 === 0).",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Divisible by 4 and not 100, or divisible by 400."]
  },
  {
    id: "JS-P028",
    number: 28,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Strings", "Conditionals"],
    tags: ["strings", "vowel", "logic"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['a']", output: "true", explanation: "'a' is a vowel." },
      { title: "Example 2", input: "['B']", output: "false", explanation: "'B' is a consonant." }
    ],
    constraints: ["char.length === 1"],
    starterCode: "function isVowel(char) {\n  // Write your solution here\n}",
    functionName: "isVowel",
    testCases: [
      { id: "tc_28_1", input: "['a']", expectedOutput: "true", isHidden: false },
      { id: "tc_28_2", input: "['E']", expectedOutput: "true", isHidden: false },
      { id: "tc_28_3", input: "['x']", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_28_4", input: "['u']", expectedOutput: "true", isHidden: true },
      { id: "tc_28_5", input: "['1']", expectedOutput: "false", isHidden: true }
    ],
    solution: "function isVowel(char) {\n  return 'aeiouAEIOU'.includes(char);\n}",
    explanation: "Check membership in 'aeiouAEIOU'.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use 'aeiouAEIOU'.includes(char)."]
  },
  {
    id: "JS-P029",
    number: 29,
    ...
    examples: [
      { title: "Example 1", input: "['banana', 'a']", output: "3", explanation: "'a' appears 3 times in 'banana'." },
      { title: "Example 2", input: "['hello', 'z']", output: "0", explanation: "'z' is not present." }
    ],
    constraints: ["0 <= str.length <= 10^5", "char.length === 1"],
    starterCode: "function countChar(str, char) {\n  // Write your solution here\n}",
    functionName: "countChar",
    testCases: [
      { id: "tc_29_1", input: "['banana', 'a']", expectedOutput: "3", isHidden: false },
      { id: "tc_29_2", input: "['hello', 'l']", expectedOutput: "2", isHidden: false },
      { id: "tc_29_3", input: "['hello', 'z']", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_29_4", input: "['', 'a']", expectedOutput: "0", isHidden: true },
      { id: "tc_29_5", input: "['AAAAA', 'A']", expectedOutput: "5", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Iterate through each character and check if str[i] === char."]
  },
  {
    id: "JS-P030",
    number: 30,
    ...
    tags: ["strings", "truncate", "ui-utility"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['Hello World', 8]", output: "'Hello...'", explanation: "5 characters + '...' = 8 characters." },
      { title: "Example 2", input: "['Hi', 5]", output: "'Hi'", explanation: "Length is within limit." }
    ],
    constraints: ["0 <= str.length <= 10^5", "3 <= maxLength <= 10^5"],
    starterCode: "function truncate(str, maxLength) {\n  // Write your solution here\n}",
    functionName: "truncate",
    testCases: [
      { id: "tc_30_1", input: "['Hello World', 8]", expectedOutput: "'Hello...'", isHidden: false },
      { id: "tc_30_2", input: "['Hi', 5]", expectedOutput: "'Hi'", isHidden: false },
      { id: "tc_30_3", input: "['JavaScript', 10]", expectedOutput: "'JavaScript'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_30_4", input: "['Testing', 4]", expectedOutput: "'T...'", isHidden: true },
      { id: "tc_30_5", input: "['', 5]", expectedOutput: "''", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Check if str.length <= maxLength, otherwise return str.slice(0, maxLength - 3) + '...'."]
  },
  {
    id: "JS-P031",
    number: 31,
    ...
    examples: [
      { title: "Example 1", input: "['abc', 3]", output: "'abcabcabc'", explanation: "'abc' repeated 3 times." },
      { title: "Example 2", input: "['hi', 0]", output: "''", explanation: "0 repeats yields empty string." }
    ],
    constraints: ["0 <= str.length <= 100", "0 <= n <= 1000"],
    starterCode: "function repeatString(str, n) {\n  // Write your solution here\n}",
    functionName: "repeatString",
    testCases: [
      { id: "tc_31_1", input: "['abc', 3]", expectedOutput: "'abcabcabc'", isHidden: false },
      { id: "tc_31_2", input: "['hi', 0]", expectedOutput: "''", isHidden: false },
      { id: "tc_31_3", input: "['!', 4]", expectedOutput: "'!!!!'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_31_4", input: "['', 5]", expectedOutput: "''", isHidden: true },
      { id: "tc_31_5", input: "['ab', 1]", expectedOutput: "'ab'", isHidden: true }
    ],
    ...
    hints: ["Use str.repeat(n) or a loop."]
  },
  {
    id: "JS-P032",
    number: 32,
    ...
    examples: [
      { title: "Example 1", input: "['hello world', 'hello']", output: "true", explanation: "'hello world' begins with 'hello'." },
      { title: "Example 2", input: "['javascript', 'java']", output: "true", explanation: "'javascript' starts with 'java'." },
      { title: "Example 3", input: "['react', 'vue']", output: "false", explanation: "Does not start with 'vue'." }
    ],
    constraints: ["0 <= str.length, prefix.length <= 10^5"],
    starterCode: "function startsWith(str, prefix) {\n  // Write your solution here\n}",
    functionName: "startsWith",
    testCases: [
      { id: "tc_32_1", input: "['hello world', 'hello']", expectedOutput: "true", isHidden: false },
      { id: "tc_32_2", input: "['javascript', 'java']", expectedOutput: "true", isHidden: false },
      { id: "tc_32_3", input: "['react', 'vue']", expectedOutput: "false", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_32_4", input: "['anything', '']", expectedOutput: "true", isHidden: true },
      { id: "tc_32_5", input: "['short', 'longerPrefix']", expectedOutput: "false", isHidden: true }
    ],
    ...
    timeComplexity: "O(m)",
    spaceComplexity: "O(1)",
    hints: ["Use str.startsWith(prefix)."]
  },
  {
    id: "JS-P033",
    number: 33,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Strings", "Suffixes"],
    tags: ["strings", "suffix", "endsWith"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['picture.png', '.png']", output: "true", explanation: "Ends with '.png'." },
      { title: "Example 2", input: "['index.html', '.js']", output: "false", explanation: "Does not end with '.js'." }
    ],
    constraints: ["0 <= str.length, suffix.length <= 10^5"],
    starterCode: "function endsWith(str, suffix) {\n  // Write your solution here\n}",
    functionName: "endsWith",
    testCases: [
      { id: "tc_33_1", input: "['picture.png', '.png']", expectedOutput: "true", isHidden: false },
      { id: "tc_33_2", input: "['index.html', '.js']", expectedOutput: "false", isHidden: false },
      { id: "tc_33_3", input: "['hello', 'o']", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_33_4", input: "['test', '']", expectedOutput: "true", isHidden: true },
      { id: "tc_33_5", input: "['abc', 'abcd']", expectedOutput: "false", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Numbers", "ES6 Destructuring"],
    tags: ["numbers", "swap", "destructuring"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[5, 10]", output: "[10, 5]", explanation: "5 and 10 are swapped to [10, 5]." },
      { title: "Example 2", input: "[1, 2]", output: "[2, 1]", explanation: "Swapped to [2, 1]." }
    ],
    constraints: ["-10^9 <= a, b <= 10^9"],
    starterCode: "function swapNumbers(a, b) {\n  // Write your solution here\n}",
    functionName: "swapNumbers",
    testCases: [
      { id: "tc_34_1", input: "[5, 10]", expectedOutput: "[10, 5]", isHidden: false },
      { id: "tc_34_2", input: "[1, 2]", expectedOutput: "[2, 1]", isHidden: false },
      { id: "tc_34_3", input: "[-3, 7]", expectedOutput: "[7, -3]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_34_4", input: "[0, 0]", expectedOutput: "[0, 0]", isHidden: true },
      { id: "tc_34_5", input: "[42, -42]", expectedOutput: "[-42, 42]", isHidden: true }
    ],
    solution: "function swapNumbers(a, b) {\n  return [b, a];\n}",
    explanation: "Array destructuring/literal returns [b, a] directly.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return [b, a] or use arithmetic addition/subtraction."]
  },
  {
    id: "JS-P035",
    number: 35,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Arrays", "Reduce"],
    tags: ["arrays", "sum", "reduce"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4, 5]]", output: "15", explanation: "1+2+3+4+5 = 15." },
      { title: "Example 2", input: "[[]]", output: "0", explanation: "Empty array returns 0." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function sumArray(arr) {\n  // Write your solution here\n}",
    functionName: "sumArray",
    testCases: [
      { id: "tc_35_1", input: "[[1, 2, 3, 4, 5]]", expectedOutput: "15", isHidden: false },
      { id: "tc_35_2", input: "[[]]", expectedOutput: "0", isHidden: false },
      { id: "tc_35_3", input: "[[-1, -2, 3]]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_35_4", input: "[[10, 20, 30]]", expectedOutput: "60", isHidden: true },
      { id: "tc_35_5", input: "[[100]]", expectedOutput: "100", isHidden: true }
    ],
    solution: "function sumArray(arr) {\n  return arr.reduce((acc, x) => acc + x, 0);\n}",
    explanation: "Reduce sums each element into the accumulator starting from 0.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use arr.reduce((sum, n) => sum + n, 0)."]
  },
  {
    id: "JS-P036",
    number: 36,
    ...
    examples: [
      { title: "Example 1", input: "[[2, 4, 6, 8]]", output: "5", explanation: "(2+4+6+8)/4 = 5." },
      { title: "Example 2", input: "[[10, 20]]", output: "15", explanation: "(10+20)/2 = 15." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function averageArray(arr) {\n  // Write your solution here\n}",
    functionName: "averageArray",
    testCases: [
      { id: "tc_36_1", input: "[[2, 4, 6, 8]]", expectedOutput: "5", isHidden: false },
      { id: "tc_36_2", input: "[[10, 20]]", expectedOutput: "15", isHidden: false },
      { id: "tc_36_3", input: "[[]]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_36_4", input: "[[7]]", expectedOutput: "7", isHidden: true },
      { id: "tc_36_5", input: "[[1, 2, 3, 4, 5]]", expectedOutput: "3", isHidden: true }
    ],
    solution: "function averageArray(arr) {\n  if (!arr || arr.length === 0) return 0;\n  const sum = arr.reduce((acc, x) => acc + x, 0);\n  return sum / arr.length;\n}",
    explanation: "Sum elements and divide by array length.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Sum elements with reduce, then divide by arr.length."]
  },
  {
    id: "JS-P037",
    number: 37,
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3], 2]", output: "true", explanation: "2 is present." },
      { title: "Example 2", input: "[[1, 2, 3], 5]", output: "false", explanation: "5 is not present." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function containsElement(arr, val) {\n  // Write your solution here\n}",
    functionName: "containsElement",
    testCases: [
      { id: "tc_37_1", input: "[[1, 2, 3], 2]", expectedOutput: "true", isHidden: false },
      { id: "tc_37_2", input: "[[1, 2, 3], 5]", expectedOutput: "false", isHidden: false },
      { id: "tc_37_3", input: "[['a', 'b', 'c'], 'c']", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_37_4", input: "[[], 1]", expectedOutput: "false", isHidden: true },
      { id: "tc_37_5", input: "[[null, undefined], null]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function containsElement(arr, val) {\n  return arr.includes(val);\n}",
    explanation: "Array.prototype.includes scans the array in O(n) time.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use arr.includes(val)."]
  },
  {
    id: "JS-P038",
    number: 38,
    ...
    examples: [
      { title: "Example 1", input: "[[10, 20, 30], 20]", output: "1", explanation: "20 is at index 1." },
      { title: "Example 2", input: "[[10, 20, 30], 99]", output: "-1", explanation: "Not found." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function indexOfElement(arr, val) {\n  // Write your solution here\n}",
    functionName: "indexOfElement",
    testCases: [
      { id: "tc_38_1", input: "[[10, 20, 30], 20]", expectedOutput: "1", isHidden: false },
      { id: "tc_38_2", input: "[[10, 20, 30], 99]", expectedOutput: "-1", isHidden: false },
      { id: "tc_38_3", input: "[[5, 5, 5], 5]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_38_4", input: "[[], 1]", expectedOutput: "-1", isHidden: true },
      { id: "tc_38_5", input: "[['apple', 'banana'], 'banana']", expectedOutput: "1", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Conditionals", "Logic"],
    tags: ["numbers", "sign", "conditionals"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[5]", output: "'positive'", explanation: "5 is positive." },
      { title: "Example 2", input: "[-3]", output: "'negative'", explanation: "-3 is negative." },
      { title: "Example 3", input: "[0]", output: "'zero'", explanation: "0 is zero." }
    ],
    constraints: ["-10^9 <= n <= 10^9"],
    starterCode: "function checkSign(n) {\n  // Write your solution here\n}",
    functionName: "checkSign",
    testCases: [
      { id: "tc_39_1", input: "[5]", expectedOutput: "'positive'", isHidden: false },
      { id: "tc_39_2", input: "[-3]", expectedOutput: "'negative'", isHidden: false },
      { id: "tc_39_3", input: "[0]", expectedOutput: "'zero'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_39_4", input: "[0.001]", expectedOutput: "'positive'", isHidden: true },
      { id: "tc_39_5", input: "[-0.001]", expectedOutput: "'negative'", isHidden: true }
    ],
    solution: "function checkSign(n) {\n  if (n > 0) return 'positive';\n  if (n < 0) return 'negative';\n  return 'zero';\n}",
    explanation: "Check standard if-else comparison against 0.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use if-else or Math.sign."]
  },
  {
    id: "JS-P040",
    number: 40,
    ...
    examples: [
      { title: "Example 1", input: "[-5]", output: "5", explanation: "Absolute of -5 is 5." },
      { title: "Example 2", input: "[10]", output: "10", explanation: "Absolute of 10 is 10." }
    ],
    constraints: ["-10^9 <= n <= 10^9"],
    starterCode: "function absVal(n) {\n  // Write your solution here\n}",
    functionName: "absVal",
    testCases: [
      { id: "tc_40_1", input: "[-5]", expectedOutput: "5", isHidden: false },
      { id: "tc_40_2", input: "[10]", expectedOutput: "10", isHidden: false },
      { id: "tc_40_3", input: "[0]", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_40_4", input: "[-999]", expectedOutput: "999", isHidden: true },
      { id: "tc_40_5", input: "[-0.5]", expectedOutput: "0.5", isHidden: true }
    ],
    solution: "function absVal(n) {\n  return n < 0 ? -n : n;\n}",
    explanation: "If n < 0, negate it; otherwise return n as is.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["If n < 0 return -n, else return n."]
  },
  {
    id: "JS-P041",
    number: 41,
    ...
    examples: [
      { title: "Example 1", input: "[15, 0, 10]", output: "10", explanation: "15 exceeds max 10." },
      { title: "Example 2", input: "[-5, 0, 10]", output: "0", explanation: "-5 is below min 0." },
      { title: "Example 3", input: "[5, 0, 10]", output: "5", explanation: "5 is within [0, 10]." }
    ],
    constraints: ["min <= max"],
    starterCode: "function clamp(val, min, max) {\n  // Write your solution here\n}",
    functionName: "clamp",
    testCases: [
      { id: "tc_41_1", input: "[15, 0, 10]", expectedOutput: "10", isHidden: false },
      { id: "tc_41_2", input: "[-5, 0, 10]", expectedOutput: "0", isHidden: false },
      { id: "tc_41_3", input: "[5, 0, 10]", expectedOutput: "5", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_41_4", input: "[0, 0, 0]", expectedOutput: "0", isHidden: true },
      { id: "tc_41_5", input: "[100, 50, 75]", expectedOutput: "75", isHidden: true }
    ],
    solution: "function clamp(val, min, max) {\n  return Math.min(Math.max(val, min), max);\n}",
    explanation: "Math.min(Math.max(val, min), max) clamps efficiently in O(1).",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Math.min(Math.max(val, min), max)."]
  },
  {
    id: "JS-P042",
    number: 42,
    ...
    questionType: "Coding",
    skills: ["Bitwise", "Math"],
    tags: ["bitwise", "power-of-two", "math"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[16]", output: "true", explanation: "16 = 2^4." },
      { title: "Example 2", input: "[18]", output: "false", explanation: "18 is not a power of 2." },
      { title: "Example 3", input: "[1]", output: "true", explanation: "1 = 2^0." }
    ],
    constraints: ["n is any integer"],
    starterCode: "function isPowerOfTwo(n) {\n  // Write your solution here\n}",
    functionName: "isPowerOfTwo",
    testCases: [
      { id: "tc_42_1", input: "[16]", expectedOutput: "true", isHidden: false },
      { id: "tc_42_2", input: "[18]", expectedOutput: "false", isHidden: false },
      { id: "tc_42_3", input: "[1]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_42_4", input: "[0]", expectedOutput: "false", isHidden: true },
      { id: "tc_42_5", input: "[-4]", expectedOutput: "false", isHidden: true },
      { id: "tc_42_6", input: "[1024]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isPowerOfTwo(n) {\n  if (n <= 0) return false;\n  return (n & (n - 1)) === 0;\n}",
    explanation: "A positive number is a power of 2 if and only if (n & (n - 1)) === 0.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use bitwise trick n > 0 && (n & (n - 1)) === 0."]
  },
  {
    id: "JS-P043",
    number: 43,
    ...
    difficulty: "Easy",
    questionType: "Coding",
    skills: ["Numbers", "Binary"],
    tags: ["binary", "conversion", "math"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[10]", output: "'1010'", explanation: "10 in binary is 1010." },
      { title: "Example 2", input: "[0]", output: "'0'", explanation: "0 is '0'." }
    ],
    constraints: ["0 <= n <= 10^9"],
    starterCode: "function decimalToBinary(n) {\n  // Write your solution here\n}",
    functionName: "decimalToBinary",
    testCases: [
      { id: "tc_43_1", input: "[10]", expectedOutput: "'1010'", isHidden: false },
      { id: "tc_43_2", input: "[0]", expectedOutput: "'0'", isHidden: false },
      { id: "tc_43_3", input: "[7]", expectedOutput: "'111'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_43_4", input: "[255]", expectedOutput: "'11111111'", isHidden: true },
      { id: "tc_43_5", input: "[1]", expectedOutput: "'1'", isHidden: true }
    ],
  ...
  },
  {
    ...
    examples: [
      { title: "Example 1", input: "['1010']", output: "10", explanation: "1010 base 2 is 10 base 10." },
      { title: "Example 2", input: "['111']", output: "7", explanation: "111 is 7." }
    ],
    constraints: ["bin consists only of '0' and '1'."],
    starterCode: "function binaryToDecimal(bin) {\n  // Write your solution here\n}",
    functionName: "binaryToDecimal",
    testCases: [
      { id: "tc_44_1", input: "['1010']", expectedOutput: "10", isHidden: false },
      { id: "tc_44_2", input: "['111']", expectedOutput: "7", isHidden: false },
      { id: "tc_44_3", input: "['0']", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_44_4", input: "['11111111']", expectedOutput: "255", isHidden: true },
      { id: "tc_44_5", input: "['10000000000']", expectedOutput: "1024", isHidden: true }
    ],
    solution: "function binaryToDecimal(bin) {\n  return parseInt(bin, 2);\n}",
    explanation: "parseInt(bin, 2) parses base-2 into integer.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use parseInt(bin, 2)."]
  },
  {
    id: "JS-P045",
    number: 45,
    ...
    questionType: "Coding",
    skills: ["Strings", "Trim"],
    tags: ["strings", "whitespace", "validation"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['   ']", output: "true", explanation: "Whitespace only." },
      { title: "Example 2", input: "['hello']", output: "false", explanation: "Contains non-whitespace." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function isBlank(str) {\n  // Write your solution here\n}",
    functionName: "isBlank",
    testCases: [
      { id: "tc_45_1", input: "['   ']", expectedOutput: "true", isHidden: false },
      { id: "tc_45_2", input: "['hello']", expectedOutput: "false", isHidden: false },
      { id: "tc_45_3", input: "['']", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_45_4", input: "['  a  ']", expectedOutput: "false", isHidden: true },
      { id: "tc_45_5", input: "['\\t\\n\\r']", expectedOutput: "true", isHidden: true }
    ],
    solution: "function isBlank(str) {\n  return str.trim().length === 0;\n}",
    explanation: "Trimming whitespace and checking length === 0.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Use str.trim().length === 0."]
  },
  {
    id: "JS-P046",
    number: 46,
    ...
    examples: [
      { title: "Example 1", input: "['   hello world   ']", output: "'hello world'", explanation: "Leading and trailing spaces removed." },
      { title: "Example 2", input: "['\\n\\tcode\\n']", output: "'code'", explanation: "Tabs and newlines trimmed." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function trimString(str) {\n  // Write your solution here\n}",
    functionName: "trimString",
    testCases: [
      { id: "tc_46_1", input: "['   hello world   ']", expectedOutput: "'hello world'", isHidden: false },
      { id: "tc_46_2", input: "['\\n\\tcode\\n']", expectedOutput: "'code'", isHidden: false },
      { id: "tc_46_3", input: "['already trimmed']", expectedOutput: "'already trimmed'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_46_4", input: "['   ']", expectedOutput: "''", isHidden: true },
      { id: "tc_46_5", input: "['']", expectedOutput: "''", isHidden: true }
    ],
  ...
  },
  {
    ...
    examples: [
      { title: "Example 1", input: "['the quick brown fox']", output: "'The Quick Brown Fox'", explanation: "First letter of each word capitalized." },
      { title: "Example 2", input: "['JAVASCRIPT IS FUN']", output: "'Javascript Is Fun'", explanation: "Non-initial characters lowercased." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function toTitleCase(str) {\n  // Write your solution here\n}",
    functionName: "toTitleCase",
    testCases: [
      { id: "tc_47_1", input: "['the quick brown fox']", expectedOutput: "'The Quick Brown Fox'", isHidden: false },
      { id: "tc_47_2", input: "['JAVASCRIPT IS FUN']", expectedOutput: "'Javascript Is Fun'", isHidden: false },
      { id: "tc_47_3", input: "['hello']", expectedOutput: "'Hello'", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_47_4", input: "['']", expectedOutput: "''", isHidden: true },
      { id: "tc_47_5", input: "['a b c']", expectedOutput: "'A B C'", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Split into words, capitalize charAt(0) and lowercase remainder, then join(' ')."]
  },
  {
    id: "JS-P048",
    number: 48,
    ...
    examples: [
      { title: "Example 1", input: "['hello world']", output: "2", explanation: "2 words." },
      { title: "Example 2", input: "['  one   two   three  ']", output: "3", explanation: "3 words despite multiple spaces." }
    ],
    constraints: ["0 <= str.length <= 10^5"],
    starterCode: "function countWords(str) {\n  // Write your solution here\n}",
    functionName: "countWords",
    testCases: [
      { id: "tc_48_1", input: "['hello world']", expectedOutput: "2", isHidden: false },
      { id: "tc_48_2", input: "['  one   two   three  ']", expectedOutput: "3", isHidden: false },
      { id: "tc_48_3", input: "['']", expectedOutput: "0", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_48_4", input: "['   ']", expectedOutput: "0", isHidden: true },
      { id: "tc_48_5", input: "['SingleWord']", expectedOutput: "1", isHidden: true }
    ],
    solution: "function countWords(str) {\n  const trimmed = str.trim();\n  if (!trimmed) return 0;\n  return trimmed.split(/\\s+/).length;\n}",
    explanation: "Trim string and split on /\\s+/ whitespace regex.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(n)",
    hints: ["Trim first, check if empty, then split(/\\s+/).length."]
  },
  {
    id: "JS-P049",
    number: 49,
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4]]", output: "24", explanation: "1 * 2 * 3 * 4 = 24." },
      { title: "Example 2", input: "[[5, 0, 10]]", output: "0", explanation: "Multiplying with 0 is 0." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function productArray(arr) {\n  // Write your solution here\n}",
    functionName: "productArray",
    testCases: [
      { id: "tc_49_1", input: "[[1, 2, 3, 4]]", expectedOutput: "24", isHidden: false },
      { id: "tc_49_2", input: "[[5, 0, 10]]", expectedOutput: "0", isHidden: false },
      { id: "tc_49_3", input: "[[]]", expectedOutput: "1", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_49_4", input: "[[-2, 3, -4]]", expectedOutput: "24", isHidden: true },
      { id: "tc_49_5", input: "[[7]]", expectedOutput: "7", isHidden: true }
    ],
    ...
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use arr.reduce((prod, x) => prod * x, 1)."]
  },
  {
    id: "JS-P050",
    number: 50,
    ...
    examples: [
      { title: "Example 1", input: "[[1, 2, 3, 4]]", output: "true", explanation: "All elements are > 0." },
      { title: "Example 2", input: "[[1, -2, 3]]", output: "false", explanation: "-2 is not positive." }
    ],
    constraints: ["0 <= arr.length <= 10^5"],
    starterCode: "function allPositive(arr) {\n  // Write your solution here\n}",
    functionName: "allPositive",
    testCases: [
      { id: "tc_50_1", input: "[[1, 2, 3, 4]]", expectedOutput: "true", isHidden: false },
      { id: "tc_50_2", input: "[[1, -2, 3]]", expectedOutput: "false", isHidden: false },
      { id: "tc_50_3", input: "[[]]", expectedOutput: "true", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_50_4", input: "[[0, 1, 2]]", expectedOutput: "false", isHidden: true },
      { id: "tc_50_5", input: "[[10, 20, 30]]", expectedOutput: "true", isHidden: true }
    ],
    solution: "function allPositive(arr) {\n  return arr.every(x => x > 0);\n}",
    explanation: "Array.prototype.every tests whether all elements pass x > 0.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    hints: ["Use arr.every(x => x > 0)."]
  }
];

export async function buildAndTestBatch01() {
  console.log('Testing Batch 01 (50 questions)...');
  const passed = await testBatch(b01);
  if (!passed) {
    throw new Error('Batch 01 verification failed!');
  }
  const targetFile = path.resolve('src/components/coreprogramming/data/batches/batch01.ts');
  const fileContent = `// src/components/coreprogramming/data/batches/batch01.ts\nimport type { CoreProgrammingQuestion } from '../coreProgrammingTypes';\n\nexport const coreProgrammingBatch1: CoreProgrammingQuestion[] = ${JSON.stringify(b01, null, 2)};\n`;
  fs.writeFileSync(targetFile, fileContent, 'utf-8');
  console.log(`Successfully wrote ${b01.length} verified questions to batch01.ts!`);
}

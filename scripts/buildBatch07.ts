...
const b07: CoreProgrammingQuestion[] = [
  {
    id: "JS-P301",
    number: 301,
    ...
    skills: ["Closures", "State"],
    tags: ["counter", "closures", "state"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[0, 2, [[], [], []]]", output: "[0, 2, 4]", explanation: "Increments by 2 each call." }
    ],
    constraints: ["step defaults to 1."],
    starterCode: "function createCounter(initial = 0, step = 1) {\n  // Write your solution here\n}",
    functionName: "createCounter",
    testCases: [
      { id: "tc_301_1", input: "[0, 2, [[], [], []]]", expectedOutput: "[0, 2, 4]", isHidden: false },
      { id: "tc_301_2", input: "[10, 5, [[], []]]", expectedOutput: "[10, 15]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_301_3", input: "[-5, 1, [[], []]]", expectedOutput: "[-5, -4]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Store count in closure variable and increment by step."]
  },
  {
    id: "JS-P302",
    number: 302,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Encapsulation", "Object Methods"],
    tags: ["counter", "encapsulation", "methods"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[5], [['increment'], ['increment'], ['decrement'], ['reset']]]", output: "[6, 7, 6, 5]", explanation: "Methods manipulate private count." }
    ],
    constraints: ["Count variable must be private."],
    starterCode: "function createCounterObject(init = 0) {\n  // Write your solution here\n}",
    functionName: "createCounterObject",
    testCases: [
      { id: "tc_302_1", input: "[[5], [['increment'], ['increment'], ['decrement'], ['reset']]]", expectedOutput: "[6, 7, 6, 5]", isHidden: false },
      { id: "tc_302_2", input: "[[0], [['getValue'], ['increment'], ['getValue']]]", expectedOutput: "[0, 1, 1]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_302_3", input: "[[-10], [['decrement'], ['getValue']]]", expectedOutput: "[-11, -11]", isHidden: true }
    ],
    solution: "function createCounterObject(init = 0) {\n  let count = init;\n  return {\n    increment: () => ++count,\n    decrement: () => --count,\n    reset: () => (count = init),\n    getValue: () => count\n  };\n}",
    explanation: "Keep count inside closure, expose manipulation methods.",
    timeComplexity: "O(1) per operation",
    spaceComplexity: "O(1)",
    hints: ["Return an object containing increment, decrement, reset, getValue."]
  },
  {
    id: "JS-P303",
    number: 303,
    ...
    examples: [
      { title: "Example 1", input: "[false, [[], [], []]]", output: "[true, false, true]", explanation: "Flips on each call." }
    ],
    constraints: ["Initial state defaults to false."],
    starterCode: "function createToggle(initialState = false) {\n  // Write your solution here\n}",
    functionName: "createToggle",
    testCases: [
      { id: "tc_303_1", input: "[false, [[], [], []]]", expectedOutput: "[true, false, true]", isHidden: false },
      { id: "tc_303_2", input: "[true, [[], []]]", expectedOutput: "[false, true]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_303_3", input: "[false, [[]]]", expectedOutput: "[true]", isHidden: true }
    ],
    solution: "function createToggle(initialState = false) {\n  let state = initialState;\n  return function() {\n    state = !state;\n    return state;\n  };\n}",
    explanation: "Invert boolean state and return it.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["state = !state; return state;"]
  },
  {
    id: "JS-P304",
    number: 304,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Generators"],
    tags: ["sequence", "generator", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[10, 3, [[], [], []]]", output: "[10, 13, 16]", explanation: "10, 13, 16..." }
    ],
    constraints: ["start and step can be negative or float."],
    starterCode: "function createSequence(start = 0, step = 1) {\n  // Write your solution here\n}",
    functionName: "createSequence",
    testCases: [
      { id: "tc_304_1", input: "[10, 3, [[], [], []]]", expectedOutput: "[10, 13, 16]", isHidden: false },
      { id: "tc_304_2", input: "[0, -2, [[], [], []]]", expectedOutput: "[0, -2, -4]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_304_3", input: "[100, 0, [[], []]]", expectedOutput: "[100, 100]", isHidden: true }
    ],
    solution: "function createSequence(start = 0, step = 1) {\n  let cur = start;\n  return function() {\n    const val = cur;\n    cur += step;\n    return val;\n  };\n}",
    explanation: "Store cur in closure, advance by step after reading.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return current value then add step."]
  },
  {
    id: "JS-P305",
    number: 305,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "String Formatting"],
    tags: ["id", "generator", "unique"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "['user_', 1, [[], [], []]]", output: "['user_1', 'user_2', 'user_3']", explanation: "Generates user_1, user_2, user_3." }
    ],
    constraints: ["start defaults to 1."],
    starterCode: "function createIdGenerator(prefix = 'id_', start = 1) {\n  // Write your solution here\n}",
    functionName: "createIdGenerator",
    testCases: [
      { id: "tc_305_1", input: "['user_', 1, [[], [], []]]", expectedOutput: "['user_1', 'user_2', 'user_3']", isHidden: false },
      { id: "tc_305_2", input: "['task-', 10, [[], []]]", expectedOutput: "['task-10', 'task-11']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_305_3", input: "['', 0, [[], []]]", expectedOutput: "['0', '1']", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Recursion", "Accumulator"],
    tags: ["currying", "infinite", "sum"],
    ...
    examples: [
      { title: "Example 1", input: "[1, [[2], [3], []]]", output: "6", explanation: "curriedSum(1)(2)(3)() = 6" }
    ],
    constraints: ["Terminates when invoked with zero arguments."],
    starterCode: "function curriedSum(a) {\n  // Write your solution here\n}",
    functionName: "curriedSum",
    testCases: [
      { id: "tc_306_1", input: "[1, [[2], [3], []]]", expectedOutput: "6", isHidden: false },
      { id: "tc_306_2", input: "[10, [[20], []]]", expectedOutput: "30", isHidden: false },
      { id: "tc_306_3", input: "[5, [[]]]", expectedOutput: "5", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_306_4", input: "[0, [[-5], [5], []]]", expectedOutput: "0", isHidden: true }
    ],
    ...
    hints: ["Check if argument is undefined. If so, return sum; otherwise recurse."]
  },
  {
    id: "JS-P307",
    number: 307,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Data Privacy"],
    tags: ["vault", "security", "privacy"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[['pass123', 'treasure'], [['unlock', 'wrong'], ['unlock', 'pass123']]]", output: "[null, 'treasure']", explanation: "Only unlocks with correct key." }
    ],
    constraints: ["Secret cannot be accessed directly without unlock."],
    starterCode: "function createVault(key, secret) {\n  // Write your solution here\n}",
    functionName: "createVault",
    testCases: [
      { id: "tc_307_1", input: "[['pass123', 'treasure'], [['unlock', 'wrong'], ['unlock', 'pass123']]]", expectedOutput: "[null, 'treasure']", isHidden: false },
      { id: "tc_307_2", input: "[['k', 'data'], [['changeKey', 'wrong', 'k2'], ['changeKey', 'k', 'k2'], ['unlock', 'k2']]]", expectedOutput: "[false, true, 'data']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_307_3", input: "[['abc', 42], [['unlock', 'abc']]]", expectedOutput: "[42]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Check enteredKey === currentKey."]
  },
  {
    id: "JS-P308",
    number: 308,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Encapsulation", "Finance"],
    tags: ["bank", "account", "encapsulation"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[100], [['deposit', 50], ['withdraw', 30], ['getBalance']]]", output: "[150, 120, 120]", explanation: "Maintains private balance." }
    ],
    constraints: ["amt must be > 0."],
    starterCode: "function createBankAccount(initialBalance = 0) {\n  // Write your solution here\n}",
    functionName: "createBankAccount",
    testCases: [
      { id: "tc_308_1", input: "[[100], [['deposit', 50], ['withdraw', 30], ['getBalance']]]", expectedOutput: "[150, 120, 120]", isHidden: false },
      { id: "tc_308_2", input: "[[50], [['withdraw', 100], ['getBalance']]]", expectedOutput: "['Insufficient funds', 50]", isHidden: false },
      { id: "tc_308_3", input: "[[0], [['deposit', 20], ['getTransactions']]]", expectedOutput: "[20, [{\"type\":\"deposit\",\"amount\":20}]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_308_4", input: "[[200], [['withdraw', 200], ['getBalance']]]", expectedOutput: "[0, 0]", isHidden: true }
    ],
    ...
    hints: ["Store transactions in an array in closure."]
  },
  {
    id: "JS-P309",
    number: 309,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Rate Limiting"],
    tags: ["rateLimit", "closures", "flow"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[2, [[], [], []]]", output: "[true, true, false]", explanation: "Limit 2 allows first two calls." }
    ],
    constraints: ["limit >= 0."],
    starterCode: "function createRateLimiter(limit) {\n  // Write your solution here\n}",
    functionName: "createRateLimiter",
    testCases: [
      { id: "tc_309_1", input: "[2, [[], [], []]]", expectedOutput: "[true, true, false]", isHidden: false },
      { id: "tc_309_2", input: "[0, [[]]]", expectedOutput: "[false]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_309_3", input: "[1, [[], []]]", expectedOutput: "[true, false]", isHidden: true }
    ],
    solution: "function createRateLimiter(limit) {\n  let calls = 0;\n  return function() {\n    if (calls < limit) {\n      calls++;\n      return true;\n    }\n    return false;\n  };\n}",
    explanation: "Increment calls while calls < limit.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Maintain calls counter in closure."]
  },
  {
    id: "JS-P310",
    number: 310,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Undo/Redo", "Data Structures"],
    tags: ["undo", "redo", "state"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "['A', [['set', 'B'], ['set', 'C'], ['undo'], ['get']]]", output: "[undefined, undefined, 'B', 'B']", explanation: "Undoes C back to B." }
    ],
    constraints: ["If cannot undo/redo, keep current value unchanged."],
    starterCode: "function createUndoRedo(initial) {\n  // Write your solution here\n}",
    functionName: "createUndoRedo",
    testCases: [
      { id: "tc_310_1", input: "['A', [['set', 'B'], ['set', 'C'], ['undo'], ['get']]]", expectedOutput: "[null, null, 'B', 'B']", isHidden: false },
      { id: "tc_310_2", input: "[1, [['undo'], ['get'], ['set', 2], ['undo'], ['redo'], ['get']]]", expectedOutput: "[1, 1, null, 1, 2, 2]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_310_3", input: "['x', [['set', 'y'], ['set', 'z'], ['undo'], ['undo'], ['get']]]", expectedOutput: "[null, null, 'y', 'x', 'x']", isHidden: true }
    ],
    ...
    hints: ["Maintain undoStack and redoStack in closure."]
  },
  {
    id: "JS-P311",
    number: 311,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "History"],
    tags: ["history", "state", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[1, [['push', 2], ['push', 3], ['getHistory'], ['current']]]", output: "[null, null, [1, 2, 3], 3]", explanation: "Tracks [1, 2, 3]." }
    ],
    constraints: ["Never mutate external history."],
    starterCode: "function createStateHistory(initial) {\n  // Write your solution here\n}",
    functionName: "createStateHistory",
    testCases: [
      { id: "tc_311_1", input: "[1, [['push', 2], ['push', 3], ['getHistory'], ['current']]]", expectedOutput: "[null, null, [1, 2, 3], 3]", isHidden: false },
      { id: "tc_311_2", input: "['start', [['current'], ['getHistory']]]", expectedOutput: "['start', ['start']]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_311_3", input: "[0, [['push', 10], ['current']]]", expectedOutput: "[null, 10]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Store values in an array initialized with [initial]."]
  },
  {
    id: "JS-P312",
    number: 312,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Map/Object"],
    tags: ["multiCounter", "counters", "state"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['increment', 'a'], ['increment', 'a'], ['increment', 'b'], ['get', 'a'], ['get', 'b']]]", output: "[1, 2, 1, 2, 1]", explanation: "Manages 'a' and 'b' separately." }
    ],
    constraints: ["Keys can be any string."],
    starterCode: "function createMultiCounter() {\n  // Write your solution here\n}",
    functionName: "createMultiCounter",
    testCases: [
      { id: "tc_312_1", input: "[[], [['increment', 'a'], ['increment', 'a'], ['increment', 'b'], ['get', 'a'], ['get', 'b']]]", expectedOutput: "[1, 2, 1, 2, 1]", isHidden: false },
      { id: "tc_312_2", input: "[[], [['get', 'unknown'], ['decrement', 'c'], ['reset', 'c'], ['get', 'c']]]", expectedOutput: "[0, -1, 0, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_312_3", input: "[[], [['increment', 'x'], ['reset', 'x']]]", expectedOutput: "[1, 0]", isHidden: true }
    ],
    ...
    hints: ["Use Map or plain object in closure."]
  },
  {
    id: "JS-P313",
    number: 313,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Iterators"],
    tags: ["cycle", "iterator", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[['red', 'green', 'blue'], [[], [], [], []]]", output: "['red', 'green', 'blue', 'red']", explanation: "Wraps back to 'red'." }
    ],
    constraints: ["items is non-empty array."],
    starterCode: "function createCycleIterator(items) {\n  // Write your solution here\n}",
    functionName: "createCycleIterator",
    testCases: [
      { id: "tc_313_1", input: "[['red', 'green', 'blue'], [[], [], [], []]]", expectedOutput: "['red', 'green', 'blue', 'red']", isHidden: false },
      { id: "tc_313_2", input: "[[1, 2], [[], [], []]]", expectedOutput: "[1, 2, 1]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_313_3", input: "[['only'], [[], []]]", expectedOutput: "['only', 'only']", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Use index = (index + 1) % items.length."]
  },
  {
    id: "JS-P314",
    number: 314,
    ...
    examples: [
      { title: "Example 1", input: "[0, [[5], [10], [-3]]]", output: "[5, 15, 12]", explanation: "Accumulates 0 + 5 + 10 - 3." }
    ],
    constraints: ["val is numeric."],
    starterCode: "function createAccumulator(init = 0) {\n  // Write your solution here\n}",
    functionName: "createAccumulator",
    testCases: [
      { id: "tc_314_1", input: "[0, [[5], [10], [-3]]]", expectedOutput: "[5, 15, 12]", isHidden: false },
      { id: "tc_314_2", input: "[100, [[50], [25]]]", expectedOutput: "[150, 175]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_314_3", input: "[-10, [[10]]]", expectedOutput: "[0]", isHidden: true }
    ],
    solution: "function createAccumulator(init = 0) {\n  let total = init;\n  return function(val = 0) {\n    total += val;\n    return total;\n  };\n}",
    explanation: "Add val to total stored in closure.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["total += val; return total;"]
  },
  {
    id: "JS-P315",
    number: 315,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Counters"],
    tags: ["countdown", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[2, [[], [], [], []]]", output: "[2, 1, 0, 0]", explanation: "Counts down 2, 1, 0, 0." }
    ],
    constraints: ["n >= 0."],
    starterCode: "function createCountdown(n) {\n  // Write your solution here\n}",
    functionName: "createCountdown",
    testCases: [
      { id: "tc_315_1", input: "[2, [[], [], [], []]]", expectedOutput: "[2, 1, 0, 0]", isHidden: false },
      { id: "tc_315_2", input: "[0, [[], []]]", expectedOutput: "[0, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_315_3", input: "[1, [[], [], []]]", expectedOutput: "[1, 0, 0]", isHidden: true }
    ],
    solution: "function createCountdown(n) {\n  let current = n;\n  return function() {\n    const val = current;\n    if (current > 0) current--;\n    return val;\n  };\n}",
    explanation: "Decrement while current > 0.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return current, decrement if > 0."]
  },
  {
    id: "JS-P316",
    number: 316,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Spies", "Testing"],
    tags: ["spy", "testing", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[x => x * 2], [['spy', 5], ['spy', 10], ['callCount'], ['lastArgs']]]", output: "[10, 20, 2, [10]]", explanation: "Tracks calls and last arguments." }
    ],
    constraints: ["Preserve fn this context."],
    starterCode: "function createSpy(fn) {\n  // Write your solution here\n}",
    functionName: "createSpy",
    testCases: [
      { id: "tc_316_1", input: "[[x => x * 2], [['spy', 5], ['spy', 10], ['callCount'], ['lastArgs']]]", expectedOutput: "[10, 20, 2, [10]]", isHidden: false },
      { id: "tc_316_2", input: "[[() => 'ok'], [['callCount'], ['lastArgs']]]", expectedOutput: "[0, null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_316_3", input: "[[(a, b) => a + b], [['spy', 1, 2], ['calls']]]", expectedOutput: "[3, [[1, 2]]]", isHidden: true }
    ],
    ...
    hints: ["Attach methods directly to the wrapper function."]
  },
  {
    id: "JS-P317",
    number: 317,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "State Machines"],
    tags: ["stateMachine", "fsm", "state"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "['idle', { idle: { start: 'running' }, running: { stop: 'idle' } }, [['transition', 'start'], ['getState'], ['transition', 'invalid']]]", output: "['running', 'running', null]", explanation: "Transitions idle -> running on 'start'." }
    ],
    constraints: ["transitions is an object mapping state -> { action: nextState }."],
    starterCode: "function createStateMachine(initial, transitions) {\n  // Write your solution here\n}",
    functionName: "createStateMachine",
    testCases: [
      { id: "tc_317_1", input: "['idle', { idle: { start: 'running' }, running: { stop: 'idle' } }, [['transition', 'start'], ['getState'], ['transition', 'invalid']]]", expectedOutput: "['running', 'running', null]", isHidden: false },
      { id: "tc_317_2", input: "['locked', { locked: { coin: 'unlocked' }, unlocked: { push: 'locked' } }, [['getState'], ['transition', 'coin'], ['transition', 'push']]]", expectedOutput: "['locked', 'unlocked', 'locked']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_317_3", input: "['a', {}, [['transition', 'x']]]", expectedOutput: "[null]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Stack"],
    tags: ["stack", "dataStructures", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['push', 1], ['push', 2], ['peek'], ['pop'], ['size']]]", output: "[null, null, 2, 2, 1]", explanation: "LIFO: 2 popped first." }
    ],
    constraints: ["pop() and peek() on empty stack return undefined."],
    starterCode: "function createStackStore() {\n  // Write your solution here\n}",
    functionName: "createStackStore",
    testCases: [
      { id: "tc_318_1", input: "[[], [['push', 1], ['push', 2], ['peek'], ['pop'], ['size']]]", expectedOutput: "[null, null, 2, 2, 1]", isHidden: false },
      { id: "tc_318_2", input: "[[], [['isEmpty'], ['pop'], ['peek']]]", expectedOutput: "[true, null, null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_318_3", input: "[[], [['push', 'a'], ['isEmpty']]]", expectedOutput: "[null, false]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Use items.pop() and items[items.length - 1]."]
  },
  {
    id: "JS-P319",
    number: 319,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Queue"],
    tags: ["queue", "dataStructures", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['enqueue', 'a'], ['enqueue', 'b'], ['dequeue'], ['peek']]]", output: "[null, null, 'a', 'b']", explanation: "FIFO: 'a' dequeued first." }
    ],
    constraints: ["dequeue() and peek() on empty queue return undefined."],
    starterCode: "function createQueueStore() {\n  // Write your solution here\n}",
    functionName: "createQueueStore",
    testCases: [
      { id: "tc_319_1", input: "[[], [['enqueue', 'a'], ['enqueue', 'b'], ['dequeue'], ['peek']]]", expectedOutput: "[null, null, 'a', 'b']", isHidden: false },
      { id: "tc_319_2", input: "[[], [['isEmpty'], ['size']]]", expectedOutput: "[true, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_319_3", input: "[[], [['enqueue', 42], ['isEmpty']]]", expectedOutput: "[null, false]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Circular Buffer", "Pointers"],
    tags: ["circularBuffer", "buffer", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['write', 1], ['write', 2], ['write', 3], ['read'], ['read']]]", output: "[null, null, null, 2, 3]", explanation: "1 was overwritten by 3." }
    ],
    constraints: ["capacity > 0."],
    starterCode: "function createCircularBuffer(capacity) {\n  // Write your solution here\n}",
    functionName: "createCircularBuffer",
    testCases: [
      { id: "tc_320_1", input: "[[2], [['write', 1], ['write', 2], ['write', 3], ['read'], ['read']]]", expectedOutput: "[null, null, null, 2, 3]", isHidden: false },
      { id: "tc_320_2", input: "[[3], [['isEmpty'], ['isFull']]]", expectedOutput: "[true, false]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_320_3", input: "[[1], [['write', 'a'], ['isFull'], ['read'], ['isEmpty']]]", expectedOutput: "[null, true, 'a', true]", isHidden: true }
    ],
    ...
    hints: ["When buf.length >= capacity, call buf.shift()."]
  },
  {
    id: "JS-P321",
    number: 321,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "LRU Cache", "Map"],
    tags: ["lru", "cache", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['put', 1, 1], ['put', 2, 2], ['get', 1], ['put', 3, 3], ['get', 2]]]", output: "[null, null, 1, null, -1]", explanation: "Key 2 was evicted because key 1 was accessed." }
    ],
    constraints: ["capacity >= 1."],
    starterCode: "function createLRUCache(capacity) {\n  // Write your solution here\n}",
    functionName: "createLRUCache",
    testCases: [
      { id: "tc_321_1", input: "[[2], [['put', 1, 1], ['put', 2, 2], ['get', 1], ['put', 3, 3], ['get', 2]]]", expectedOutput: "[null, null, 1, null, -1]", isHidden: false },
      { id: "tc_321_2", input: "[[1], [['put', 'k', 'v'], ['size'], ['get', 'k']]]", expectedOutput: "[null, 1, 'v']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_321_3", input: "[[2], [['get', 99]]]", expectedOutput: "[-1]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1) all operations",
    spaceComplexity: "O(capacity)",
    hints: ["Use JavaScript Map's key insertion ordering."]
  },
  {
    id: "JS-P322",
    number: 322,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Observer", "PubSub"],
    tags: ["store", "subscribable", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[{ count: 0 }, [['getState'], ['setState', { count: 1 }], ['getState']]]", output: "[{\"count\":0}, null, {\"count\":1}]", explanation: "Updates state." }
    ],
    constraints: ["Listener is invoked on every setState."],
    starterCode: "function createStore(initialState) {\n  // Write your solution here\n}",
    functionName: "createStore",
    testCases: [
      { id: "tc_322_1", input: "[{ count: 0 }, [['getState'], ['setState', { count: 1 }], ['getState']]]", expectedOutput: "[{\"count\":0}, null, {\"count\":1}]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_322_2", input: "[42, [['getState']]]", expectedOutput: "[42]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "EventEmitter", "Events"],
    tags: ["events", "emitter", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['on', 'click', () => 1], ['emit', 'click']]]", output: "[null, [1]]", explanation: "Emits to registered listener." }
    ],
    constraints: ["Emit returns empty array if no listeners."],
    starterCode: "function createEventEmitter() {\n  // Write your solution here\n}",
    functionName: "createEventEmitter",
    testCases: [
      { id: "tc_323_1", input: "[[], [['on', 'click', () => 1], ['emit', 'click']]]", expectedOutput: "[null, [1]]", isHidden: false },
      { id: "tc_323_2", input: "[[], [['emit', 'missing']]]", expectedOutput: "[[]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_323_3", input: "[[], [['on', 'msg', s => `Hello ${s}`], ['emit', 'msg', 'World']]]", expectedOutput: "[null, ['Hello World']]", isHidden: true }
    ],
    ...
    hints: ["Store callbacks in Map keyed by event name."]
  },
  {
    id: "JS-P324",
    number: 324,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Events"],
    tags: ["once", "emitter", "events"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['once', 'greet', () => 'hi'], ['emit', 'greet'], ['emit', 'greet']]]", output: "[null, ['hi'], []]", explanation: "Second emit has no active listeners." }
    ],
    constraints: ["Listener is removed immediately after first emit."],
    starterCode: "function createOnceEmitter() {\n  // Write your solution here\n}",
    functionName: "createOnceEmitter",
    testCases: [
      { id: "tc_324_1", input: "[[], [['once', 'greet', () => 'hi'], ['emit', 'greet'], ['emit', 'greet']]]", expectedOutput: "[null, ['hi'], []]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_324_2", input: "[[], [['emit', 'empty']]]", expectedOutput: "[[]]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(k)",
    hints: ["Delete callbacks upon emitting."]
  },
  {
    id: "JS-P325",
    number: 325,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Error Handling"],
    tags: ["safeInvoker", "resilience", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[() => { throw new Error('fail'); }, 2, 'safe', [[], [], []]]", output: "['safe', 'safe', 'fail']", explanation: "Throws on 3rd error." }
    ],
    constraints: ["Throw original error once limit is exceeded."],
    starterCode: "function createSafeInvoker(fn, maxErrors, fallback) {\n  // Write your solution here\n}",
    functionName: "createSafeInvoker",
    testCases: [
      { id: "tc_325_1", input: "[x => { if (x < 0) throw new Error('neg'); return x; }, 1, 'fallback', [[5], [-1], [10]]]", expectedOutput: "[5, 'fallback', 10]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_325_2", input: "[x => x * 2, 0, 'bad', [[3]]]", expectedOutput: "[6]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Catch error, if errors <= maxErrors return fallback else throw err."]
  },
  {
    id: "JS-P326",
    number: 326,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Lazy Evaluation"],
    tags: ["lazy", "closures", "optimization"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[() => ({ id: Math.random() }), [[], []]]", output: "same cached object", explanation: "Returns identical cached object on second call." }
    ],
    constraints: ["factory takes zero arguments."],
    starterCode: "function createLazyValue(factory) {\n  // Write your solution here\n}",
    functionName: "createLazyValue",
    testCases: [
      { id: "tc_326_1", input: "[(() => { let c = 0; return () => ++c; })(), [[], [], []]]", expectedOutput: "[1, 1, 1]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_326_2", input: "[() => 'static', [[]]]", expectedOutput: "['static']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(1)",
    hints: ["If !evaluated, compute value = factory() and set evaluated = true."]
  },
  {
    id: "JS-P327",
    number: 327,
    ...
    questionType: "Implementation",
    skills: ["Closures", "Map"],
    tags: ["autoIncrement", "map", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[1, [['getId', 'apple'], ['getId', 'banana'], ['getId', 'apple'], ['size']]]", output: "[1, 2, 1, 2]", explanation: "Apple gets 1, banana gets 2, apple returns 1." }
    ],
    constraints: ["startId is positive integer."],
    starterCode: "function createAutoIncrementMap(startId = 1) {\n  // Write your solution here\n}",
    functionName: "createAutoIncrementMap",
    testCases: [
      { id: "tc_327_1", input: "[1, [['getId', 'apple'], ['getId', 'banana'], ['getId', 'apple'], ['size']]]", expectedOutput: "[1, 2, 1, 2]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_327_2", input: "[100, [['getId', 'x'], ['getId', 'y']]]", expectedOutput: "[100, 101]", isHidden: true }
    ],
    solution: "function createAutoIncrementMap(startId = 1) {\n  const map = new Map();\n  let nextId = startId;\n  return {\n    getId: (key) => {\n      if (!map.has(key)) {\n        map.set(key, nextId++);\n      }\n      return map.get(key);\n    },\n    size: () => map.size\n  };\n}",
    explanation: "Check Map.has(key); if not present, map.set(key, nextId++).",
    timeComplexity: "O(1) amortized",
    spaceComplexity: "O(k)",
    hints: ["Use Map in closure with nextId counter."]
  },
  {
    id: "JS-P328",
    number: 328,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Priority Queue", "Data Structures"],
    tags: ["priorityQueue", "dataStructures", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['enqueue', 'low', 10], ['enqueue', 'high', 1], ['dequeue']]]", output: "[null, null, 'high']", explanation: "Priority 1 dequeued before 10." }
    ],
    constraints: ["Smallest priority number = highest priority."],
    starterCode: "function createPriorityQueue() {\n  // Write your solution here\n}",
    functionName: "createPriorityQueue",
    testCases: [
      { id: "tc_328_1", input: "[[], [['enqueue', 'low', 10], ['enqueue', 'high', 1], ['dequeue']]]", expectedOutput: "[null, null, 'high']", isHidden: false },
      { id: "tc_328_2", input: "[[], [['enqueue', 'a', 1], ['enqueue', 'b', 1], ['dequeue'], ['dequeue']]]", expectedOutput: "[null, null, 'a', 'b']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_328_3", input: "[[], [['dequeue']]]", expectedOutput: "[null]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Sort queue by priority on insertion."]
  },
  {
    id: "JS-P329",
    number: 329,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Middleware", "Pipeline"],
    tags: ["middleware", "pipeline", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['use', x => x + 1], ['use', x => x * 2], ['execute', 5]]]", output: "[null, null, 12]", explanation: "(5 + 1) * 2 = 12." }
    ],
    constraints: ["Returns input unchanged if no middlewares."],
    starterCode: "function createPipeline() {\n  // Write your solution here\n}",
    functionName: "createPipeline",
    testCases: [
      { id: "tc_329_1", input: "[[], [['use', x => x + 1], ['use', x => x * 2], ['execute', 5]]]", expectedOutput: "[null, null, 12]", isHidden: false },
      { id: "tc_329_2", input: "[[], [['execute', 42]]]", expectedOutput: "[42]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_329_3", input: "[[], [['use', s => s.toUpperCase()], ['execute', 'hi']]]", expectedOutput: "[null, 'HI']", isHidden: true }
    ],
    ...
    spaceComplexity: "O(m)",
    hints: ["Use middlewares.reduce((acc, fn) => fn(acc), input)."]
  },
  {
    id: "JS-P330",
    number: 330,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Scope Hierarchy"],
    tags: ["scope", "context", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['set', 'a', 1], ['enterScope'], ['set', 'a', 2], ['get', 'a'], ['exitScope'], ['get', 'a']]]", output: "[null, null, null, 2, null, 1]", explanation: "Inner scope shadows outer scope." }
    ],
    constraints: ["Root scope is never popped."],
    starterCode: "function createScopedContext() {\n  // Write your solution here\n}",
    functionName: "createScopedContext",
    testCases: [
      { id: "tc_330_1", input: "[[], [['set', 'a', 1], ['enterScope'], ['set', 'a', 2], ['get', 'a'], ['exitScope'], ['get', 'a']]]", expectedOutput: "[null, null, null, 2, null, 1]", isHidden: false },
      { id: "tc_330_2", input: "[[], [['get', 'unset']]]", expectedOutput: "[null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_330_3", input: "[[], [['set', 'x', 10], ['enterScope'], ['get', 'x']]]", expectedOutput: "[null, null, 10]", isHidden: true }
    ],
    ...
    hints: ["Iterate backwards through scopes array for get(k)."]
  },
  {
    id: "JS-P331",
    number: 331,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Objects", "Diff"],
    tags: ["diff", "tracker", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[{ a: 1, b: 2 }], [['update', { a: 99 }], ['getChanges'], ['reset'], ['getChanges']]]", output: "[null, {\"a\":99}, null, {}]", explanation: "Detects changed key 'a'." }
    ],
    constraints: ["Shallow comparison for property values."],
    starterCode: "function createDiffTracker(initialObj) {\n  // Write your solution here\n}",
    functionName: "createDiffTracker",
    testCases: [
      { id: "tc_331_1", input: "[[{ a: 1, b: 2 }], [['update', { a: 99 }], ['getChanges'], ['reset'], ['getChanges']]]", expectedOutput: "[null, {\"a\":99}, null, {}]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_331_2", input: "[[{ x: 10 }], [['getChanges']]]", expectedOutput: "[{}]", isHidden: true }
    ],
    ...
    timeComplexity: "O(k)",
    spaceComplexity: "O(k)",
    hints: ["Compare current[k] !== base[k]."]
  },
  {
    id: "JS-P332",
    number: 332,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Token Bucket", "Rate Limiting"],
    tags: ["tokenBucket", "rateLimiter", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[10], [['consume', 4], ['consume', 7], ['refill', 5], ['consume', 7]]]", output: "[true, false, 10, true]", explanation: "10 - 4 = 6; 7 > 6 fails; refill to 10; 10 - 7 = 3 succeeds." }
    ],
    constraints: ["Starts full with tokens === capacity."],
    starterCode: "function createTokenBucket(capacity) {\n  // Write your solution here\n}",
    functionName: "createTokenBucket",
    testCases: [
      { id: "tc_332_1", input: "[[10], [['consume', 4], ['consume', 7], ['refill', 5], ['consume', 7]]]", expectedOutput: "[true, false, 10, true]", isHidden: false },
      { id: "tc_332_2", input: "[[5], [['getTokens'], ['consume', 5], ['getTokens']]]", expectedOutput: "[5, true, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_332_3", input: "[[5], [['consume', 6]]]", expectedOutput: "[false]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["tokens = Math.min(capacity, tokens + count)."]
  },
  {
    id: "JS-P333",
    number: 333,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Step Runner"],
    tags: ["stepRunner", "workflow", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[[x => x + 1, x => x * 2]], [['next', 5], ['next', 10], ['hasMore']]]", output: "[6, 20, false]", explanation: "Runs step 1 (5+1), then step 2 (10*2)." }
    ],
    constraints: ["steps is array of functions."],
    starterCode: "function createStepRunner(steps) {\n  // Write your solution here\n}",
    functionName: "createStepRunner",
    testCases: [
      { id: "tc_333_1", input: "[[[x => x + 1, x => x * 2]], [['next', 5], ['next', 10], ['hasMore']]]", expectedOutput: "[6, 20, false]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_333_2", input: "[[[]], [['hasMore'], ['next', 1]]]", expectedOutput: "[false, null]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Execute steps[idx++] and check idx < steps.length."]
  },
  {
    id: "JS-P334",
    number: 334,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "ReplaySubject", "RxJS Pattern"],
    tags: ["replaySubject", "observer", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['next', 'a'], ['next', 'b'], ['next', 'c'], ['getBuffer']]]", output: "[null, null, null, ['b', 'c']]", explanation: "Buffers 2 most recent values." }
    ],
    constraints: ["Buffer size >= 1."],
    starterCode: "function createReplaySubject(bufferSize = 2) {\n  // Write your solution here\n}",
    functionName: "createReplaySubject",
    testCases: [
      { id: "tc_334_1", input: "[[2], [['next', 'a'], ['next', 'b'], ['next', 'c'], ['getBuffer']]]", expectedOutput: "[null, null, null, ['b', 'c']]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_334_2", input: "[[1], [['next', 10], ['getBuffer']]]", expectedOutput: "[null, [10]]", isHidden: true }
    ],
    ...
    hints: ["Replay buffered items when subscribe is called."]
  },
  {
    id: "JS-P335",
    number: 335,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "TTL", "Caching"],
    tags: ["ttl", "cache", "store"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['set', 'token', 'abc', 100, 0], ['get', 'token', 50], ['get', 'token', 150]]]", output: "[null, 'abc', null]", explanation: "Expires after 100ms." }
    ],
    constraints: ["now is an integer timestamp."],
    starterCode: "function createTTLStore() {\n  // Write your solution here\n}",
    functionName: "createTTLStore",
    testCases: [
      { id: "tc_335_1", input: "[[], [['set', 'token', 'abc', 100, 0], ['get', 'token', 50], ['get', 'token', 150]]]", expectedOutput: "[null, 'abc', null]", isHidden: false },
      { id: "tc_335_2", input: "[[], [['set', 'a', 1, 50, 0], ['size', 20], ['size', 60]]]", expectedOutput: "[null, 1, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_335_3", input: "[[], [['get', 'none', 0]]]", expectedOutput: "[null]", isHidden: true }
    ],
  ...
  },
  {
    ...
    examples: [
      { title: "Example 1", input: "[[], [['set', 'a', 1], ['begin'], ['set', 'a', 2], ['get', 'a'], ['rollback'], ['get', 'a']]]", output: "[null, null, null, 2, null, 1]", explanation: "Rollback restores 'a' to 1." }
    ],
    constraints: ["Support nested transactions."],
    starterCode: "function createTransactionManager() {\n  // Write your solution here\n}",
    functionName: "createTransactionManager",
    testCases: [
      { id: "tc_336_1", input: "[[], [['set', 'a', 1], ['begin'], ['set', 'a', 2], ['get', 'a'], ['rollback'], ['get', 'a']]]", expectedOutput: "[null, null, null, 2, null, 1]", isHidden: false },
      { id: "tc_336_2", input: "[[], [['begin'], ['set', 'x', 10], ['commit'], ['get', 'x']]]", expectedOutput: "[null, null, null, 10]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_336_3", input: "[[], [['rollback'], ['get', 'a']]]", expectedOutput: "[null, null]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(v)",
    hints: ["Use stack of Maps, commit merges into parent Map."]
  },
  {
    id: "JS-P337",
    number: 337,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Dispatch"],
    tags: ["dispatcher", "action", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['register', 'ADD', p => p + 1], ['dispatch', { type: 'ADD', payload: 10 }]]]", output: "[null, 11]", explanation: "Calls ADD handler." }
    ],
    constraints: ["Actions have format { type, payload }."],
    starterCode: "function createActionDispatcher() {\n  // Write your solution here\n}",
    functionName: "createActionDispatcher",
    testCases: [
      { id: "tc_337_1", input: "[[], [['register', 'ADD', p => p + 1], ['dispatch', { type: 'ADD', payload: 10 }]]]", expectedOutput: "[null, 11]", isHidden: false },
      { id: "tc_337_2", input: "[[], [['dispatch', { type: 'UNKNOWN' }]]]", expectedOutput: "[null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_337_3", input: "[[], [['register', 'UPPER', s => s.toUpperCase()], ['dispatch', { type: 'UPPER', payload: 'test' }]]]", expectedOutput: "[null, 'TEST']", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(h)",
    hints: ["handlers.get(action.type) and call with action.payload."]
  },
  {
    id: "JS-P338",
    number: 338,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Batching"],
    tags: ["batch", "collector", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['add', 'a'], ['add', 'b'], ['flush']]]", output: "[false, true, ['a', 'b']]", explanation: "Flushes full batch." }
    ],
    constraints: ["batchSize >= 1."],
    starterCode: "function createBatchCollector(batchSize) {\n  // Write your solution here\n}",
    functionName: "createBatchCollector",
    testCases: [
      { id: "tc_338_1", input: "[[2], [['add', 'a'], ['add', 'b'], ['flush']]]", expectedOutput: "[false, true, ['a', 'b']]", isHidden: false },
      { id: "tc_338_2", input: "[[3], [['flush']]]", expectedOutput: "[[]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_338_3", input: "[[1], [['add', 42], ['isFull']]]", expectedOutput: "[true, true]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Mocking"],
    tags: ["poller", "mocking", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[['pending', 'done'], [[], [], []]]", output: "['pending', 'done', 'done']", explanation: "Repeats 'done' when exhausted." }
    ],
    constraints: ["responses is non-empty."],
    starterCode: "function createPoller(responses) {\n  // Write your solution here\n}",
    functionName: "createPoller",
    testCases: [
      { id: "tc_339_1", input: "[['pending', 'done'], [[], [], []]]", expectedOutput: "['pending', 'done', 'done']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_339_2", input: "[[42], [[], []]]", expectedOutput: "[42, 42]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Clamp index with Math.min."]
  },
  {
    id: "JS-P340",
    number: 340,
    ...
    examples: [
      { title: "Example 1", input: "['A', [['setPending', 'B'], ['get'], ['commit'], ['get']]]", output: "[null, 'A', 'B', 'B']", explanation: "Only updates upon commit." }
    ],
    constraints: ["Initial pending equals initial."],
    starterCode: "function createDebounceState(initial) {\n  // Write your solution here\n}",
    functionName: "createDebounceState",
    testCases: [
      { id: "tc_340_1", input: "['A', [['setPending', 'B'], ['get'], ['commit'], ['get']]]", expectedOutput: "[null, 'A', 'B', 'B']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_340_2", input: "[0, [['getPending']]]", expectedOutput: "[0]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["current = pending on commit()."]
  },
  {
    id: "JS-P341",
    number: 341,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Mutex", "Concurrency"],
    tags: ["lock", "mutex", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['acquire'], ['acquire'], ['release'], ['acquire']]]", output: "[true, false, true, true]", explanation: "Second acquire fails until release." }
    ],
    constraints: ["Starts unlocked."],
    starterCode: "function createLock() {\n  // Write your solution here\n}",
    functionName: "createLock",
    testCases: [
      { id: "tc_341_1", input: "[[], [['acquire'], ['acquire'], ['release'], ['acquire']]]", expectedOutput: "[true, false, true, true]", isHidden: false },
      { id: "tc_341_2", input: "[[], [['isLocked'], ['release']]]", expectedOutput: "[false, true]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_341_3", input: "[[], [['acquire'], ['isLocked']]]", expectedOutput: "[true, true]", isHidden: true }
    ],
    solution: "function createLock() {\n  let locked = false;\n  return {\n    acquire: () => {\n      if (locked) return false;\n      locked = true;\n      return true;\n    },\n    release: () => {\n      locked = false;\n      return true;\n    },\n    isLocked: () => locked\n  };\n}",
    explanation: "Boolean flag representing mutex state.",
    timeComplexity: "O(1)",
    spaceComplexity: "O(1)",
    hints: ["Return false if locked is already true."]
  },
  {
    id: "JS-P342",
    number: 342,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Indexing", "Storage"],
    tags: ["indexedStore", "database", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "['id', [['insert', { id: 1, name: 'Alice' }], ['findById', 1], ['remove', 1], ['findById', 1]]]", output: "[{\"id\":1,\"name\":\"Alice\"}, {\"id\":1,\"name\":\"Alice\"}, true, null]", explanation: "Indexed storage by id." }
    ],
    constraints: ["keyProp is string."],
    starterCode: "function createIndexedStore(keyProp = 'id') {\n  // Write your solution here\n}",
    functionName: "createIndexedStore",
    testCases: [
      { id: "tc_342_1", input: "['id', [['insert', { id: 1, name: 'Alice' }], ['findById', 1], ['remove', 1], ['findById', 1]]]", expectedOutput: "[{\"id\":1,\"name\":\"Alice\"}, {\"id\":1,\"name\":\"Alice\"}, true, null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_342_2", input: "['key', [['getAll']]]", expectedOutput: "[[]]", isHidden: true }
    ],
    ...
    spaceComplexity: "O(n)",
    hints: ["Use Map keyed by item[keyProp]."]
  },
  {
    id: "JS-P343",
    number: 343,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Snapshots", "State"],
    tags: ["snapshot", "restore", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[10, [['takeSnapshot', 's1'], ['set', 20], ['get'], ['restore', 's1'], ['get']]]", output: "[null, null, 20, 10, 10]", explanation: "Restores snapshot 's1'." }
    ],
    constraints: ["Snapshots are deep cloned."],
    starterCode: "function createSnapshotManager(init) {\n  // Write your solution here\n}",
    functionName: "createSnapshotManager",
    testCases: [
      { id: "tc_343_1", input: "[10, [['takeSnapshot', 's1'], ['set', 20], ['get'], ['restore', 's1'], ['get']]]", expectedOutput: "[null, null, 20, 10, 10]", isHidden: false },
      { id: "tc_343_2", input: "['a', [['restore', 'invalid']]]", expectedOutput: "[null]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_343_3", input: "[0, [['set', 5], ['get']]]", expectedOutput: "[null, 5]", isHidden: true }
    ],
    ...
    hints: ["Deep copy with JSON parse/stringify."]
  },
  {
    id: "JS-P344",
    number: 344,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Filtering"],
    tags: ["stream", "filter", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[x => x % 2 === 0, [['push', 1], ['push', 2], ['push', 4], ['getValues']]]", output: "[false, true, true, [2, 4]]", explanation: "Only even numbers accepted." }
    ],
    constraints: ["predicate returns boolean."],
    starterCode: "function createFilteredStream(predicate) {\n  // Write your solution here\n}",
    functionName: "createFilteredStream",
    testCases: [
      { id: "tc_344_1", input: "[x => x % 2 === 0, [['push', 1], ['push', 2], ['push', 4], ['getValues']]]", expectedOutput: "[false, true, true, [2, 4]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_344_2", input: "[() => true, [['push', 42], ['clear'], ['getValues']]]", expectedOutput: "[true, null, []]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(n)",
    hints: ["Check predicate(item) before values.push."]
  },
  {
    id: "JS-P345",
    number: 345,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Interceptors"],
    tags: ["interceptor", "properties", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[x => (x ? x.toUpperCase() : undefined), x => x.trim(), [['set', 'name', '  alice  '], ['get', 'name']]]", output: "[null, 'ALICE']", explanation: "Trims on set, uppercases on get." }
    ],
    constraints: ["Transforms are functions."],
    starterCode: "function createPropertyInterceptor(getTransform, setTransform) {\n  // Write your solution here\n}",
    functionName: "createPropertyInterceptor",
    testCases: [
      { id: "tc_345_1", input: "[x => (x ? x.toUpperCase() : undefined), x => x.trim(), [['set', 'name', '  alice  '], ['get', 'name']]]", expectedOutput: "[null, 'ALICE']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_345_2", input: "[x => x, x => x, [['get', 'unset']]]", expectedOutput: "[null]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1)",
    spaceComplexity: "O(k)",
    hints: ["Apply transforms inside get/set."]
  },
  {
    id: "JS-P346",
    number: 346,
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Logging"],
    tags: ["logger", "events", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['log', 'click', { x: 10 }], ['log', 'click', { x: 20 }], ['count', 'click']]]", output: "[null, null, 2]", explanation: "Tracks 2 click events." }
    ],
    constraints: ["Return empty array if no logs exist."],
    starterCode: "function createEventLogger() {\n  // Write your solution here\n}",
    functionName: "createEventLogger",
    testCases: [
      { id: "tc_346_1", input: "[[], [['log', 'click', { x: 10 }], ['log', 'click', { x: 20 }], ['count', 'click']]]", expectedOutput: "[null, null, 2]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_346_2", input: "[[], [['getLogs', 'empty'], ['count', 'empty']]]", expectedOutput: "[[], 0]", isHidden: true }
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    questionType: "Implementation",
    skills: ["Closures", "Sliding Window", "Math"],
    tags: ["movingAverage", "slidingWindow", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[3], [['add', 1], ['add', 2], ['add', 3], ['add', 4]]]", output: "[1, 1.5, 2, 3]", explanation: "(2 + 3 + 4) / 3 = 3." }
    ],
    constraints: ["size >= 1."],
    starterCode: "function createMovingAverage(size) {\n  // Write your solution here\n}",
    functionName: "createMovingAverage",
    testCases: [
      { id: "tc_347_1", input: "[[3], [['add', 1], ['add', 2], ['add', 3], ['add', 4]]]", expectedOutput: "[1, 1.5, 2, 3]", isHidden: false },
      { id: "tc_347_2", input: "[[2], [['getAverage']]]", expectedOutput: "[0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_347_3", input: "[[1], [['add', 10], ['getAverage']]]", expectedOutput: "[10, 10]", isHidden: true }
    ],
    ...
    hints: ["Maintain running sum so computing average is O(1)."]
  },
  {
    id: "JS-P348",
    number: 348,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "BiMap", "Data Structures"],
    tags: ["biMap", "dataStructures", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[], [['set', 'a', 1], ['getByKey', 'a'], ['getByVal', 1]]]", output: "[null, 1, 'a']", explanation: "Can query by key or value." }
    ],
    constraints: ["One-to-one bijection."],
    starterCode: "function createBiMap() {\n  // Write your solution here\n}",
    functionName: "createBiMap",
    testCases: [
      { id: "tc_348_1", input: "[[], [['set', 'a', 1], ['getByKey', 'a'], ['getByVal', 1]]]", expectedOutput: "[null, 1, 'a']", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_348_2", input: "[[], [['getByKey', 'x'], ['getByVal', 99]]]", expectedOutput: "[null, null]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1) all operations",
    spaceComplexity: "O(n)",
    hints: ["Use two Maps: keyToVal and valToKey."]
  },
  {
    id: "JS-P349",
    number: 349,
    ...
    questionType: "Implementation",
    skills: ["Closures", "Stack"],
    tags: ["historyStack", "stack", "closures"],
    expectedTime: "5 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[2], [['push', 1], ['push', 2], ['push', 3], ['getItems']]]", output: "[null, null, null, [2, 3]]", explanation: "1 was dropped due to maxSize 2." }
    ],
    constraints: ["maxSize >= 1."],
    starterCode: "function createHistoryStack(maxSize) {\n  // Write your solution here\n}",
    functionName: "createHistoryStack",
    testCases: [
      { id: "tc_349_1", input: "[[2], [['push', 1], ['push', 2], ['push', 3], ['getItems']]]", expectedOutput: "[null, null, null, [2, 3]]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_349_2", input: "[[1], [['push', 'a'], ['peek'], ['pop']]]", expectedOutput: "[null, 'a', 'a']", isHidden: true }
    ],
    ...
    hints: ["If stack.length > maxSize, call stack.shift()."]
  },
  {
    id: "JS-P350",
    number: 350,
    ...
    difficulty: "Medium",
    questionType: "Implementation",
    skills: ["Closures", "Caching", "Invalidation"],
    tags: ["cache", "invalidation", "closures"],
    expectedTime: "10 mins",
    ...
    examples: [
      { title: "Example 1", input: "[[x => x * 2], [['call', 5], ['size'], ['invalidate', 5], ['size']]]", output: "[10, 1, null, 0]", explanation: "Invalidates specific cached arg." }
    ],
    constraints: ["Key is JSON.stringify(args)."],
    starterCode: "function createInvalidatableCache(fn) {\n  // Write your solution here\n}",
    functionName: "createInvalidatableCache",
    testCases: [
      { id: "tc_350_1", input: "[[x => x * 2], [['call', 5], ['size'], ['invalidate', 5], ['size']]]", expectedOutput: "[10, 1, null, 0]", isHidden: false },
      { id: "tc_350_2", input: "[[(a, b) => a + b], [['call', 1, 2], ['call', 3, 4], ['invalidateAll'], ['size']]]", expectedOutput: "[3, 7, null, 0]", isHidden: false }
    ],
    hiddenTestCases: [
      { id: "tc_350_3", input: "[[s => s.length], [['size']]]", expectedOutput: "[0]", isHidden: true }
    ],
    ...
    timeComplexity: "O(1) amortized",
    spaceComplexity: "O(m)",
    hints: ["Use cache.delete and cache.clear."]
  }
];

async function buildAndTestBatch07() {
  console.log(`Testing Batch 07 (${b07.length} questions)...`);
  const passed = await testBatch(b07);
  if (!passed) throw new Error('Batch 07 verification failed!');

  const outPath = path.join(process.cwd(), 'src/components/coreprogramming/data/batches/batch07.ts');
  const fileContent = `// src/components/coreprogramming/data/batches/batch07.ts
import type { CoreProgrammingQuestion } from '../coreProgrammingTypes';

export const batch07: CoreProgrammingQuestion[] = ${JSON.stringify(b07, null, 2)};
`;

  fs.writeFileSync(outPath, fileContent, 'utf-8');
  console.log('Successfully wrote 50 verified questions to batch07.ts!');
}

// src/components/coreprogramming/data/batches/batch02.ts
import type { CoreProgrammingQuestion } from '../coreProgrammingTypes';

export const coreProgrammingBatch2: CoreProgrammingQuestion[] = [
  {
    "id": "JS-P051",
    "number": 51,
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 4, 5], 2]",
        "output": "[[1, 2], [3, 4], [5]]",
        "explanation": "Chunks of size 2, with the remaining element in the last chunk."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 3], 1]",
        "output": "[[1], [2], [3]]",
        "explanation": "Each chunk has size 1."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use a for loop incrementing i by size and push arr.slice(i, i + size)."
    ]
  },
  {
    "id": "JS-P052",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 2, 3, 4, 4, 5]]",
        "output": "[1, 2, 3, 4, 5]",
        "explanation": "Duplicates 2 and 4 removed."
      },
      {
        "title": "Example 2",
        "input": "[['a', 'b', 'a', 'c']]",
        "output": "['a', 'b', 'c']",
        "explanation": "Duplicate 'a' removed."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "[[10, 5, 20, 20, 8]]",
        "output": "10",
        "explanation": "Largest is 20, second largest distinct is 10."
      },
      {
        "title": "Example 2",
        "input": "[[5, 5, 5]]",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Maintain two variables first and second initialized to -Infinity."
    ]
  },
  {
    "id": "JS-P054",
    ...
    "examples": [
      {
        ...
        "input": "[[12, 3, 1, 5, 1]]",
        "output": "3",
        "explanation": "Smallest is 1, second smallest is 3."
      },
      {
        "title": "Example 2",
        "input": "[[4, 4]]",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Track first and second initialized to Infinity."
    ]
  },
  {
    "id": "JS-P055",
    ...
    "examples": [
      {
        ...
        "input": "[[0, 1, 0, 3, 12]]",
        "output": "[1, 3, 12, 0, 0]",
        "explanation": "1, 3, 12 keep order, 0s move to back."
      },
      {
        "title": "Example 2",
        "input": "[[0, 0]]",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Filter non-zero elements and append an array of zeros of the remaining length."
    ]
  },
  {
    "id": "JS-P056",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 4, 5], 2]",
        "output": "[4, 5, 1, 2, 3]",
        "explanation": "Elements rotated right 2 positions."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], 3]",
        "output": "[2, 1]",
        "explanation": "3 % 2 = 1 position rotation."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use k % arr.length, then slice the last k elements and prefix them."
    ]
  },
  {
    "id": "JS-P057",
    ...
    "hints": [
      "Use a Set for the second array and filter distinct elements from the first array."
    ]
  },
  {
    "id": "JS-P058",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3], [2, 3, 4]]",
        "output": "[1, 2, 3, 4]",
        "explanation": "Combined unique elements."
      },
      {
        "title": "Example 2",
        "input": "[[1, 1], [2, 2]]",
        "output": "[1, 2]",
        "explanation": "Uniques are 1 and 2."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "spaceComplexity": "O(n + m)",
    "hints": [
      "Use Array.from(new Set([...arr1, ...arr2]))."
    ]
  },
  {
    "id": "JS-P059",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 4], [2, 4]]",
        "output": "[1, 3]",
        "explanation": "1 and 3 are only in arr1."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], [1, 2]]",
        "output": "[]",
        "explanation": "All elements exist in arr2."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3], [3, 4, 5]]",
        "output": "[1, 2, 4, 5]",
        "explanation": "3 is common and excluded."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], [1, 2]]",
        "output": "[]",
        "explanation": "All elements shared."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "spaceComplexity": "O(n + m)",
    "hints": [
      "Find elements in s1 not in s2, plus elements in s2 not in s1."
    ]
  },
  {
    "id": "JS-P061",
    ...
    "examples": [
      {
        ...
        "explanation": "Evens and odds partitioned."
      },
      {
        "title": "Example 2",
        "input": "[[2, 4]]",
    ...
    "testCases": [
      ...
      },
      {
        "id": "tc_61_2",
        "input": "[[2, 4]]",
        "expectedOutput": "{ evens: [2, 4], odds: [] }",
        "isHidden": false
      },
      {
        "id": "tc_61_3",
        "input": "[[]]",
        "expectedOutput": "{ evens: [], odds: [] }",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
      {
        "id": "tc_61_4",
        "input": "[[1, 3, 5]]",
        "expectedOutput": "{ evens: [], odds: [1, 3, 5] }",
        "isHidden": true
      },
      {
        "id": "tc_61_5",
        "input": "[[-2, -1, 0]]",
        "expectedOutput": "{ evens: [-2, 0], odds: [-1] }",
        "isHidden": true
      }
    ],
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Iterate through the array checking n % 2 === 0."
    ]
  },
  {
    "id": "JS-P062",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use Gauss sum formula: (n * (n + 1)) / 2 minus the array sum."
    ]
  },
  {
    "id": "JS-P063",
  ...
  },
  {
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use Kadane's algorithm: currMax = Math.max(x, currMax + x)."
    ]
  },
  {
    "id": "JS-P065",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use arr.map with a cumulative accumulator variable."
    ]
  },
  {
    "id": "JS-P066",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3]]",
        "output": "[0, 1, 3, 6]",
        "explanation": "Index 0 is 0, then 1, 3, 6."
      },
      {
        "title": "Example 2",
        "input": "[[]]",
        "output": "[0]",
        "explanation": "Prefix of empty array is [0]."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Start with [0] and iteratively append res[i] + arr[i]."
    ]
  },
  {
    "id": "JS-P067",
    ...
    "examples": [
      {
        ...
        "input": "[[[1, 2], [3, 4], [5]]]",
        "output": "[1, 2, 3, 4, 5]",
        "explanation": "1 level flattened."
      },
      {
        "title": "Example 2",
        "input": "[[1, [2, [3]]]]",
        "output": "[1, 2, [3]]",
        "explanation": "Only depth 1 flattened."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "[['a', 'b', 'c'], [1, 2, 3]]",
        "output": "[['a', 1], ['b', 2], ['c', 3]]",
        "explanation": "Paired element by element."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], ['x']]",
        "output": "[[1, 'x']]",
        "explanation": "Length bounded by shorter array."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "hints": [
      "Iterate from 0 to Math.min(arr1.length, arr2.length)."
    ]
  },
  {
    "id": "JS-P069",
    ...
    "examples": [
      {
        ...
        "input": "[[['a', 1], ['b', 2], ['c', 3]]]",
        "output": "[['a', 'b', 'c'], [1, 2, 3]]",
        "explanation": "Deconstructed into two arrays."
      },
      {
        "title": "Example 2",
        "input": "[[]]",
        "output": "[[], []]",
        "explanation": "Empty input returns two empty arrays."
      }
    ],
    "constraints": [
      "0 <= pairs.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Iterate through pairs, destructuring [a, b] into separate arrays."
    ]
  },
  {
    "id": "JS-P070",
    ...
    "examples": [
      {
        ...
        "input": "[1, 5, 1]",
        "output": "[1, 2, 3, 4, 5]",
        "explanation": "Numbers 1 through 5."
      },
      {
        "title": "Example 2",
        "input": "[0, 10, 2]",
        "output": "[0, 2, 4, 6, 8, 10]",
        "explanation": "Step by 2."
      }
    ],
    "constraints": [
      "step >= 1"
    ...
    "hints": [
      "Use a for loop: for (let i = start; i <= end; i += step)."
    ]
  },
  {
    "id": "JS-P071",
    ...
    "examples": [
      {
        ...
        "explanation": "Counts for each fruit."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 2, 3]]",
        "output": "{ '1': 1, '2': 2, '3': 1 }",
        "explanation": "Integer keys converted to object property strings."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Iterate through array and update map: map[x] = (map[x] || 0) + 1."
    ]
  },
  {
    "id": "JS-P072",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 3, 2, 1, 4, 1]]",
        "output": "1",
        "explanation": "1 appears 3 times."
      },
      {
        "title": "Example 2",
        "input": "[['a', 'b', 'b', 'c']]",
        "output": "'b'",
        "explanation": "'b' appears 2 times."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use Map to record frequencies and track the element with the maximum count."
    ]
  },
  {
    "id": "JS-P073",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[1, 3, 2]]",
        "output": "false",
        "explanation": "3 > 2 violates monotonicity."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[30, 20, 10]]",
        "output": "false",
        "explanation": "Descending, not ascending."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example 1",
        "input": "[[0, 1, false, 2, '', 3, 'a', NaN]]",
        "output": "[1, 2, 3, 'a']",
        "explanation": "0, false, '', and NaN removed."
      },
      {
        "title": "Example 2",
        "input": "[[null, undefined]]",
        "output": "[]",
        "explanation": "All falsy."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use a Map to store complement value to index."
    ]
  },
  {
    "id": "JS-P077",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 5, 7, -1, 5], 6]",
        "output": "[[-1, 7], [1, 5]]",
        "explanation": "-1+7=6 and 1+5=6."
      },
      {
        "title": "Example 2",
        "input": "[[2, 2, 2], 4]",
        "output": "[[2, 2]]",
        "explanation": "Distinct pair is [2, 2]."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Normalize pairs as [Math.min(a, b), Math.max(a, b)] to deduplicate."
    ]
  },
  {
    "id": "JS-P078",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3]]",
        "output": "[3, 2, 1]",
        "explanation": "Copy reversed."
      },
      {
        "title": "Example 2",
        "input": "[['a', 'b']]",
        "output": "['b', 'a']",
        "explanation": "Original preserved."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use [...arr].reverse() or slice().reverse()."
    ]
  },
  {
    "id": "JS-P079",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 2, 4], 2]",
        "output": "[1, 3, 4]",
        "explanation": "Both 2s removed."
      },
      {
        "title": "Example 2",
        "input": "[['apple', 'banana'], 'banana']",
        "output": "['apple']",
        "explanation": "'banana' removed."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
  ...
  },
  {
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use one set for seen items and another set for duplicated items."
    ]
  },
  {
    "id": "JS-P081",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Iterate backwards from right to left tracking the maximum value seen so far."
    ]
  },
  {
    "id": "JS-P082",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[1, 2, 1, 3, 5, 6, 4]]",
        "output": "1",
        "explanation": "First peak is 2 at index 1."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Compare arr[i] to arr[i - 1] and arr[i + 1], treating out-of-bound neighbors as -Infinity."
    ]
  },
  {
    "id": "JS-P083",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Check both the two largest positive numbers and two most negative numbers."
    ]
  },
  {
    "id": "JS-P084",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3], [1, 2, 3]]",
        "output": "true",
        "explanation": "Identical elements and order."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], [2, 1]]",
        "output": "false",
        "explanation": "Different order."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Compare lengths first, then check arr1[i] === arr2[i]."
    ]
  },
  {
    "id": "JS-P085",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Track minPrice seen so far and calculate profit price - minPrice."
    ]
  },
  {
    "id": "JS-P086",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[1, 2, 3]]",
        "output": "0",
        "explanation": "Already sorted, 0 inversions."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 1000"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Loop through all pairs (i, j) where i < j and check if arr[i] > arr[j]."
    ]
  },
  {
    "id": "JS-P087",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[1, 2], [3, 4]]",
        "output": "[1, 2, 3, 4]",
        "explanation": "All elements from arr1 precede arr2."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "spaceComplexity": "O(n + m)",
    "hints": [
      "Use two pointers i and j comparing arr1[i] and arr2[j]."
    ]
  },
  {
    "id": "JS-P088",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use the XOR bitwise operator (^). x ^ x === 0 and x ^ 0 === x."
    ]
  },
  {
    "id": "JS-P089",
    ...
    "testCases": [
      {
        "id": "tc_89_1",
        "input": "[['one', 'two', 'three', 'four', 'five']]",
        "expectedOutput": "{ '3': ['one', 'two'], '4': ['four', 'five'], '5': ['three'] }",
        "isHidden": false
      },
      {
        "id": "tc_89_2",
        "input": "[['a', 'b', 'c']]",
        "expectedOutput": "{ '1': ['a', 'b', 'c'] }",
        "isHidden": false
      },
      {
        "id": "tc_89_3",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use an object with keys s.length."
    ]
  },
  {
    "id": "JS-P090",
    ...
    "examples": [
      {
        ...
        "input": "[[3, 4, 9, 6, 1]]",
        "output": "[3, 2, 0, 0, 0]",
        "explanation": "For 3: 4, 9, 6 are greater (3). For 4: 9, 6 are greater (2)."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 3]]",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "For each element at i, count items to the right greater than arr[i]."
    ]
  },
  {
    "id": "JS-P091",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "[[2, 0, 5]]",
        "output": "[2, 0, 0]",
        "explanation": "Zero makes subsequent products 0."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use arr.map maintaining running product variable."
    ]
  },
  {
    "id": "JS-P092",
    ...
    "examples": [
      {
        "title": "Example 1",
        "input": "[[1, 5, 10, 20], [5, 6, 7, 20], [5, 20, 30]]",
        "output": "[5, 20]",
        "explanation": "5 and 20 are present in all three."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2], [3, 4], [5, 6]]",
    ...
    "hints": [
      "Use Sets for arr2 and arr3, then check if both sets have element from arr1."
    ]
  },
  {
    "id": "JS-P093",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3], ['a', 'b', 'c']]",
        "output": "[1, 'a', 2, 'b', 3, 'c']",
        "explanation": "Alternating elements."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 3, 4], ['a']]",
        "output": "[1, 'a', 2, 3, 4]",
        "explanation": "Remainder of arr1 appended."
      }
    ],
    "constraints": [
      "0 <= arr1.length, arr2.length <= 10^5"
    ...
    "spaceComplexity": "O(n + m)",
    "hints": [
      "Loop up to Math.max(arr1.length, arr2.length) and check indices."
    ]
  },
  {
    "id": "JS-P094",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 4]]",
        "output": "[[1, 2], [3, 4]]",
        "explanation": "Even length split equally."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 3, 4, 5]]",
        "output": "[[1, 2, 3], [4, 5]]",
        "explanation": "Odd length puts extra item in first half."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "mid = Math.ceil(arr.length / 2). Slice 0 to mid and mid to end."
    ]
  },
  {
    "id": "JS-P095",
    ...
    "examples": [
      {
        ...
        "input": "[[1, -1, 2]]",
        "output": "4",
        "explanation": "[1], [2], [1, -1, 2], [-1, 2] have positive sums."
      },
      {
        "title": "Example 2",
        "input": "[[-1, -2]]",
        "output": "0",
        "explanation": "No positive sums."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 1000"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use nested loops with a running sum for each start index."
    ]
  },
  {
    "id": "JS-P096",
    "number": 96,
    "title": "Array Transformation: Exclusion Products (productExceptSelf)",
    "slug": "js-p096-array-transformation-exclusion-products-productexceptself",
    "category": "Arrays",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 2, 3, 4]]",
        "output": "[24, 12, 8, 6]",
        "explanation": "24/1=24, 24/2=12, 24/3=8, 24/4=6."
      },
      {
        "title": "Example 2",
        "input": "[[-1, 1, 0, -3, 3]]",
        "output": "[0, 0, 9, 0, 0]",
        "explanation": "Only index 2 omits 0."
      }
    ],
    "constraints": [
      "2 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Pass left-to-right computing prefix products, then right-to-left multiplying suffix products."
    ]
  },
  {
    "id": "JS-P097",
    ...
    "examples": [
      {
        ...
        "input": "[[1, 1, 2, 3, 3, 3]]",
        "output": "3",
        "explanation": "(1, 1) once, (3, 3) twice. Total 3."
      },
      {
        "title": "Example 2",
        "input": "[[1, 2, 3]]",
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        ...
        "output": "9",
        "explanation": "0 through 8 sequence has length 9."
      }
    ],
    "constraints": [
      "0 <= arr.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Insert into Set and only start counting when n - 1 is not in the set."
    ]
  },
  {
    "id": "JS-P100",
    ...
    "examples": [
      {
        ...
        "input": "[[2, 0, 2, 1, 1, 0]]",
        "output": "[0, 0, 1, 1, 2, 2]",
        "explanation": "Sorted 0s, then 1s, then 2s."
      },
      {
        "title": "Example 2",
        "input": "[[2, 0, 1]]",

// src/components/coreprogramming/data/batches/batch03.ts
import type { CoreProgrammingQuestion } from '../coreProgrammingTypes';

export const coreProgrammingBatch3: CoreProgrammingQuestion[] = [
  {
    "id": "JS-P101",
    "number": 101,
    ...
    "examples": [
      {
        ...
        "input": "['swiss']",
        "output": "'w'",
        "explanation": "'s' repeats, 'w' is first non-repeating."
      },
      {
        "title": "Example 2",
        "input": "['aabbcc']",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Count characters first with an object, then iterate the string to find the first with frequency 1."
    ]
  },
  {
    "id": "JS-P102",
    ...
    "examples": [
      {
        ...
        "input": "['abca']",
        "output": "'a'",
        "explanation": "'a' repeats at index 3."
      },
      {
        "title": "Example 2",
        "input": "['abcdef']",
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "output": "'jumped'",
        "explanation": "'jumped' has length 6."
      },
      {
        "title": "Example 2",
        "input": "['May the force be with you']",
        "output": "'force'",
        "explanation": "'force' has length 5."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Split by whitespace, then iterate tracking the longest string."
    ]
  },
  {
    "id": "JS-P104",
    ...
    "examples": [
      {
        ...
        "output": "'I'",
        "explanation": "'I' has length 1."
      },
      {
        "title": "Example 2",
        "input": "['hello world']",
        "output": "'hello'",
        "explanation": "Tied length 5, returns first."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Split into words, track the shortest length."
    ]
  },
  {
    "id": "JS-P105",
    ...
    "examples": [
      {
        ...
        "input": "['hello world']",
        "output": "'olleh dlrow'",
        "explanation": "Each word reversed."
      },
      {
        "title": "Example 2",
    ...
    "testCases": [
      ...
      },
      {
        "id": "tc_105_2",
        "input": "['JavaScript is awesome']",
        "expectedOutput": "'tpircSavaJ si emosewa'",
        "isHidden": false
      },
      {
        "id": "tc_105_3",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Split by space ' ', reverse each word's characters, join back with ' '."
    ]
  },
  {
    "id": "JS-P106",
    ...
    "examples": [
      {
        ...
        "output": "true",
        "explanation": "'erbottlewat' is rotation of 'waterbottle'."
      },
      {
        "title": "Example 2",
        "input": "['hello', 'world']",
        "output": "false",
        "explanation": "Different strings."
      }
    ],
    "constraints": [
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Check if s1.length === s2.length && (s1 + s1).includes(s2)."
    ]
  },
  {
    "id": "JS-P107",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Iterate through characters counting identical adjacent letters."
    ]
  },
  {
    "id": "JS-P108",
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "['banana', 'an']",
        "output": "2",
        "explanation": "'an' appears at index 1 and index 3."
      },
      {
        "title": "Example 2",
        "input": "['aaaa', 'aa']",
        "output": "2",
        "explanation": "Two non-overlapping 'aa' pairs."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use str.indexOf(sub, pos) in a while loop."
    ]
  },
  {
    "id": "JS-P110",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use a counter: increment for '(', decrement for ')'. Check counter >= 0 at all times."
    ]
  },
  {
    "id": "JS-P111",
    ...
    "examples": [
      {
        ...
        "explanation": "Punctuation removed."
      },
      {
        "title": "Example 2",
        "input": "['Code: 100% (done).']",
        "output": "'Code 100% done'",
        "explanation": ":, (, ), . removed."
      }
    ],
    "constraints": [
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "['Hello World!']",
        "output": "'hello-world'",
        "explanation": "Lowercased and hyphenated."
      },
      {
        "title": "Example 2",
        "input": "['  React & Vue 2024  ']",
        "output": "'react-vue-2024'",
        "explanation": "& and extra spaces converted."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "toLowerCase(), replace(/[^a-z0-9]+/g, '-'), and trim hyphens."
    ]
  },
  {
    "id": "JS-P113",
    ...
    "testCases": [
      ...
      {
        "id": "tc_113_3",
        "input": "['borderTopLeftRadius']",
        "expectedOutput": "'border-top-left-radius'",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use str.replace(/([A-Z])/g, '-$1').toLowerCase()."
    ]
  },
  {
    "id": "JS-P114",
    ...
    "testCases": [
      ...
      },
      {
        "id": "tc_114_2",
        "input": "['font-size']",
        "expectedOutput": "'fontSize'",
        "isHidden": false
      },
      {
        "id": "tc_114_3",
        "input": "['border-top-left-radius']",
        "expectedOutput": "'borderTopLeftRadius'",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use str.replace(/-([a-z0-9])/g, (_, char) => char.toUpperCase())."
    ]
  },
  {
    "id": "JS-P115",
    ...
    "testCases": [
      {
        "id": "tc_115_1",
        "input": "['user_first_name']",
        "expectedOutput": "'userFirstName'",
        "isHidden": false
      },
      {
        "id": "tc_115_2",
        "input": "['is_active']",
        "expectedOutput": "'isActive'",
        "isHidden": false
      },
      {
        "id": "tc_115_3",
        "input": "['created_at_date']",
        "expectedOutput": "'createdAtDate'",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use str.replace(/_([a-z0-9])/g, (_, char) => char.toUpperCase())."
    ]
  },
  {
    "id": "JS-P116",
    ...
    "testCases": [
      {
        "id": "tc_116_1",
        "input": "['userFirstName']",
        "expectedOutput": "'user_first_name'",
        "isHidden": false
      },
      {
        "id": "tc_116_2",
        "input": "['isActive']",
        "expectedOutput": "'is_active'",
        "isHidden": false
      },
      {
        "id": "tc_116_3",
        "input": "['createdAtDate']",
        "expectedOutput": "'created_at_date'",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use str.replace(/([A-Z])/g, '_$1').toLowerCase()."
    ]
  },
  {
    "id": "JS-P117",
    ...
    "examples": [
      {
        ...
        "output": "'############5678'",
        "explanation": "12 digits masked, last 4 visible."
      },
      {
        "title": "Example 2",
        "input": "['1234']",
        "output": "'1234'",
        "explanation": "Length <= 4 unchanged."
      }
    ],
    "constraints": [
      "0 <= cc.length <= 50"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use '#'.repeat(cc.length - 4) + cc.slice(-4)."
    ]
  },
  {
    "id": "JS-P118",
    ...
    "examples": [
      {
        ...
        "input": "[1000000]",
        "output": "'1,000,000'",
        "explanation": "Formatted with commas."
      },
      {
        "title": "Example 2",
        "input": "[12345]",
    ...
    "hints": [
      "Use n.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, ',')."
    ]
  },
  {
    "id": "JS-P119",
    ...
    "examples": [
      {
        "title": "Example 1",
        "input": "['Order #12345 placed on 2024-01-15']",
        "output": "'1234520240115'",
        "explanation": "All digits concatenated."
      },
      {
        "title": "Example 2",
        "input": "['abc']",
        "output": "''",
        "explanation": "No digits."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use str.match(/\\d/g) or filter characters."
    ]
  },
  {
    "id": "JS-P120",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "['Hello, World!', 3]",
        "output": "'Khoor, Zruog!'",
        "explanation": "Letters shifted, punctuation unchanged."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use charCodeAt, subtract base (65 for uppercase, 97 for lowercase), add shift % 26, modulo 26, then restore base."
    ]
  },
  {
    "id": "JS-P121",
    ...
    "examples": [
      {
        ...
        "output": "true",
        "explanation": "Contains all 26 letters."
      },
      {
        "title": "Example 2",
        "input": "['Hello world']",
        "output": "false",
        "explanation": "Missing many letters."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Add all lowercase alphabetic characters to a Set and check if set.size === 26."
    ]
  },
  {
    "id": "JS-P122",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use two maps to check bidirectional character mapping consistency."
    ]
  },
  {
    "id": "JS-P123",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Start with prefix = strs[0], then trim it while !strs[i].startsWith(prefix)."
    ]
  },
  {
    "id": "JS-P124",
    ...
    "examples": [
      {
        ...
        "input": "['ab-cd']",
        "output": "'dc-ba'",
        "explanation": "Letters reversed, hyphen preserved."
      },
      {
        "title": "Example 2",
        "input": "['a-bC-dEf-ghIj']",
        "output": "'j-Ih-gfE-dCba'",
        "explanation": "Preserves case and non-letters."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "hiddenTestCases": [
      ...
      },
      {
        ...
        "expectedOutput": "'Qedo1ct-eeLg=ntse-T!'",
        "isHidden": true
      }
    ],
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Two pointers: advance left if non-letter, decrement right if non-letter, swap when both are letters."
    ]
  },
  {
    "id": "JS-P125",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Clean with str.toLowerCase().replace(/[^a-z0-9]/g, '') then compare ends."
    ]
  },
  {
    "id": "JS-P126",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Iterate through characters and update freq[c] = (freq[c] || 0) + 1."
    ]
  },
  {
    "id": "JS-P127",
    ...
    "examples": [
      {
        ...
        "input": "['programming']",
        "output": "'progami'",
        "explanation": "Duplicates r, m, g removed."
      },
      {
        "title": "Example 2",
        "input": "['banana']",
        "output": "'ban'",
        "explanation": "'ban' first occurrences."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use Array.from(new Set(str)).join('')."
    ]
  },
  {
    "id": "JS-P128",
    ...
    "examples": [
      {
        ...
        "input": "['ab']",
        "output": "['ab', 'ba']",
        "explanation": "All permutations of 'ab'."
      },
      {
        "title": "Example 2",
        "input": "['a']",
    ...
    "spaceComplexity": "O(n!)",
    "hints": [
      "Use recursion: pick a character, permute the remainder, collect in a Set."
    ]
  },
  {
    "id": "JS-P129",
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "input": "['5', 3, '0']",
        "output": "'005'",
        "explanation": "'5' padded to length 3 with '0'."
      },
      {
        "title": "Example 2",
        "input": "['hello', 5, ' ']",
        "output": "'hello'",
        "explanation": "Already length 5."
      }
    ],
    "constraints": [
      "0 <= str.length <= 1000",
    ...
    "hints": [
      "Use str.padStart(targetLen, padChar)."
    ]
  },
  {
    "id": "JS-P131",
    ...
    "examples": [
      {
        ...
        "input": "['5', 3, '0']",
        "output": "'500'",
        "explanation": "'5' padded on right to length 3."
      },
      {
        "title": "Example 2",
        "input": "['abc', 6, '.']",
        "output": "'abc...'",
        "explanation": "Padded with dots."
      }
    ],
    "constraints": [
      "0 <= str.length <= 1000"
    ...
    "spaceComplexity": "O(targetLen)",
    "hints": [
      "Use str.padEnd(targetLen, padChar)."
    ]
  },
  {
    "id": "JS-P132",
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use two pointers; advance pointer for s only on matching characters."
    ]
  },
  {
    "id": "JS-P133",
    ...
    "hints": [
      "Use a sliding window [left, right] with a map storing the last seen index."
    ]
  },
  {
    "id": "JS-P134",
    ...
    "examples": [
      {
        ...
        "input": "['hello world']",
        "output": "'HeLlO WoRlD'",
        "explanation": "Alternating cases."
      },
      {
        "title": "Example 2",
        "input": "['abc']",
        "output": "'AbC'",
        "explanation": "0: 'A', 1: 'b', 2: 'C'."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Check index i % 2 === 0 for toUpperCase() else toLowerCase()."
    ]
  },
  {
    "id": "JS-P135",
    ...
    "examples": [
      ...
      },
      {
        ...
        "output": "3",
        "explanation": "Three punctuation clusters."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "['256.100.0.1']",
        "output": "false",
        "explanation": "256 exceeds 255."
      },
      {
        "title": "Example 3",
        "input": "['192.168.01.1']",
        "output": "false",
        "explanation": "'01' has invalid leading zero."
      }
    ],
    "constraints": [
      "0 <= ip.length <= 50"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Split by '.', check parts.length === 4, check leading zeros and range 0-255."
    ]
  },
  {
    "id": "JS-P137",
    ...
    "examples": [
      {
        ...
        "output": "'Hello World'",
        "explanation": "Tags stripped."
      },
      {
        "title": "Example 2",
        "input": "['<div><span>Text</span></div>']",
        "output": "'Text'",
        "explanation": "Nested tags stripped."
      }
    ],
    "constraints": [
      "0 <= str.length <= 10^5"
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "explanation": "All HTML specials escaped."
      },
      {
        "title": "Example 2",
        "input": "['Tom & Jerry']",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use a character map and regex replace /[&<>\"']/g."
    ]
  },
  {
    "id": "JS-P139",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Use regex /&(amp|lt|gt|quot|#39);/g with a replacement dictionary."
    ]
  },
  {
    "id": "JS-P140",
  ...
  },
  {
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Compare map[s[i]] with map[s[i+1]]."
    ]
  },
  {
    "id": "JS-P142",
    ...
    "examples": [
      {
        ...
        "input": "[3]",
        "output": "'III'",
        "explanation": "3 is III."
      },
      {
        "title": "Example 2",
        "input": "[58]",
        "output": "'LVIII'",
        "explanation": "58 is LVIII."
      },
      {
        "title": "Example 3",
        "input": "[1994]",
        "output": "'MCMXCIV'",
        "explanation": "1994 is MCMXCIV."
      }
    ],
    "constraints": [
      "1 <= num <= 3999"
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use a greedy table of values and subtract in descending order."
    ]
  },
  {
    "id": "JS-P143",
    ...
    "examples": [
      {
        ...
        "output": "'JFK'",
        "explanation": "J, F, K initials."
      },
      {
        "title": "Example 2",
        "input": "['alan turing']",
        "output": "'AT'",
        "explanation": "Uppercase initials."
      }
    ],
    "constraints": [
      "0 <= name.length <= 1000"
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Trim, split by /\\s+/, map first char to uppercase, join."
    ]
  },
  {
    "id": "JS-P144",
    ...
    "examples": [
      {
        ...
        "explanation": "'user' masked to 'u*****r'."
      },
      {
        "title": "Example 2",
        "input": "['alexander@gmail.com']",
        "output": "'a*****r@gmail.com'",
        "explanation": "'alexander' masked."
      }
    ],
    "constraints": [
      "email contains exactly one '@' with local part of length >= 2."
    ],
    ...
    "testCases": [
      {
        "id": "tc_144_1",
        "input": "['user@example.com']",
        "expectedOutput": "'u*****r@example.com'",
        "isHidden": false
      },
      {
        "id": "tc_144_2",
        "input": "['alexander@gmail.com']",
        "expectedOutput": "'a*****r@gmail.com'",
        "isHidden": false
      },
      {
        "id": "tc_144_3",
        "input": "['ab@test.org']",
        "expectedOutput": "'a*****b@test.org'",
        "isHidden": false
      }
    ],
    "hiddenTestCases": [
      {
        "id": "tc_144_4",
        "input": "['developer@company.io']",
        "expectedOutput": "'d*****r@company.io'",
        "isHidden": true
      }
    ],
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Split at '@', format user[0] + '*****' + user[user.length - 1] + '@' + domain."
    ]
  },
  {
    "id": "JS-P145",
    ...
    "examples": [
      {
        ...
        "input": "['pale', 'ple']",
        "output": "true",
        "explanation": "1 deletion."
      },
      {
        "title": "Example 2",
        "input": "['pales', 'pale']",
        "output": "true",
        "explanation": "1 insertion."
      },
      {
        "title": "Example 3",
        "input": "['pale', 'bale']",
        "output": "true",
        "explanation": "1 replacement."
      },
      {
        "title": "Example 4",
        "input": "['pale', 'bake']",
    ...
    "spaceComplexity": "O(n)",
    "hints": [
      "Find first mismatch index. If lengths equal, suffixes from i+1 must match. If length difference is 1, test insertion."
    ]
  },
  {
    "id": "JS-P146",
    ...
    "examples": [
      ...
      },
      {
        ...
        "input": "['abab', 'ab']",
        "output": "[0, 1, 2]",
        "explanation": "Anagrams at indices 0, 1, 2."
      }
    ],
    "constraints": [
      "0 <= s.length, p.length <= 10^5"
    ],
    ...
    "spaceComplexity": "O(1)",
    "hints": [
      "Use a sliding window of length p.length and compare letter count frequencies."
    ]
  },
  {
    "id": "JS-P147",
    ...
    "hints": [
      "Use sorted characters of each word as the Map key."
    ]
  },
  {
    "id": "JS-P148",
  ...
  },
  {
    ...
    "hiddenTestCases": [
      ...
      {
        "id": "tc_150_5",
        "input": "['john.doe@sub.company.org']",
        "expectedOutput": "true",
        "isHidden": true
      }
    ],
